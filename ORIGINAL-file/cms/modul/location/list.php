...
function pss_list(){
   ...
   # Paging Start
   $perpage = 20;
   $SQLpage = "SELECT * FROM pss_location $search_sql";
   $urlpage = "?".pss_url_def()."=".$_GET[pss_url_def()];
   $awal = pss_paging(1,$SQLpage,$perpage);
   $banyak = $perpage;
   # Paging End

   $SQL = "SELECT * FROM pss_location $search_sql
           ORDER BY head_office desc
           LIMIT $awal,$banyak";
   ...
   do{
      ...
      $HTML .= "<td class=\"tbl_2 tbl_3\" valign=\"top\">$tanggal</td>";
          $HTML .= "<td class=\"tbl_2 tbl_3\" valign=\"top\">$subject</td>";
      $HTML .= "</tr>";
