...
$lang = array_merge($lang, array(
	...
	'ACP_CAT_POSTING'	=> 'المشاركات',
	'ACP_CAT_STYLES'	=> 'الاستايلات',
	'ACP_CAT_SYSTEM'	=> 'النظــام',
	'ACP_CAT_USERGROUP'	=> 'المجموعات',
	...
	'ACP_ORPHAN_ATTACHMENTS'	=> 'المرفقات اليتيمه',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'	=> 'شكرا لاختيارك phpBB3 كبرنامج الإدارة لمنتداك. هذه الشاشة ستعطيك نظرة عامة وسريعة حول جميع الاحصائيات المتنوعة لمنتداك. الروابط على الجهة اليمنى من الشاشة تسمح لك بالتحكم في كل جانب من جوانب المنتدى. في كل صفحة ستجد تعليمات لكيفية استعمال الأدوات المتوفرة.
<br/><strong>
يمكنك دائما طلب الدعم للاستفسار عن اي خاصيه في لوحه التحكم ، اذهب الى  منتدى الدعم العربي بالضغط <a href="http://www.phpbbegypt.com/bb" target="_blank"> هنا </a></strong>',
	...
	'FILES_PER_DAY'	=> 'متوسط المرفقات / يوم',
	...
	'POSTS_PER_DAY'	=> 'متوسط المشاركات / اليوم',
	...
	'RUN'	=> 'تنفيذ',
	'STATISTIC'	=> 'الإحصائية',
	'STATISTIC_RESYNC_OPTIONS'	=> 'تعديل الاحصائيات',
	'TOPICS_PER_DAY'	=> 'متوسط الموضوعات / اليوم',
	'UPLOAD_DIR_SIZE'	=> 'حجم المرفقات المستخدمة',
	'USERS_PER_DAY'	=> 'متوسط انضمام الاعضاء / اليوم',
	'VALUE'	=> 'القيمة',
	'VIEW_ADMIN_LOG'	=> 'مشاهدة سجلات الإدارة',
	'VIEW_INACTIVE_USERS'	=> 'مشاهدة الأعضاء الغير مفعلين',
	'WELCOME_PHPBB'	=> 'مرحبا بك في لوحه تحكم منتداك phpBB3',
	  'WRITABLE_CONFIG'      => 'ملف الكونفيج config.php حاليا في وضع غير امن ، مهم جدا ان تقوم فورا الان بتغيير الترخيص الخاص به الى 644 او الى 640',
));
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'قائمة بالأعضاء المسجلين لكن حساباتهم غير مفعلة. يمكنك تفعيلها أو حذفها أو تذكير هؤلاء الأعضاء (عن طريق إرسال بريد) إذا أردت',
...
$lang = array_merge($lang, array(
	...
	'LOG_DELETE_SHADOW_TOPIC'   => '<strong>الغاء الموضوعات ذات الظل</strong><br />» %s',
	...
	'ACP_NO_ITEMS'	=> 'لم يتم الاختيار',
	'SETTING_TOO_LOW'	=> 'قليله جدا',
	'SETTING_TOO_BIG'	=> 'كبيره جدا',
	'SETTING_TOO_LONG'	=> 'طويله جدا',
	'ADM_LOGOUT'         => 'الخروج من لوحه الادمن',
       'ADM_LOGGED_OUT'      => 'تم بنجاح تسجيل خروجك من لوحه المشرف العام',
	    'LOG_REFERER_INVALID'      => '<strong>صلاحيه الاحاله لم تنجح</strong><br />»الاحاله كانت “<em>%1$s</em>”. تم انهاء الجلسه',
	'SETTING_TOO_SHORT'	=> 'قصيره جدا',
));
