...
$lang = array_merge($lang, array(
	...
	'EDIT_FORUM'	=> 'تعديل القسم',
	'FORUM_PASSWORD_UNSET'	=> 'لم يتم وضع كلمه سر للمنتدى',
	'FORUM_PASSWORD_UNSET_EXPLAIN'	=> 'الشرح',
	'FORUM_PASSWORD_OLD'	=> 'كلمه سر المنتدى القديمه',
	...
	'FORUM_LINK_EXPLAIN'	=> 'الرابط كاملاً (محتوياً البروتوكول, مثل: <samp>http://</samp>) للمكان الذي تريد أن يذهب إليه الأعضاء عند الضغط على هذا المنتدى, مثال: <samp>http://www.phpbbegypt.com/</samp>.',
	...
	'TYPE_LINK'	=> 'رابط',
	'UNLOCKED'	=> 'مفتوح',
	'LIST_SUBFORUMS'	=> 'قائمه المنتديات الفرعيه',
	'LIST_SUBFORUMS_EXPLAIN'	=> 'الشرح',
));
