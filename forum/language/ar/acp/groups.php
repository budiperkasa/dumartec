...
$lang = array_merge($lang, array(
	...
	'GROUP_CONFIRM_ADD_USER'		=> 'هل انت متـأكد من اضافه العضو %1$s الى هذه المجموعه?',
	'GROUP_CONFIRM_ADD_USERS'		=> 'هل انت متأكد من اضافه هؤلاء الاعضاء %1$s الى هذه المجموعه?',
	...
	'GROUP_MAX_RECIPIENTS'         => 'الحد الاقصى المسموح باستلامه في الرسائل الخاصه',
     'GROUP_MAX_RECIPIENTS_EXPLAIN'   => 'العدد الاقصى المسموح له باستلام الرساله الواحده - العدد صفر يعنى انلا حدود للارسال',
	...
	'USER_GROUP_LEADER'	=> 'تحديد كرئيس للمجموعة',
	   'NO_VALID_USERS'         => 'لم تقم بادخال اسم مستخدم يصلح.',
	'NO_USERS_ADDED'	=> 'لم يتم اضافه اي عضو',
));
