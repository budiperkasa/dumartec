...
$lang = array_merge($lang, array(
	...
	'EDITOR_DISABLED'               => 'خاصيه تحرير الملف معطله',
	'DETAILS'	=> 'تفاصيـل',
...
'				=> 'ملف stylesheet لا يقبل الكتابة لدى فال stylesheet تم تخزينه في قاعدة البيانات بالتعديلات التي اجريتها.',
	...
	'LOCATION_DISABLED_EXPLAIN'   => 'هذه الاعدادات منقوله ولا يمكن تغييرها',
	...
	'TEMPLATE_DELETE_DEPENDENT'   => 'لايمكن اتمام عمليه الالغاء . هناك استايل اخر او اكثر يستخدم خواص منقوله من هذا الاستايل',
	...
	'TEMPLATE_ERR_REQUIRED_OR_INCOMPLETE' => 'الاستايل الجديد يتطلب وجود الاستايل  %s ولايمكن استيراد الخواص من تلقاء نفسه ',
	'THEME_FILE'	=> 'اسم الثيم',
	'TEMPLATE_INHERITS'         => 'هذا الاستيل يستورد مكوناته من الاستايل  %s وبالتالى لا يمكن ان تخزن في مسار مختلف',
