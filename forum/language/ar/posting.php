...
$lang = array_merge($lang, array(
	...
	'ATTACH_SIG'	=> 'أرفق التوقيع (يمكنك ضبط إعدادات التوقيع من <a href="ucp.php?i=profile&mode=signature"> لوحه التحكم</a>)',
	...
	'LOAD'	=> 'تحميل',
	'VIEW_PRIVATE_MESSAGE'	=> 'عرض الرسائل الخاصه',
	...
	'POST_STORED_MOD'	=> 'شكرا على مشاركتك . سيتم مراجعتها من قبل الاداره ،',
	...
	'TOO_MANY_CHARS_POST'		=> 'رسالتك تحتوى على %1$d حروف. الحد الاقصى المسموح به للحروف هو %2$d.',
	'TOO_MANY_CHARS_SIG'		=> 'توقيعك يحتوى على %1$d حروف. الحد الاقصى من الحروف المسموح به هو %2$d.',
	...
	'WRONG_SIZE'				=> 'أبعاد الصورة يجب أن تكون على الأقل %1$d بكسل عرضاً و %2$d بكسل ارتفاعاً وعلى الأكثر %3$d بكسل عرضاً و %4$d بكسل ارتفاعاً. أبعاد الصورة المقدمة هي %5$d بكسل عرضاً و %6$d بكسل ارتفاعاً.',
	   'DISALLOWED_CONTENT'      => 'تم ايقاف التحميل . الملف المحمل ربما يمثل خطرا محتمل على المنتدى',
));
