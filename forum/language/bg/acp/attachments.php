...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Максимален размер на прикачените файлове в ЛС за всеки потребител, 0 е за неограничен.',
   ...
   'CHECK_CONTENT'             => 'Проверявай прикачениет файлове',
   'CHECK_CONTENT_EXPLAIN'      => 'При някои браузъри може да има проблеми с mimetypes. Тази опция проверява дали има проблем и го отстранява.',
	...
	'MAX_ATTACHMENTS'				=> 'Максимален брой прикачени файлове към мнение',
	'MAX_ATTACHMENTS_PM'			=> 'Максимален брой прикачени файлове към съобщение',
