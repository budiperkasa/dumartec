...
$lang = array_merge($lang, array(
	...
	'ALLOW_MASS_PM_EXPLAIN'      => 'Дава възможност за изпращане на масови лични съобщения до група потребители.',
    ...
    'PM_MAX_RECIPIENTS_EXPLAIN'   => 'Максималният брой получатели при изпращането на лични съобщения. Ако е въведено 0, броят е неограничен. Тази опция може да бъде настройвана за всяка съществуваща група.',
));
...
$lang = array_merge($lang, array(
    ...
    'ENABLE_QUEUE_TRIGGER'         => 'Включи queued posts',
    'ENABLE_QUEUE_TRIGGER_EXPLAIN'   => 'Тази функция ви дава възможност да ограничите потребителите с определен брой мнения. Когато броят на мненията е по-малък от избрания, техните мнения няма да се показват веднага, а ще трябва да бъдат одобрени от администратор/модератор.',
    'QUEUE_TRIGGER_POSTS'         => 'Максимален брой мнения за queued posts функцията',
    'QUEUE_TRIGGER_POSTS_EXPLAIN'   => 'Ако функцията queued posts е включена, потребителите ще трябва да достигнат въведената от вас цифра, за да могат да публикуват мненият, без те да трябва да бъдат одобрявани от вас.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'MIN_CHARS'					=> 'Минимално',
    'MIN_TIME_REG'            => 'Минимум време за регистрация',
    'MIN_TIME_REG_EXPLAIN'      => 'Ограничение при времето за регистрация на потребители.',
    'MIN_TIME_TERMS'         => 'Минимум време за четене на условията за ползвате',
    'MIN_TIME_TERMS_EXPLAIN'   => 'Ограничение при времето за прочит на условията за ползване.',
...
$lang = array_merge($lang, array(
    ...
    'FORM_TIME_MIN'                 => 'Минимално време за изпращане на форма',
    'FORM_TIME_MIN_EXPLAIN'         => 'Ако потребител напише и изпрати съобщение по-бързо от въведената стройност, форума ще игнорира мнението му. Можете да използвате 0 за да изключите тази опция.',
	...
	'REF_HOST'						=> 'Валидирай хост',
	'REF_PATH'						=> 'Валидирай път',
	'REFERER_VALID'					=> 'Валидирай реферал',
	'REFERER_VALID_EXPLAIN'         => 'Ако опцията е включена форума ще проверява дали POST Querty-то е с правилни хост, път и реферал. Това може да Ви създаде проблеми ако използвате няколко домейн имена паркирани, или външна логин система..',
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Ако потребителя не съществува няма да бъде направен опит за създаването му.',
));
