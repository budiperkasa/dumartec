...
$lang = array_merge($lang, array(
    ...
    'ADM_LOGGED_OUT'      => 'Вие излязохте успешно от администраторския панел',
	'ADMIN'					=> 'Администрация',
    ...
    'SETTING_TOO_LOW'      => 'Въведената стойност за “%s” е прекалено малка. Минималната позволена е %d.',
    'SETTING_TOO_BIG'      => 'Въведената стойност за “%s” е прекалено голяма. Максималната позволена %d.',   
    'SETTING_TOO_LONG'      => 'Въведената стойност за “%s” е прекалено дълга. Максималната позволена дължина е %d.',
    'SETTING_TOO_SHORT'      => 'Въведената стойност за “%s” не е достатъчно дълга. Минималната позволена дължина е %d.', 
...
$lang = array_merge($lang, array(
	...
	'WRITABLE_CONFIG'      => 'Вашият конфигурационен файл (config.php) е с права за писане. Съветваме ви, да сложите CHMOD-а на 640 или поне на 644. Повече информация можете да намерите за <a href="http://en.wikipedia.org/wiki/Chmod" rel="external">chmod</a>.',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_DELETE_SHADOW_TOPIC'   => '<strong>Изтрита shadow тема</strong><br />» %s',
	...
	'LOG_MOVE'					=> '<strong>Преместена тема</strong><br />» от %s',
	...
	'LOG_REFERER_INVALID'      => '<strong>Реферал валидацията се провали</strong><br />»Реферала беше “<em>%1$s</em>”. Сесията е прекратена.',
