...
'GENERAL_FORUM_SETTINGS'   => 'Главни настройки',
	...
	'LINK'					=> 'Връзка',
    'LIST_SUBFORUMS'         => 'Подреди подфорумите в легенда',
    'LIST_SUBFORUMS_EXPLAIN'   => 'Показва подфорумите на форума на началната страница и навсякъде другаде като връзка в легенда, ако опцията "Покажи подфорума при форума" е включена.',
