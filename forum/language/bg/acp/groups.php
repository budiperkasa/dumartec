...
$lang = array_merge($lang, array(
	...
	'GROUP_MAX_RECIPIENTS'         => 'Максимален брой позволени получатели при личните съобщения.',
    'GROUP_MAX_RECIPIENTS_EXPLAIN'   => 'Максималният брой получатели при изпращане на лично съобщение. Ако въведете 0, ще бъдат използвани глобалните настройки на системата.',
...
'NO_VALID_USERS'         => 'Не сте избрали валидни потребители.',
	'NO_GROUPS_CREATED'			=> 'Няма създадена група.',
	'NO_PERMISSIONS'			=> 'Не копирай права',
	'NO_USERS'					=> 'Няма въведени потребители.',
	'NO_USERS_ADDED'         => 'Не бяха добавени потребители към групата.',
