...
$lang = array_merge($lang, array(
	...
	'BBCODE_HELPLINE_TOO_LONG'   => 'Помощният ред е прекалено дълъг.',
    'BBCODE_INVALID_TAG_NAME'   => 'BBCode таг името което сте избрали вече съществува.',
...
$lang = array_merge($lang, array(
    ...
    'SMILIE_NO_CODE'         => 'Усмивката “%s”  беше игнорирана, защото нямаше въведен код за нея.',
    'SMILIE_NO_EMOTION'         => 'Усмивката “%s” беше игнорирана, защото нямаше въведена емоция.',
