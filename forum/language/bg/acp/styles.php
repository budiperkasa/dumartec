...
$lang = array_merge($lang, array(
	...
	'EDITOR_DISABLED'               => 'Темплейт редактора е изключен.',
	'EXPORT'							=> 'Експортирай',
	...
	'LOCATION_DISABLED_EXPLAIN'   => 'Тази настройка не може да бъде променяна.',
	...
	'TEMPLATE_DELETE_DEPENDENT'   => 'Темплейта не може да бъде изтрит от него взаймстват:',
	...
	'TEMPLATE_ERR_REQUIRED_OR_INCOMPLETE' => 'Новият темплейт сет изиксва темата %s да бъде инсталирана и да не взаймодейства със себе си. ',
	...
	'TEMPLATE_INHERITS'         => 'Темплейт сета взаймодейства с %s и не може да има различни настройки.',
