...
$lang = array_merge($lang, array(
    'TRANSLATION_INFO'  => 'Превод: <a href="http://web-hosting.bg" target="_blank">Ioan Arnaudov</a>',
    'DIRECTION'         => 'ltr',
	...
	'AVATAR_DISALLOWED_CONTENT'      => 'Избраният аватар не може да бъде качен.',
    'ASCENDING'                     => 'Възходящ',
	...
	'ERR_UNWATCHING'               => 'Грешка при опит за премахване на абонамента.',
    'ERR_WATCHING'                  => 'Грешка при опит за абониране.',
    ...
    'NUM_POSTS_IN_QUEUE'      => array(
       0         => 'Няма мнения на опашката',      // 0
       1         => 'Едно мнение на опашката',      // 1
       2         => '%d мнения на опашката',      // 2+
    ),
    ...
    'THE_TEAM'            => 'Екип',
    'TIME'                => 'Време',
	'TOO_LONG'                  => 'Въведената стойност е твърде дълга.',
	...
	'TOO_SHORT'                  => 'Въведената стройност е твърде къса.',
