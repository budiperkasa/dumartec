...
$lang = array_merge($lang, array(
    ...
    'CANNOT_JOIN_GROUP'         => 'Вие не можете да се присъедините към тази група. Вие можете да участвате в отворени групи.',
    'CANNOT_RESIGN_GROUP'      => 'Вие не можете да напуснете тази група. Вие можете да напускате единствено отворени групи.',
    'CHANGED_DEFAULT_GROUP'      => 'Групата по подразбиране беше променена успешно.',
