...
$lang = array_merge($lang, array(
	...
	'CONTINUE_UPDATE'				=> 'Продължи обновяващия процес сега',
	...
	'DOWNLOAD_UPDATE_METHOD_BUTTON'      => 'Свали файла с модифицирания архив (препоръчително)',
	...
	'NUMBER_OF_FILES_COLLECTED'      => 'phpBB намери разлика в двата файла %1$d и %2$d.<br />Изчакайте докато операцията приключи.',
	...
	'TRY_DOWNLOAD_METHOD'      => 'Може би ще искате да опитате метода със свалянето на модифицираните файлове.<br />Този метод винаги работи и е препоръчителен за използване.',
    'TRY_DOWNLOAD_METHOD_BUTTON'=> 'Изпробвай този метод сега',
