...
$lang = array_merge($lang, array(
	...
	'IM_NO_JABBER'			=> 'Директното изпращане на съобщения до Jabber потребители не се поддържа. За да изпращате съобщения до Jabber потребител, ви трябва Jabber клиент.',
