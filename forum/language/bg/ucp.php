...
$lang = array_merge($lang, array(
	...
	'AVATAR_EXPLAIN'            => 'Максимални размери; ширина: %1$d пиксела, височина: %2$d пиксела, размер: %3$.2f KiB.',
	...
	'INVALID_USER_BIRTHDAY'         => 'Въведената дата на раждане е невалидна.',
	...
	'NO_AUTH_PASSWORD_REMINDER'      => 'Вие нямате права за искане на нова парола.',
    'NO_AUTH_READ_HOLD_MESSAGE'      => 'Вие нямате права да четете лични съобщения, които са на изчакване.',
	...
	'NO_WATCHED_SELECTED'      => 'Вие не сте избрали форум или тема.',
