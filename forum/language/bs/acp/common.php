...
'ACP_ATTACHMENTS'=> 'Attachmenti',
'ACP_ATTACHMENT_SETTINGS'=> 'Postavke attachmenta',
'ACP_AUTH_SETTINGS'=> 'Provjera autentičnosti ',
'ACP_AUTOMATION'=> 'Automatizacija',
'ACP_AVATAR_SETTINGS'=> 'Postavke avatara',
'ACP_BACKUP'=> 'Backup',
'ACP_BAN'=> 'Banovanje',
'ACP_BAN_EMAILS'=> 'Banovanje e-mail adresa',
'ACP_BAN_IPS'=> 'Banovanje IP adresa',
'ACP_BAN_USERNAMES'=> 'Banovanje korisničkih imena',
'ACP_BBCODES'=> 'BBKodovi',
'ACP_BOARD_CONFIGURATION'=> 'Konfigurisanje foruma',
...
'ACP_COOKIE_SETTINGS'=> 'Postavke cookia',
...
'ACP_DISALLOW'=> 'Zabrani',
'ACP_DISALLOW_USERNAMES'=> 'Zabranjena korisniča imena',
...
'ACP_GROUPS'=> 'Grupe',
'ACP_GROUPS_FORUM_PERMISSIONS'=> 'Forumske permisije grupa',
...
'ACP_INDEX'=> 'Administracijski panel početna',
...
'ACP_MAIN'=> 'Administracijski panel početna',
...
'ACP_NO_ITEMS'=> '/',
'ACP_ORPHAN_ATTACHMENTS'=> 'Bezpostni attachmenti',
'ACP_PERMISSIONS'=> 'Permisije',
'ACP_PERMISSION_MASKS'=> 'Maske permisija',
'ACP_PERMISSION_ROLES'=> 'Setovi permisija',
'ACP_PERMISSION_TRACE'=> 'Praćenje permisija',
'ACP_PHP_INFO'=> 'PHP info',
'ACP_POST_SETTINGS'=> 'Postavke postanja',
'ACP_PRUNE_FORUMS'=> 'Brisanje foruma',
'ACP_PRUNE_USERS'=> 'Brisanje korisnika/ca',
...
'ACP_RESTORE'=> 'Restore',
'ACP_SEARCH'=> 'Konfigurisanje pretraživanja',
...
'ACP_SERVER_CONFIGURATION'=> 'Konfigurisanje servera',
...
'ACP_STYLES'=> 'Stilovi',
'ACP_TEMPLATES'=> 'Templejti',
'ACP_THEMES'=> 'Teme',
'ACP_UPDATE'=> 'Ažuriranje u tijeku',
'ACP_USERS_FORUM_PERMISSIONS'=> 'Forumske permisije korisnika/ca',
'ACP_USERS_LOGS'=> 'Logovi korisnika/ca',
'ACP_USERS_PERMISSIONS'=> 'Permisije korisnika/ca',
'ACP_USER_ATTACH'=> 'Attachmenti',
...
'ACP_VIEW_ADMIN_PERMISSIONS'=> 'Administratorske permisije',
'ACP_VIEW_FORUM_MOD_PERMISSIONS'=> 'Forumske moderatorske permisije',
'ACP_VIEW_FORUM_PERMISSIONS'=> 'Forumske permisije',
'ACP_VIEW_GLOBAL_MOD_PERMISSIONS'=> 'Globalne moderatorske permisije',
'ACP_VIEW_USER_PERMISSIONS'=> 'Korisničke permisije',
...
'ADMIN_INDEX'=> 'Administracijski panel početna',
...
'DIRECTORY_NOT_DIR'=> 'Unesena putanja “%s” nije folder.',
'DIRECTORY_NOT_WRITABLE'=> 'Unesena putanja “%s” nije prepisiva.',
'DISABLE'=> 'Isključi',
'DOWNLOAD'=> 'Preuzmi',
'DOWNLOAD_AS'=> 'Preuzmi kao',
'DOWNLOAD_STORE'=> 'Preuzmi ili pohrani datoteku',
'DOWNLOAD_STORE_EXPLAIN'=> 'Datoteku možeš direktno preuzeti ili ju pohraniti u folder za pohranjivanje [<samp>store/</samp>].',
...
'GENERAL_OPTIONS'=> 'Opšte mogućnosti',
'GENERAL_SETTINGS'=> 'Opšte postavke',
'GLOBAL_MASK'=> 'Maska globalnih permisija',
...
'LOGIN_ADMIN'=> 'Kako bi mogao/la administrirati forum, moraš imati permisije.',
...
'MANAGE'=> 'Upravljanje',
'MENU_TOGGLE'=> 'Sakrij odnosno prikaži bočni meni',
...
'NO_PASSWORD_SUPPLIED'=> 'Moraš unijeti šifru kako bi mogao/la pristupiti <em>Administriranju foruma</em>.',
...
'PIXEL'=> 'px',
'PROCEED_TO_ACP'=> 'Klikni %sovdje%s za odlazak u Administracijski panel.',
...
// PHP info
$lang = array_merge($lang, array(
'ACP_PHP_INFO_EXPLAIN'=> 'Ovdje možeš vidjeti informacije o tome koja je verzija PHP-a instalirana na server.<br />Info uključuje detalje o modulima, dostupnim varijablama i zadanim postavkama.<br />Ove informacije mogu biti od koristi kod dijagnostike u slučaju pojave problema.<br />Neki provajderi ograničavaju prikaz pojedinih informacija zbog sigurnosnih razloga. Preporučeno je ne davati ikakve detalje [ovdje vidljive] ikome osim u slučaju da to traže <a href="http://www.phpbb.com/about/team/">članovi/ce službenog tima</a> (s) foruma podrške.',
...
// Logs
$lang = array_merge($lang, array(
'ACP_ADMIN_LOGS_EXPLAIN'=> 'Ovdje su izlistane radnje izvršene od strane administratora/ica.<br />Možeš ih poredati po korisničkom imenu, datumu, IP adresi odnosno radnji.<br />Ukoliko imaš potrebne permisije, možeš izbrisati pojedine logove odnosno cijelu listu.',
'ACP_CRITICAL_LOGS_EXPLAIN'=> 'Ovdje su izlistane radnje izvršene od strane samog foruma.<br />Logovi pružaju informacije koje, u pravilu, služe za rješavanje specifičnih problema [npr. neisporučeni e-mailovi].<br />Možeš ih poredati po korisničkom imenu, datumu, IP adresi odnosno radnji.<br />Ukoliko imaš potrebne permisije, možeš izbrisati pojedine logove odnosno cijelu listu.',
'ACP_MOD_LOGS_EXPLAIN'=> 'Ovdje su izlistane radnje izvršene od strane moderatora/ica.<br />Možeš ih poredati po korisničkom imenu, datumu, IP adresi odnosno radnji.<br />Ukoliko imaš potrebne permisije, možeš izbrisati pojedine logove odnosno cijelu listu.',
...
'AVATAR_DIR_SIZE'=> 'Veličina foldera avatara',
...
'FILES_PER_DAY'=> 'Attachmenta dnevno',
'FORUM_STATS'=> 'Statistika foruma',

'GZIP_COMPRESSION'=> 'Gzip kompresija',

'NOT_AVAILABLE'=> 'Nedostupno',
'NUMBER_FILES'=> 'Ukupno attachmenta',
'NUMBER_POSTS'=> 'Ukupno postova',
'NUMBER_TOPICS'=> 'Ukupno tema',
'NUMBER_USERS'=> 'Ukupno korisnika/ca',
'NUMBER_ORPHAN'=> 'Ukupno bezpostnih attachmenta',

'POSTS_PER_DAY'=> 'Postova dnevno',
'PURGE_CACHE'=> 'Isprazni cache',
'PURGE_CACHE_CONFIRM'=> 'Jesi li siguran/na da želiš isprazniti cashe memoriju?',
'PURGE_CACHE_EXPLAIN'=> 'Briše cashe memoriju.',

'RESET_DATE'=> 'Resetuj datum pokretanja foruma',
'RESET_DATE_CONFIRM'=> 'Jesi li siguran/na da želiš resetovati datum pokretanja foruma?',
'RESET_ONLINE'=> 'Resetuj brojač najviše korisnika/ca istovremeno online',
'RESET_ONLINE_CONFIRM'=> 'Jesi li siguran/na da želiš resetovati brojač najviše korisnika/ca istovremeno online?',
...
'RESYNC_POST_MARKING'=> 'Resinkroniziraj potačkane teme',
'RESYNC_POST_MARKING_CONFIRM'=> 'Jesi li siguran/na da želiš resinkronizirati potačkane teme?',
'RESYNC_POST_MARKING_EXPLAIN'=> 'Sve će teme prvo biti odznačene da bi potom označenima (p)ostale samo one za koje je utvrđena aktivnost u posljednjih šest mjeseci.',
...
'UPLOAD_DIR_SIZE'=> 'Veličina postanih attachmenta',
...
'LOG_ATTACHMENTS_DELETED'	=> '<strong>Izbrisani attachmenti korisnika/ce</strong><br />» %s',
'LOG_ATTACH_EXT_ADD'=> '<strong>Dodana ili uređena ekstenzija attachmenta</strong><br />» %s',
'LOG_ATTACH_EXT_DEL'=> '<strong>Izbrisana ekstenzija attachmenta</strong><br />» %s',
'LOG_ATTACH_EXT_UPDATE'=> '<strong>Ažurirana ekstenzija attachmenta</strong><br />» %s',
...
'LOG_ATTACH_FILEUPLOAD'=> '<strong>Bezpostni attachment dodan postu</strong><br />» ID %1$d - %2$s',
'LOG_ATTACH_ORPHAN_DEL'=> '<strong>Bezpostni attachment izbrisan</strong><br />» %s',
'LOG_BAN_EXCLUDE_USER'=> '<strong>Izuzet/a korisnik/ca od banovanja</strong> iz razloga “<em>%1$s</em>”<br />» %2$s',
'LOG_BAN_EXCLUDE_IP'=> '<strong>Izuzet/a IP adresa od banovanja</strong> iz razloga “<em>%1$s</em>”<br />» %2$s',
'LOG_BAN_EXCLUDE_EMAIL' => '<strong>Izuzet/a e-mail adresa od banovanja</strong> iz razloga “<em>%1$s</em>”<br />» %2$s',
'LOG_BAN_USER'=> '<strong>Banovan korisnik/ca</strong> iz razloga “<em>%1$s</em>”<br />» %2$s',
'LOG_BAN_IP'=> '<strong>Banovana IP adresa</strong> iz razloga “<em>%1$s</em>”<br />» %2$s',
'LOG_BAN_EMAIL'=> '<strong>Banovana e-mail adresa</strong> iz razloga “<em>%1$s</em>”<br />» %2$s',
'LOG_UNBAN_USER'=> '<strong>Skinut ban sa korisnika</strong><br />» %s',
'LOG_UNBAN_IP'=> '<strong>Skinut ban sa IP adresa</strong><br />» %s',
'LOG_UNBAN_EMAIL'=> '<strong>Skinut ban sa e-mail adresa</strong><br />» %s',
...
'LOG_BOT_ADDED'=> '<strong>Dodan novi bot</strong><br />» %s',
'LOG_BOT_DELETE'=> '<strong>Izbrisan bot</strong><br />» %s',
'LOG_BOT_UPDATED'=> '<strong>Ažuriran bot</strong><br />» %s',
...
'LOG_CONFIG_ATTACH'=> '<strong>Promijenjene postavke attachmenta</strong>',
...
'LOG_CONFIG_COOKIE'=> '<strong>Promijenjene postavke cookia</strong>',
...
'LOG_DB_RESTORE'=> '<strong>Urađen restore baze podataka</strong>',
...
'LOG_LANGUAGE_PACK_DELETED'=> '<strong>Izbrisan jezički paket</strong><br />» %s',
...
'LOG_LANGUAGE_FILE_REPLACED'=> '<strong>Zamijenjena jezička datoteka</strong><br />» %s',
'LOG_LANGUAGE_FILE_SUBMITTED'=> '<strong>Poslana jezička datoteka i smještena u folder za pohranu</strong><br />» %s',
...
'LOG_MODULE_DISABLE'=> '<strong>Log Modul disable</strong><br />» %s',
'LOG_MODULE_ENABLE'=> '<strong>Log modul enable</strong><br />» %s',
...
'LOG_A_ROLE_ADD'=> '<strong>Administratorski set permisija dodan</strong><br />» %s',
'LOG_A_ROLE_EDIT'=> '<strong>Administratorski set permisija uređen</strong><br />» %s',
'LOG_A_ROLE_REMOVED'=> '<strong>Administratorski set permisija izbrisan</strong><br />» %s',
'LOG_F_ROLE_ADD'=> '<strong>Forumski set permisija dodan</strong><br />» %s',
'LOG_F_ROLE_EDIT'=> '<strong>Forumski set permisija uređen</strong><br />» %s',
'LOG_F_ROLE_REMOVED'=> '<strong>Forumski set permisija izbrisan</strong><br />» %s',
'LOG_M_ROLE_ADD'=> '<strong>Moderatorski set permisija dodan</strong><br />» %s',
'LOG_M_ROLE_EDIT'=> '<strong>Moderatorski set permisija uređen</strong><br />» %s',
'LOG_M_ROLE_REMOVED'=> '<strong>Moderatorski set permisija izbrisan</strong><br />» %s',
'LOG_U_ROLE_ADD'=> '<strong>Korisnički set permisija dodan</strong><br />» %s',
'LOG_U_ROLE_EDIT'=> '<strong>Korisnički set permisija uređen</strong><br />» %s',
'LOG_U_ROLE_REMOVED'=> '<strong>Korisnički set permisija izbrisan</strong><br />» %s',
...
'LOG_TEMPLATE_ADD_DB'=> '<strong>Dodan novi set templejta u bazu podataka</strong><br />» %s',
'LOG_TEMPLATE_ADD_FS'=> '<strong>Dodan novi set templejta na sistem datoteka</strong><br />» %s',
'LOG_TEMPLATE_CACHE_CLEARED'=> '<strong>Izbrisane cacheirane verzije datoteka templejta <em>%1$s</em></strong><br />» %2$s',
'LOG_TEMPLATE_DELETE'=> '<strong>Izbrisan set templejta</strong><br />» %s',
'LOG_TEMPLATE_EDIT'=> '<strong>Uređen set templejta <em>%1$s</em></strong><br />» %2$s',
'LOG_TEMPLATE_EDIT_DETAILS'=> '<strong>Uređeni detalji templejta</strong><br />» %s',
'LOG_TEMPLATE_EXPORT'=> '<strong>Eksportiran set templejta</strong><br />» %s',
'LOG_TEMPLATE_REFRESHED'=> '<strong>Osvježen set templejta</strong><br />» %s',
...
'LOG_USER_DEL_ATTACH'=> '<strong>Izbrisani svi attachmenti korisnika/ce</strong><br />» %s',
...
'LOG_USER_NEW_PASSWORD'=> '<strong>Promijenjena šifra korisnika/ce</strong><br />» %s',
