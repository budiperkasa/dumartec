...
'ACP_GROUPS_MANAGE_EXPLAIN'=> 'Odavde možeš administrirati sve grupe.<br />Možeš dodavati/brisati/uređivati grupe, dodjeljivati grupama vođe, mijenjati tipove grupa [otvorena/zatvorena/skrivena...] i dr.',
...
'COPY_PERMISSIONS_EXPLAIN'=> 'Po kreiranju, grupa će dobiti (imati) iste permisije kao izabrana.',
...
'GROUP_MESSAGE_LIMIT'=> 'Privatnu(e) poruku(e) grupe ograniči na folder(e)',
'GROUP_MESSAGE_LIMIT_EXPLAIN'=> 'Ove postavke prepisuju (dotadašnje) postavke korisnika/ce (a) vezane uz ograničenje(a) foldera poruka.<br />Vrijednost 0 znači da će biti korištena zadana ograničenja korisnika/ce.',
...
'NO_PERMISSIONS'=> 'Nemoj kopirati permisije',
...
'TOTAL_MEMBERS'=> 'Članovi',

'USERS_APPROVED'=> 'Korisnici/e su odobreni/e.',
'USER_DEFAULT'=> 'Korisnički zadano',
'USER_DEF_GROUPS'=> 'Korisnički definirane grupe',
'USER_DEF_GROUPS_EXPLAIN'=> 'Korisnički definirane grupe su grupe koje su kreirali/e (kreiraju) administratori/ce.<br />Možeš upravljati Članovima, uređivati postavke grupa te (čak i) izbrisati grupe.',
