<?php
/** 
* acp_permissions (phpBB Permission Set) [Bosnian]
*
* @package language
* @version $Id: $
...
'acl_u_chgpasswd'=> array('lang' => 'Može mijenjati šifru', 'cat' => 'profile'),
...
'acl_u_attach'=> array('lang' => 'Može dodavati attachmente', 'cat' => 'post'),
...
'acl_u_pm_attach'=> array('lang' => 'Može dodavati attachmente u privatnim porukama', 'cat' => 'pm'),
...
'acl_f_attach'=> array('lang' => 'Može dodavati attachmente', 'cat' => 'content'),
...
'acl_f_subscribe'=> array('lang' => 'Može se prijaviti za praćenje foruma/tema', 'cat' => 'actions'),
...
'acl_m_delete'=> array('lang' => 'Može brisati postove', 'cat' => 'post_actions'),
'acl_m_approve'=> array('lang' => 'Može odobravati postove', 'cat' => 'post_actions'),
'acl_m_report'=> array('lang' => 'Može zaključivati i brisati prijave', 'cat' => 'post_actions'),
...
'acl_a_forumdel'=> array('lang' => 'Može brisati forume', 'cat' => 'forums'),
'acl_a_prune'=> array('lang' => 'Može brisati forume', 'cat' => 'forums'),
...
'acl_a_attach'=> array('lang' => 'Može mijenjati postavke vezane uz attachmente', 'cat' => 'posting'),
...
'acl_a_userdel'=> array('lang' => 'Može brisati korisnike/ce', 'cat' => 'user_group'),
...
'acl_a_groupdel'=> array('lang' => 'Može brisati grupe', 'cat' => 'user_group'),
...
'acl_a_clearlogs'=> array('lang' => 'Može brisati logove', 'cat' => 'misc'),
