...
'TOKEN'=> 'Token',
'TOKENS'=> 'Tokeni',
'TOKENS_EXPLAIN'=> 'Tokeni su rezervirana mjesta za korisničke unose.<br />Unosi će biti potvrđeni samo ukoliko odgovaraju pratećoj definiciji. Ukoliko je potrebno, možeš ih pobrojati dodavanjem broja zadnjem znaku između vitičastih zagrada, npr. {TEXT1}, {TEXT2}.<br /><br />Može koristiti bilo koji jezički niz podataka koji postoji u tvom folderu jezika, npr., kao: {L_<em>&lt;STRINGNAME&gt;</em>} gdje je <em>&lt;STRINGNAME&gt;</em> ime prevedenog niza podataka koji želiš dodati. Na primjer: {L_WROTE} će biti prikazano kao &quot;wrote&quot; odnosno kao prijevod (toga) ovisno o kojem se jezičkom paketu radi.<br /><br /><strong>Samo dolje izlistani tokeni mogu biti korišteni.</strong>',
...
'SIMPLETEXT' => 'Znakovi (latin) abecede (A-Z), brojevi, zarezi, tačke, razmaci, -, +, − i _.',
'IDENTIFIER' => ' Znakovi (latin) abecede (A-Z), brojevi, − i _.',
'NUMBER'=> 'Bilo koji/kakav niz brojeva.',
...
'RANK_IMAGE_EXPLAIN'=> 'Slika (koje će biti) povezana (prikazana) sa statusom.<br />Putanja je relativna u odnosu na root phpBB folder.',
...
'DELETE_DISALLOW_EXPLAIN'=> 'Korisničko ime možeš izbrisati tako da ga izabereš s liste i klikneš na odgovarajuće dugme/naredbu.',
'DELETE_DISALLOW_TITLE'=> 'Brisanje nedopuštenog korisničkog imena',
...
'IS_NOT_TRANSLATED_EXPLAIN'=> 'Razlog <strong>nije</strong> lokaliziran.<br />Ukoliko želiš lokaliziran oblik, odredi tačan ključ iz sekcije razloga prijave(a) jezičkih datoteka.',
