...
'ALPHA_SPACERS'=> 'Alfanumerički znakovi i razmak',
'ALWAYS_TODAY'=> 'Uvijek trenutan datum',

'BOOL_ENTRIES_EXPLAIN'=> 'Unesi opcije.',
'BOOL_TYPE_EXPLAIN'=> 'Definiraj tip za odabir: ili kvadratići [checkbox] ili kružići [radio buttons].<br />Kvadratić će biti prikazan samo ako je označen za korisnika/cu u  slučaju čega će <strong>druga</strong> jezička opcija biti korištena. Kružići će biti prikazani bez obzira na njihovu vrijednost.',
...
'DEFAULT_LANGUAGE_NOT_FILLED'=> 'Jezički unosi zadanog jezika nisu ispunjeni za (ovo) korisničko polje.',
...
'FIELD_DROPDOWN'=> 'Padajući Meni',
'FIELD_IDENT'=> 'Identifikacija polja',
'FIELD_IDENT_ALREADY_EXIST'=> 'Izabrana identifikacija polja (već) postoji.<br />Izaberi drugo ime.',
'FIELD_IDENT_EXPLAIN'=> 'Identifikacija polja je ime koje služi za identifikaciju korisničkog polja u bazi podataka i templejtima.',
'FIELD_INT'=> 'Brojevi',
...
'INVALID_CHARS_FIELD_IDENT'=> 'Identifikacija polja može sadržavati samo mala slova i donju crticu(e) (_).',
...
'STEP_3_EXPLAIN_CREATE'=> 'Kako imaš instalirano više od jednog jezičnog paketa, moraš ispuniti preostale jezičke stavke.<br />Korisničko polje će raditi s omogućenim zadanim jezikom [što će reći da preostale jezičke stavke možeš naknadno ispuniti].',
'STEP_3_EXPLAIN_EDIT'=> 'Kako imaš instalirano više od jednog jezičkog paketa, možeš mijenjati/dodavati (pre)ostale jezičke stavke.<br />Korisničko polje će raditi s omogućenim zadanim jezikom.',
