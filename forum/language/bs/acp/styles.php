...
'ACP_IMAGESETS_EXPLAIN'=> 'Set slika obuhvaća sve dugmiće [forumske] i ne-stilske specifične slike koje koristi forum.<br />Ovdje možeš uređivati/izbrisat/eksportirati postojeće te importirati/aktivirati nove setove slika.',
'ACP_STYLES_EXPLAIN'=> 'Ovdje možeš upravljati dostupnim stilovima.<br />Stil se sastoji od templejta, teme i seta slika.<br />Možeš mijenjati/izbrisati/aktivirati/deaktivirati postojeće stilove te kreirati/importirati nove.<br />Korištenjem funkcije prikaza stil(ov)a, možeš vidjeti kako stil(ovi) izgleda(ju).<br />Zadani stil označen je zvjezdicom (*).<br />Izlistan je (i) broj korisnika/ca koji/e koriste pojedini stil s time da nije naznačeno radi li se o prisilno prepisanom stilu [<em>Onemogući korisnički stil</em>] već je prikazano onako kako su korisnici/e izabrali/e u svom korisničkom profilu.',
'ACP_TEMPLATES_EXPLAIN'=> 'Set templejta sadrži sve stavke kojima se generira izgled foruma.<br /> Ovdje možeš mijenjati/izbrisati/eksportirati/importirat/pregledavati setove templejta.<br />Također možeš mijenjati kod templejta korišten za generiranje BBKoda.',
...
'ADD_TEMPLATE'=> 'Kreiraj templejta',
'ADD_TEMPLATE_EXPLAIN'=> 'Ovdje možeš dodati novi set templejta.<br />Ovisno o konfiguraciji servera i dopuštenjima datoteka, možda ćeš na raspolaganju imati (neke) dodatne opcije. Npr. možda ćeš moći bazirati novi set templejta na već postojećem; možda ćeš moći uploadirati/importirati [iz foldera za pohranjivanje] arhivu templejta [ukoliko uploadiraš/importiraš arhivu, ime templejta može opcionalno biti preuzeto od imena arhive (ukoliko to želiš, ostavi(š) ime templejta prazno)] itd.',
...
'CACHE_FILENAME'=> 'Datoteka templejta',
...
'CONFIRM_TEMPLATE_CLEAR_CACHE'=> 'Jesi li siguran/na da želiš izbrisati/isprazniti sve cacheirane verzije datoteka templejta?',
'CONFIRM_TEMPLATE_REFRESH'=> 'Jesi li siguran/na da želiš osvježiti/zamijeniti sve podatke templejta pohranjene u bazi podataka sa sadržajem datoteka predloška u sistemu datoteka?<br />To će prepisati sve izmijene templejta koje su napravljene uređivačem templejta za vrijeme dok je templejt bio pohranjen u bazi podataka.',
...
'DELETE_TEMPLATE'=> 'Izbriši templejta',
'DELETE_TEMPLATE_EXPLAIN'=> 'Ovdje možeš, označen set templejta, izbrisati iz baze.<br />Opcionalno, ukoliko imaš dopuštenja, možeš izbrisati set iz sistema datoteka. Imaj na umu da nema povratne [undo] mogućnosti što će reći da je templejta izbrisan bespovratno nakon što ga (jednom) izbrišeš. Ne bi bilo zgorega, prvo ga eksportirati, zbog eventualnog budućeg korištenja.',
...
'EDIT_TEMPLATE'=> 'Uređivanje templejta',
'EDIT_TEMPLATE_EXPLAIN'=> 'Ovdje možeš direktno uređivati set templejta.<br />Imaj na umu da su uređenja trajna i ne mogu biti povraćena [undone] nakon slanja.<br />Ukoliko PHP može prepisivati datoteke predloška u mapi stilova, sve će promjene direktno biti zapisane u (same) datoteke. Ukoliko PHP ne može pre(za)pisivati datoteke, datoteke će biti kopirane u bazu podataka te će (sve) promjene biti odražene samo tamo.<br />Pažljivo uređuj/mijenjaj setove predloška te zapamti zatvoriti sve mijenjajuće varijabilne uvjete {XXXX} kao i ostale stavke.',
'EDIT_TEMPLATE_STORED_DB'=> 'Datoteka templejta je (bila) neprepisiva poradi čega je set templejta pohranjen u bazu podataka tako da sadržava izmijenjenu datoteku.',
'EDIT_THEME'=> 'Uređivanje teme',
'EDIT_THEME_EXPLAIN'=> 'Ovdje možeš uređivati teme mijenjajući im boje, slike itd.',
'EDIT_THEME_STORED_DB'=> 'Stylesheet datoteka je (bila) neprepisiva pa je pohranjena, sadržavajući izmjene, u bazu podataka.',
...
'IMG_CAT_BUTTONS'=> 'Lokalizirani dugmići',
...
'IMG_CAT_UI'=> 'Opšti elementi sučelja korisnika/ca',
'IMG_CAT_USER'=> 'Opcionalne/dodatne slike',

'IMG_SITE_LOGO'=> 'Glavni logo',
'IMG_UPLOAD_BAR'=> 'Upload bar',
...
'INCLUDE_TEMPLATE'=> 'Uključi templejt',
...
'INSTALL_TEMPLATE'=> 'Instaliraj templejt',
'INSTALL_TEMPLATE_EXPLAIN'=> 'Ovdje možeš instalirati novi set templejta.<br />O konfiguraciji servera ovisi koje ćeš opcije imati na raspolaganju.',
...
'INSTALLED_TEMPLATE'=> 'Instalirani templejti',
'INSTALLED_THEME'=> 'Instalirana teme',

'LINE_SPACING'=> 'Razmak među redovima',
...
'NO_TEMPLATE'=> 'Nije moguće pronaći templejt u sistemu datoteka.',
...
'NO_UNINSTALLED_TEMPLATE'=> 'Nema neinstaliranih templejta.',
...
'ONLY_TEMPLATE'=> 'Ovo je jedini (zadnji) preostali set templejta, ne možeš ga izbrisati.',
...
'REPLACE_IMAGESET_EXPLAIN'=> 'Izabrani set slika zamijenit će ovog kojeg brišeš u svim stilovima koji ga koriste.',
'REPLACE_STYLE'=> 'Zamijeni stil s(a)',
'REPLACE_STYLE_EXPLAIN'=> 'Izabrani stil zamijenit će ovog kojeg brišeš svim korisnicima/ama koji ga koriste.',
'REPLACE_TEMPLATE'=> 'Zamijeni templejt s(a)',
'REPLACE_TEMPLATE_EXPLAIN'=> 'Izabrani set templejta zamijenit će ovog kojeg brišeš u svim stilovima koji ga koriste.',
'REPLACE_THEME'=> 'Zamijeni temu s(a)',
'REPLACE_THEME_EXPLAIN'=> 'Izabrana tema zamijenit će ovu koju brišeš u svim stilovima koji ju koriste.',
...
'SELECTED_TEMPLATE'=> 'Izabran templejt',
'SELECTED_TEMPLATE_FILE'=> 'Izabrana datoteka templejta',
...
'STYLE_ERR_NO_IDS'=> 'Moraš odabrati templejt, temu i set slika za stil.',
...
'STYLE_EXPORT_EXPLAIN'=> 'Ovdje možeš eksportirati stil u arhivski oblik. Stil ne mora sadržavati sve elemente, ali mora sadržavati najmanje jedan. Npr. ukoliko si kreirao/la novu temu i set slika za najčešće korišten templejt, možeš jednostavno eksportirati temu i set slika (a) izostaviti templejt. Možeš izabrati hoćeš li datoteku preuzeti direktno ili ju pohraniti u mapu za pohranu podataka za kasnije preuzimanje odnosno preuzimanje FTP-om.',
'STYLE_EXPORTED'=> 'Stil je eksportiran i pohranjen u %s.',
'STYLE_IMAGESET'=> 'Set slika',
'STYLE_NAME'=> 'Ime stila',
'STYLE_TEMPLATE'=> 'Templejt',
'STYLE_THEME'=> 'Tema',
'STYLE_USED_BY'=> 'Koristi (uključujući robote)',

'TEMPLATE_ADDED'=> 'Set templejta je dodan i pohranjen u sistem datoteka.',
'TEMPLATE_ADDED_DB'=> 'Set templejta je dodan i pohranjen u bazu podataka.',
'TEMPLATE_CACHE'=> 'Cache templejta',
'TEMPLATE_CACHE_EXPLAIN'=> 'Zadano, phpBB cacheira izrađenu verziju svojih templejta (a) što smanjuje, prilikom pregledavanja stranice, opterećenje servera te može skratiti vrijeme generiranja stranice. Ovdje možeš vidjeti cache status svake datoteke i izbrisati pojedinačne datoteke ili kompletan cache.',
'TEMPLATE_CACHE_CLEARED'=> 'Cache templejta je izbrisan.',
'TEMPLATE_CACHE_EMPTY'=> 'Nema cacheiranih templejta.',
'TEMPLATE_DELETED'=> 'Set templejta je izbrisan.',
'TEMPLATE_DELETED_FS'=> 'Set templejta je izbrisan iz baze, ali je moguće da su pojedine datoteke ostale u sistemu datoteka.',
'TEMPLATE_DETAILS_UPDATED'=> 'Detalji templejta su ažurirani.',
'TEMPLATE_EDITOR'=> 'Raw HTML uređivač templejta',
'TEMPLATE_EDITOR_HEIGHT'=> 'Visina uređivača templejta',
'TEMPLATE_ERR_ARCHIVE'=> 'Izaberi metodu arhiviranja.',
'TEMPLATE_ERR_CACHE_READ'=> 'Nije bilo moguće otvoriti cache mapu namijenjenu pohranjivanju cacheiranih verzija datoteka templejta.',
'TEMPLATE_ERR_COPY_LONG'=> 'Autorska prava ne mogu biti duža od 60 znakova.',
'TEMPLATE_ERR_NAME_CHARS'=> 'Ime templejta može sadržavati samo alfanumeričke znakove, -, +, _ i razmak.',
'TEMPLATE_ERR_NAME_EXIST'=> 'Templejt s (pod) tim imenom već postoji.',
'TEMPLATE_ERR_NAME_LONG'=> 'Ime templejta ne može biti duže od 30 znakova.',
'TEMPLATE_ERR_NOT_TEMPLATE'=> 'Arhiva koju si unio/la ne sadrži valjan set templejta.',
'TEMPLATE_ERR_STYLE_NAME'=> 'Moraš unijeti ime za (ovaj) templejt.',
'TEMPLATE_EXPORT'=> 'Eksportiraj templejt/e',
'TEMPLATE_EXPORT_EXPLAIN'=> 'Ovdje možeš eksportirati set templejta u arhivski oblik. Arhiva će sadržavati sve podatke potrebne za instalaciju seta templejta na drugi forum. Možeš izabrati hoćeš li datoteku preuzeti direktno ili ju pohraniti u folder za pohranu podataka za kasnije preuzimanje odnosno preuzimanje FTP-om.',
'TEMPLATE_EXPORTED'=> 'Templejt/i je/su eksportiran/i i pohranjen/i u %s.',
'TEMPLATE_FILE'=> 'Datoteka templejta',
'TEMPLATE_FILE_UPDATED'=> 'Datoteka templejta je ažurirana.',
'TEMPLATE_LOCATION'=> 'Pohrani templejte u',
'TEMPLATE_LOCATION_EXPLAIN'=> 'Slike su uvijek pohranjene u sistemu datoteka.',
'TEMPLATE_NAME'=> 'Ime templejta',
'TEMPLATE_REFRESHED'=> 'Templejt je osvježen.',
...
'UNINSTALLED_TEMPLATE'=> 'Neinstalirani templejti',
