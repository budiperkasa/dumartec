...
array(
0 => 'Kako dodati attachment u post?',
1 => 'Za postanje attachmenta, ukoliko je administrator/ica omogućio/la tu opciju te ukoliko imaš sva dopuštenja, [vidjet ćeš formu <em>Dodavanje attachmenta</em> ispod okvira za pisanje teksta posta], koristiš <strong>[attachment=][/attachment]</strong> tag(ove).'
),
array(
0 => '--',
1 => 'Ostalo'
