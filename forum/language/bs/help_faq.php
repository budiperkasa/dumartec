...
array(
0 => 'Što ako izgubim šifru?',
1 => 'Nije smak svijeta! Jest da je tvoja trenutna šifra izgubljena [jer je kriptirana u bazi i ne može ti biti ponovo poslana], no, možeš zatražiti novu.<br />Klikneš na <em>Prijava</em> te na stranici koja će ti se otvoriti klikneš na <em>Zaboravio/la sam šifru</em>. Ispuniš tražene podatke... Daljnje upute će ti stići e-mailom.'
),
array(
0 => 'Zašto se uopće ne mogu prijaviti?',
1 => 'Prvo provjeri jesi li unio/la točno <em>korisničko ime</em> i <em>zaporku</em>.<br />Ako jesi, dogodila se jedna od dvije moguće stvari: ako si prilikom Registracije, a COPPA podrška je bila omogućena, kliknuo/la na <em>Slažem se i imam manje od 13 godina</em> morat ćeš slijediti upute koje su ti stigle e-mailom; ili je možda potrebna aktivacija tvojeg 
...
array(
0 => 'Što “Izbriši sve cookies radi?',
1 => 'Izbrisuje sve cookies koje je kreirao phpBB3, a koji, inače, sadrže informacije o tvojem prijavljivanju, pregledanim/pročitanim forumima/temama/postovima i sl.<br />Ukoliko imaš problema s prijavljivanjem/odjavljivanjem, (obično) pomaže brisanje cookisa.',
),
array(
0 => '--',
...
1 => 'Post možeš urediti/uređivati, [bilo kada odnosno, ukoliko je administrator/ica tako odredio, samo određeno vremensko razdoblje nakon postanja posta odnosno uopće ne], klikom na gumb <em>uredi</em>.<br />Ukoliko je u međuvremenu netko odgovorio na tvoj post, a ti ga naknadno urediš, primijetit ćeš da se “u postu pojavila” rečenica koja govori o tome koliko si puta i kada zadnji put uredio/la post [rečenica se neće pojaviti ukoliko nije bilo odgovora na post].<br />Post možeš izbrisati klikom na dugmić <em>izbriši</em>. Primijetit ćeš da neke postove nećeš moći izbrisati [npr. ako je u međuvremenu netko odgovorio na njih].<br />Postoji mogućnost da administrator(ica)/moderator(ica) izmijeni/izbriše tvoj post [u prvom slučaju bi svakako trebao/la napisati opasku što je i zašto izmijenio/la].'
),
array(
...
array(
0 => 'Zašto ne mogu dodavati attachmente?',
1 => 'Mogućnost dodavanja attachmenta, na forumu(ima) za grupu(e)/korisnika(cu) daje administrator/ica foruma.<br />Ukoliko ne možeš doda(va)ti attachmente, moguće je da je administrator/ica onemogućio/la dodavanje attachmenta baš za taj određen forum na kojem si pokušao/la dodati attachment/e odnosno da samo određeni/e korisnici(e)/grupe mogu dodavati attachmente na tom forumu.<br />Ukoliko ti nije jasno zašto (baš) ti ne možeš doda(va)ti attachmente, kontaktiraj administratora/icu.'
),
array(
...
array(
0 => 'Čemu služi dugmić “Pohrani” prilikom postanja/pisanja poruke(a)?',
...
1 => 'Administrator/ica može donijeti odluku prema kojoj je na [određenom(im)] forumu(ima) potrebno odobrenje kako bi post(ovi) bio(li) postan(i) ili te je administrator/ica pridružio/la korisničkoj grupi Članovimaa koje postove treba odobriti kako bi bili objavljeni. Za detalje, kontaktiraj administratora/icu.'
),
array(
...
1 => 'Da. Postoje dvije bitne stvari koje treba zapamtiti kod postanja slika: prvo, mnogi/e korisnici/e ne vole puno slika u postovima/porukama, i drugo, ukoliko je administrator/ica foruma onemogućio postanje attachmenta, slika koju umećeš/umetneš mora biti dostupna na Internetu, npr. http://www.example.com/my-picture.gif [ne može postojati samo na tvojem računalu - osim ako imaš webserver odnosno na stranicama koje nisu dostupne javnosti, stranicama zaštićenima zaporkama i sl.].<br />Da bi postao/la sliku: moraš obuhvatiti URL, na kojem se slika nalazi, sa BBKod [img][/img] tago(vi)m(a).'
),
array(
...
1 => 'Moderatori/ce su osobe [osoba ili (korisnička) grupa osoba] čiji je <em>“posao”</em> održavanje foruma.<br />Imaju ovlasti mijenjanja/brisanja postova, zaključavanja/otključavanja/premještanja/izbrisivanja/razdvajanja tema u forumima koje održavaju.<br />Tu su (i) da bi spriječili/e korisnike/ce od skretanja s tema/objavljivanja nedopuštenih sadržaja i sl.'
),
array(
...
1 => 'Na dva načina:<br />- putem profila korisnika/ce [klikom na link dodaješ ga/ju na listu prijatelja(ica)/gnjavatora(ica)];<br />- putem korisničkog profila <em>[Profil/Postavke]</em> [unošenjem korisničkog/ih imena u za to predviđeno polje].<br />Na isti način brišeš korisnike/ce s lista.'
),
array(
0 => '--',
...
1 => 'Klikom na <em>Članovi</em>, link se nalazi na svim stranicama, otvorit će se stranica, s popisom članova/ica foruma, na kojoj se nalazi forma za pretraživanje [<em>Pronađi korisničko ime</em>].'
),
array(
...
array(
0 => 'Koja je razlika između bookmarkiranja teme/a i Pračenje komentara na temu/e?',
...
array(
0 => 'Kako se mogu prijaviti za praćenje na forum/temu?',
1 => 'Kako bi se prijavio/la na forum, prilikom pregledavanja foruma, dovoljno je kliknuti na link <em>Prijavi se</em>.<br />Kako bi se prijavio/la na temu, prilikom pregledavanja teme, dovoljno je kliknuti na link <em>Prijavi se</em> odnosno prilikom postanja posta, upaliti opciju <em>Obavijesti me kad odgovor bude postan</em>.'
),
array(
0 => 'Kako se mogu Odjaviti?',
1 => 'U korisničkom profilu <em>[Profil/Postavke]</em> klikneš na link <em>Prijeve</em> i slijediš upute.'
),
array(
0 => '--',
1 => 'Attachmenti'
...
array(
0 => 'Postanje kojih attachmenta je dopušteno?',
1 => 'Administrator/ica određuje postanje kojih attachmenta je dopušteno.<br />
Ukoliko nisi siguran/na postanje kojih attachmenta je dopušteno, kontaktiraj administratora/icu.'
),
array(
0 => 'Kako mogu pronaći (sve) vlastite attachmente?',
1 => 'U korisničkom profilu <em>[Profil/Postavke]</em> klikneš na link <em>Attachmenti</em>.'
),
array(
0 => '--',
1 => 'phpBB3'
...
array(
0 => 'Tko i kako do?',
1 => 'Ovaj prijevod, s engleskog [originalna verzija]i hrvatskog na bosanski, napravio je <a href="http://medresamostar.com/">Šehić Nijaz</a>.<br />[]<br />Zadnju verziju ovog prijevoda možeš skinuti sa <a href="http://www.phpbb.com/languages/">www.phpbb.com</a>.'
)
);
?>