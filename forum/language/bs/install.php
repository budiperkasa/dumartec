...
'ADMIN_PASSWORD'=> 'Šifra administratora/ice',
'ADMIN_PASSWORD_CONFIRM'=> 'Potvrdi šifru administratora/ice',
'ADMIN_PASSWORD_EXPLAIN'=> 'Unesi šifru dužine između 6 i 30 znakova.',
...
'CONFIG_CONVERT'=> 'Konvertuj konfiguracije',
'CONFIG_FILE_UNABLE_WRITE'=> 'Nije bilo moguće prepisati konfiguracijsku datoteku.<br />Alternativna metoda je kreirati datoteku i uporabiti je dolje.',
...
'CONV_ERROR_ATTACH_FTP_DIR'=> 'Na starom forumu je omogućeno FTP uploadiranje za privitke.<br />Onemogući opciju FTP uploadiranja, provjeri je l’ određen valjan folder za uploadiranje, te kopiraj sve datoteke attachmenta u (taj novi) pristupačni folder. Kada to napraviš, ponovo pokreni konverter.',
...
'CONV_ERROR_INSERT_BOT'=> 'Nije moguće umetnuti bota u tablicu korisnika/ca.',
'CONV_ERROR_INSERT_BOTGROUP'=> 'Nije moguće umetnuti bote u tablicu botova.',
...
'DB_PASSWORD'=> 'Šifra baze podataka',
...
'DEFAULT_PREFIX_IS'=> 'Converter nije uspio pronaći tablice sa specificiranim prefiksom.<br />Provjeri jesi li unio/la točne detalje foruma koji pokušavaš konvertirati.<br />Zadani prefiks tablica za %1$s je <strong>%2$s</strong>.',
'DEV_NO_TEST_FILE'=> 'U konverter nije unesena vrijednost varijable od test_file. Ukoliko si korisnik/ca ovog konvertera, ne bi smio/la vidjeti ovu grešku, pa, te molim(o), prijavi ovu grešku autoru/ici konvertora. Ukoliko si autor/ica ovog konvertora, moraš unijeti ime postojeće datoteke izvornog koda foruma kako bi odobrio/la putanji verifikaciju.',
'DIRECTORIES_AND_FILES'=> 'Instalacija/podešavanje foldera i datoteka',
...
'DL_CONFIG_EXPLAIN'=> 'Možeš preuzeti config.php na računalo. Trebao/la bi ručno, u root phpBB 3.0 folder, uploadirati datoteku (i to) na način da njome zamijeniš postojeću config.php datoteku. Datoteku uploadiraj u ASCII formatu [ukoliko ne znaš što je ASCII format odnosno kako uploadirati datoteku, potraži pomoć u dokumentaciji FTP programa koji koristiš]. Kada uploadiraš config.php datoteku, klikni na “Gotovo” kako bi mogao/la prijeći na sljedeći korak.',
'DL_DOWNLOAD'=> 'Preuzimanje',
'DONE'=> 'Gotovo',

'ENABLE_KEYS'=> 'Re-omogućavanje ključeva. Može potrajati neko vrijeme.',

'FILES_OPTIONAL'=> 'Opcionalne datoteke i folderi',
...
'FILES_REQUIRED'=> 'Datoteke i folderi',
'FILES_REQUIRED_EXPLAIN'=> '<strong>Obvezno</strong>: kako bi mogao ispravno funkcionirati, phpBB mora imati pristup odnosno mogućnost pre(za)pisivanja određenih datoteka/foldera. Ukoliko vidiš “Nije pronađeno”, moraš kreirati odgovarajuću datoteku ili folder. Ukoliko vidiš “Nepre(za)pisljivo”, moraš promijeniti dopuštenja datoteka/folder i to tako da postanu pre(za)pisljive od strane phpBB-a.',
...
'FORUM_PATH_EXPLAIN'=> '<strong>Relativna</strong> putanja, na disku, do starog foruma, <strong>s root foldera phpBB instalacije</strong>.',
'FOUND'=> 'Pronađeno',
'FTP_CONFIG'=> 'Transferiranje config datoteke FTP-om',
'FTP_CONFIG_EXPLAIN'=> 'phpBB je uočio prisutnost FTP modula na serveru. Ukoliko želiš, možeš, pokušati, instalirati config.php time. Morat ćeš unijeti informacije izlistane ispod. Moraš znati korisničko ime i šifru za pristup server [ukoliko ih ne znaš, kontaktiraj hosting uslugu za detalje].',
'FTP_PATH'=> 'FTP putanja',
'FTP_PATH_EXPLAIN'=> 'Ovo je putanja iz tvog root foldera do phpBB-a, npr. <samp>htdocs/phpBB3/</samp>.',
...
'INSTALL_CONGRATS_EXPLAIN'=> '<p>phpBB %1$s je uspješno instaliran.<br />Imaš dvije mogućnost, dolje opisane, što možeš napraviti s ovim, svježe instaliranim, phpBB3-om.</p><h2>Konvertovanje postojećeg foruma u phpBB3</h2><p>phpBB <em>Unified Convertor Framework</em> podržava konverziju phpBB 2.0.x, i ostalih forumskih sistema, u  phpBB3.<br />Ukoliko imaš postojeći forum, koji želiš konvertovati, <a href="%2$s">klikni ovdje za odlazak na konverter</a>.</p><h2>Pokreni svoj novi phpBB3!</h2><p>Klik na donji dugmić odvest će te u <em>Administraciju foruma [AF]</em>.<br />Ne bi bilo zgorega posvetiti malo vremena istraživanju dostupnih opcija/karakteristika/mogućnosti. Pomoć je dostupna putem <a href="http://www.phpbb.com/support/documentation/3.0/">Documentacije</a> i <a href="http://www.phpbb.com/community/viewforum.php?f=46">foruma podrške</a>; baci pogled (i) na <a href="%3$s">PročitajMe</a> za dodatne informacije.</p><p><strong>Za kraj ti je ostalo izbrisati/preimenovati/premjestiti instalacijski folder prije negoli pristupiš forumu. Ukoliko ne izbrišeš folder, samo će (ti) <em>Administracija foruma [Administracija Foruma]</em> biti dostupna.</strong></p>',
...
'INSTALL_INTRO_NEXT'=> 'Kako bi mogao/la (za)početi (s) instalaciju(om), klikni na donji dugmić.',
...
'INST_ERR_DB_FORUM_PATH'=> 'Specificirana datoteka baze podataka nalazi se u forumskom stablu foldera. Morao/la bi staviti/premjestiti datoteku na lokaciju kojoj nije moguće pristupiti putem Weba.',
...
'INST_ERR_PASSWORD_MISMATCH'=> 'Šifre koje si unio/la se ne podudaraju.',
'INST_ERR_PASSWORD_TOO_LONG'=> 'Šifra koju si unio/la je predugačka. Može sadržavati maksimalno 30 znakova.',
'INST_ERR_PASSWORD_TOO_SHORT'=> 'Šifra koju si unio/la je prekratka. Mora sadržavati minimalno 6 znakova.',
...
'MAKE_FOLDER_WRITABLE'=> 'Provjeri postoji li uopće (donji) folder i je l’ pre(za)pisiv od strane servera, te potom pokušaj ponovo.<br />»<strong>%s</strong>.',
'MAKE_FOLDERS_WRITABLE'=> 'Provjeri postoje li uopće (donji) folder i je li pre(za)pisiv od strane servera, te potom pokušaj ponovo.<br />»<strong>%s</strong>.',
...
'NO_CONVERTORS'=> 'Nema dostupnih konvertera za uporabu.',
...
'RETRY_WRITE_EXPLAIN'=> 'Ukoliko želiš, možeš promijeniti permisije za config.php (a) kako bi dopustio/la phpBB-u da ju pre(za)pis(uj)e. Ukoliko to želiš napraviti, klikni dolje na “Pokušaj ponovo” za (ponovni) pokušaj. Nemoj zaboraviti vratiti permisije za config.php nakon što instalacija phpBB-a bude gotova.',
...
'WRITABLE'=> 'Pre(za)pisivo',
));

// Updater
$lang = array_merge($lang, array(
'ALL_FILES_UP_TO_DATE'=> '(Sve) Datoteke su <em/>up to date</em> (najnovije) u odnosu na zadnju verziju phpBB-a.<br />Trebao/la bi se <a href="../ucp.php?mode=login">prijaviti na forum</a> i provjeriti radi li sve kako spada. Nemoj zaboraviti izbrisati/preimenovati/premjestiti install folder!',
...
'COMPLETE_LOGIN_TO_BOARD'=> 'Trebao/la bi se <a href="../ucp.php?mode=login">prijaviti na forum</a> i provjeriti radi li sve kako spada. Nemoj zaboraviti izbrisati/preimenovati/premjestiti install folder!',
'CONTINUE_UPDATE_NOW'=> 'Nastavi s procesom ažuriranja',
'CURRENT_FILE'=> 'Početak trenutne originalne datoteke',
'CURRENT_VERSION'=> 'Trenutna verzija',

'DATABASE_TYPE'=> 'Tip baze podataka',
'DATABASE_UPDATE_INFO_OLD'=> 'Datoteka ažuriranja baze podataka, u install folderu, je zastarjela. Provjeri jesi li uploadirao/la točnu verziju datoteke.',
...
'DIFF_SEP_EXPLAIN'=> 'Kraj trenutne originalne datoteke/Početak nove ažurirane datoteke',
...
'DOWNLOAD_UPDATE_METHOD_EXPLAIN'=> 'Nakon preuzimanja, trebaš otpakirati arhivu. Unutra ćeš pronaći izmijenjene datoteke koje moraš uploadirati u root folder, odnosno njegove podfoldere, ovisno o tome kamo koja datoteka spada, phpBB-a. Nakon uploadiranja svih datoteka, provjeri datoteke klikom na odgovarajući dugmić dolje.',
...
'NEW_FILE'=> 'Kraj nove ažurirane datoteke',
...
'NO_UPDATE_FILES_EXPLAIN'=> 'Sljedeće datoteke su nove ili izmijenjene ali nije moguće pronaći, u instalaciji, folder u kojoj su one obično smještene. Ukoliko lista sadrži datoteke do drugih foldera, poput language/ ili styles/, možda si izmijenio strukturu foldera, pa možda i ažuriranje nije kompletno.',
'NO_UPDATE_FILES_OUTDATED'=> 'Nije pronađen valjan folder za ažuriranje. Provjeri jesi li uploadirao/la relevantne datoteke.<br /><br />Čini se da instalacija <strong>nije/strong> <em/>up to date</em> (najnovija). Za tvoju verziju phpBB-a, %1$s , postoje ažuriranja, pa posjeti <a href="http://www.phpbb.com/downloads/" rel="external">http://www.phpbb.com/downloads/</a> kako bi preuzeo/la ispravan paket za ažuriranje iz Verzije %2$s u Verziju %3$s.',
...
'PERFORM_DATABASE_UPDATE_EXPLAIN'=> 'Ispod se nalazi dugmić do skripte za ažuriranje baze.<br />Ažuriranje baze može potrajati stoga nemoj prekinuti izvođenje ukoliko ti se učini predugim.<br />Nakon što ažuriranje baze bude uzvedeno, slijedi instrukcije za nastavak procesa ažuriranja.',
...
'VERSION_CHECK_EXPLAIN'=> 'Provjeravanje je li verzija phpBB-a, koja je u uporabi, <em/>up to date</em> (najnovija).',
