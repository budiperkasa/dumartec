...
'ACCOUNT_ADDED'=> 'Korisnički račun je kreiran.<br />Hvala ti što si se registrirao/la.<br />Možeš se prijaviti koristeći svoje korisničko ime i šifru.',
...
'ADD_FOES_EXPLAIN'=> 'Možeš dodati više korisničkih imena, svako u novi red.',
'ADD_FOLDER'=> 'Dodaj folder',
'ADD_FRIENDS'=> 'Dodaj prijatelja(e)/icu(e)',
'ADD_FRIENDS_EXPLAIN'=> 'Možeš dodati više korisničkih imena, svako u novi red.',
...
'ATTACHMENTS_DELETED'=> 'Attachmenti su izbrisani.',
'ATTACHMENT_DELETED'=> 'Attachment je izbrisan.',
...
'CANNOT_MOVE_TO_SAME_FOLDER'=> 'Postove/poruke ne možeš premjestiti u folder koji želiš izbrisati.',
'CANNOT_MOVE_FROM_SPECIAL'=> 'Poruke ne mogu biti premještene iz foldera <em>Odlazno</em>.',
'CANNOT_RENAME_FOLDER'=> 'Folder ne može biti preimenovan.',
'CANNOT_REMOVE_FOLDER'=> 'Folder ne može biti izbrisan.',
'CHANGE_DEFAULT_GROUP'=> 'Promijeni (u) zadanu grupu',
'CHANGE_PASSWORD'=> 'Promijeni šifru',
'CLICK_RETURN_FOLDER'=> '%1$sNatrag na “%3$s” folder%2$s.',
'CONFIRMATION'=> 'Potvrda registracije',
'CONFIRM_CHANGES'=> 'Potvrda promjena',
'CONFIRM_EMAIL'=> 'Potvrdi e-mail adresu',
'CONFIRM_EMAIL_EXPLAIN'=> 'Upiši šifru samo ako ju želiš promijeniti.',
'CONFIRM_EXPLAIN'=> 'Zbog sprječavanja automatskog registriranja, administrator/ica je upalio/la opciju obveznog unosa potvrdnog koda.<br />Kod je prikazan na slici koju bi trebao/la vidjeti ispod.<br />Ukoliko nikako ne možeš pročitati kod, kontaktiraj %sadministratora/icu%s.',
'CONFIRM_PASSWORD'=> 'Potvrdi šifru',
'CONFIRM_PASSWORD_EXPLAIN'=> 'Potvrdi šifru samo ako si ju [iznad] promijenio/la.',
...
'CURRENT_PASSWORD_EXPLAIN'=> 'Trenutnu šifru moraš potvrditi ako želiš promijeniti šifru/e-mail adresu/korisničko ime.',
'CUR_PASSWORD_ERROR'=> 'Trenutna šifra koju si upisao/la je netočna.',
...
'DELETE_ATTACHMENT'=> 'Izbriši attachment',
'DELETE_ATTACHMENTS'=> 'Izbriši attachmentr',
'DELETE_ATTACHMENT_CONFIRM'=> 'Jesi li siguran/na da želiš izbrisati attachment?',
'DELETE_ATTACHMENTS_CONFIRM'=> 'Jesi li siguran/na da želiš izbrisati attachmente?',
'DELETE_AVATAR'=> 'Izbriši sliku',
'DELETE_COOKIES_CONFIRM'=> 'Jesi li siguran/na da želiš izbrisati cookies?',
...
'DELETE_MESSAGES_IN_FOLDER'=> 'Izbriši sve poruke, koje se nalaze u folderu, skupa s folderom',
...
'FOLDER_ADDED'=> 'Folder je dodan.',
'FOLDER_MESSAGE_STATUS'=> '%1$d/%2$d poruka',
'FOLDER_NAME_EXIST'=> 'Folder <strong>%s</strong> već postoji.',
'FOLDER_OPTIONS'=> 'Postavke mapa',
'FOLDER_RENAMED'=> 'Folder je preimenovan.',
'FOLDER_REMOVED'=> 'Folder je izbrisan.',
'FOLDER_STATUS_MSG'=> 'Folder je %1$d%% pun (%2$d/%3$d poruka)',
'FORWARD_PM'=> 'Proslijedi PP',
'FORCE_PASSWORD_EXPLAIN'=> 'Prije, nastavka, pregledavanja foruma, moraš promijeniti šifru.',
...
'FULL_FOLDER_OPTION_CHANGED'=> 'Radnja, koja će biti izvršena u slučaju popunjenja foldera, je promijenjena/postavljena.',
...
'HOLD_NEW_MESSAGES'=> 'Ne primaj nove poruke [poruke će biti “na čekanju” dok ne bude oslobođeno dovoljno prostora za attachment]',
'HOLD_NEW_MESSAGES_SHORT'=> 'Nove poruke će biti “na čekanju”',

'IF_FOLDER_FULL'=> 'Ukoliko je folder pun',
...
'INVALID_CHARS_NEW_PASSWORD'=> 'Šifra ne sadrži potrebne znakove.',
...
'MOVE_DELETED_MESSAGES_TO'=> 'Premjesti sve poruke, koje se nalaze u folderu koji će biti izbrisan, u folder',
'MOVE_DOWN'=> 'Premjesti dolje',
'MOVE_MARKED_TO_FOLDER'=> 'Premjesti označeno u %s',
'MOVE_PM_ERROR'=> 'Došlo je do greške prilikom premještanja poruka u drugi/novi folder, samo %1d od %2d poruka je premješteno.',
'MOVE_TO_FOLDER'=> 'Premjesti u folder',
'MOVE_UP'=> 'Premjesti gore',

'NEW_EMAIL_ERROR'=> 'E-mail adrese koje si unio/la se ne podudaraju.',
'NEW_FOLDER_NAME'=> 'Novo ime foldera',
'NEW_PASSWORD'=> 'Nova šifra',
'NEW_PASSWORD_ERROR'=> 'Šifre koje si unio/la se ne podudaraju.',
...
'NOT_ENOUGH_SPACE_FOLDER'=> 'Odredišni folder “%s” je puna. Radnja nije izvršena.',
'NOT_MOVED_MESSAGE'=> 'Imaš 1 privatnu poruku “na čekanju” [folder je pun].',
'NOT_MOVED_MESSAGES'=> 'Imaš %d privatnih/e poruka/e “na čekanju” [folder je pun].',
...
'NO_NEW_FOLDER_NAME'=> 'Moraš specificirati novo ime foldera.',
'NO_NEWER_PM'=> 'Nema novijih poruka.',
'NO_OLDER_PM'=> 'Nema starijih poruka.',
'NO_PASSWORD_SUPPLIED'=> 'Nisi unio/la šifru.<br />Ne možeš se prijaviti bez šifre.',
'NO_RECIPIENT'=> 'Moraš unijeti primatelja/icu poruke.',
'NO_RULES_DEFINED'=> '/',
'NO_SAVED_DRAFTS'=> '/',
'NO_TO_RECIPIENT'=> '/',
'NO_WATCHED_FORUMS'=> 'Nisi prijavljen/a na niti jedan forum.',
'NO_WATCHED_TOPICS'=> 'Nisi prijavljen/a na niti jednu temu.',

'PASS_TYPE_ALPHA_EXPLAIN'=> 'Šifra mora sadržavati između %1$d i %2$d znaka/ova koji moraju biti kombinacija velikih/malih slova i brojeva.',
'PASS_TYPE_ANY_EXPLAIN'=> 'Mora sadržavati između %1$d i %2$d znaka/ova.',
'PASS_TYPE_CASE_EXPLAIN'=> 'Šifra mora sadržavati između %1$d i %2$d znaka/ova koji moraju biti kombinacija velikih/malih slova.',
'PASS_TYPE_SYMBOL_EXPLAIN'=> 'Šifra mora sadržavati između %1$d i %2$d znaka/ova koji moraju biti kombinacija velikih/malih slova, brojeva i simbola.',
'PASSWORD'=> 'Šifra',
'PASSWORD_ACTIVATED'=> 'Nova šifra je aktivirana.',
'PASSWORD_UPDATED'=> 'Šifra je poslana na [tvoju] e-mail adresu.',
...
'REMOVE_FOLDER'=> 'Izbriši folder',
'REMOVE_FOLDER_CONFIRM'=> 'Jesi li siguran/na da želiš izbrisati folder?',
'RENAME'=> 'Preimenuj',
'RENAME_FOLDER'=> 'Preimenuj folder',
'REPLIED_MESSAGE'=> 'Odgovoreno na poruku',
'RESIGN_SELECTED'=> 'Istupi',
'RETURN_FOLDER'=> '%1$sNatrag na prethodni folder.%2$s',
...
'SAME_PASSWORD_ERROR'=> 'Nova šifra koju si unio/la je ista kao i stara šifra.',
...
'UCP_WELCOME'=> 'Dobrodošao/la u Profil/Postavke.<br />Ovdje možeš pregleda(va)ti/ažurirati svoj profil, postavke, Pračenje komentara na forume/teme, slati poruke i dr.<br />Prije nastavka, molim(o), pročitaj sve obavijesti.',
...
'UNWATCH_MARKED'=> 'odjavi (me) s označenog',
...
'WATCHED_EXPLAIN'=> 'Ispod je popis foruma/tema koje pratiš [na koje si prijavljen/a], a što znači da će ti stizati obavijesti o novim temama na forumima na koje si prijavljen/a odnosno (o) odgovorima na teme na koje si prijavljen/a.<br />Ukoliko želiš prestati pratiti forum/temu, označi forum(e)/temu(e) koji/u/e/ želiš prestati pratiti i klikni na <em>Odjavi (me) s označenog</em>.',
'WATCHED_FORUMS'=> 'Forumi na koje si prijavljen/a',
'WATCHED_TOPICS'=> 'Teme na koje si prijavljen/a',
'WRONG_ACTIVATION'=> 'Aktivacijski ključ koji si unio/la ne odgovara niti jednom u  bazi podataka.',

'YOUR_DETAILS'=> 'Info',
'YOUR_FOES'=> '[Tvoji] Gnjavatori/ce',
'YOUR_FOES_EXPLAIN'=> 'Za brisanje korisničkog/ih imena s liste gnjavatora/ica, označi korisničko/a ime/na koje/a želiš izbrisati i klikni na <em>Pošalji</em>.',
'YOUR_FRIENDS'=> '[Tvoji] Prijatelji/ce',
'YOUR_FRIENDS_EXPLAIN'=> 'Za brisanje korisničkog/ih imena s liste prijatelja/ica, označi korisničko/a ime/na koje/a želiš izbrisati i klikni na <em>Pošalji</em>.',
'YOUR_WARNINGS'=> 'Upozorenja',

'PM_ACTION' => array(
'PLACE_INTO_FOLDER'=> 'Premjesti u folder',
