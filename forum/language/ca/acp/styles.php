...
$lang = array_merge($lang, array(
	...
	'ADD_IMAGESET_EXPLAIN'	=> 'Aquí podeu crear un grup d’imatges nou. Depenent de la configuració del servidor i els permisos dels fitxers, és possible que tingueu opcions addicionals. Per exemple, és posible que pugueu basar aquest grup d’imatges en un altre que ja existeixi. També és possible que pugueu pujar o importar (des del directori “store”) un arxiu de grup d’imatges. Si pugeu o importeu un arxiu, el nom del grup d’imatges es pot prendre, opcionalment, del nom de l’arxiu (per fer-ho deixeu el nom del grup d’imatges en blanc).',
	'ADD_STYLE'				=> 'Crea un estil',
	'ADD_STYLE_EXPLAIN'		=> 'Aquí podeu crear un estil nou. Depenent de la configuració del servidor i els permisos dels fitxers, és possible que tingueu opcions addicionals. Per exemple, és posible que pugueu basar aquest estil en un altre que ja existeixi. També és possible que pugueu pujar o importar (des del directori “store”) un arxiu d’estil. Si pugeu o importeu un arxiu, el nom de l’estil es determinarà automàticament.',
	'ADD_TEMPLATE'			=> 'Crea una plantilla',
	'ADD_TEMPLATE_EXPLAIN'	=> 'Aquí podeu crear una plantilla nova. Depenent de la configuració del servidor i els permisos dels fitxers, és possible que tingueu opcions addicionals. Per exemple, és posible que pugueu basar aquesta plantilla en un altra que ja existeixi. També és possible que pugueu pujar o importar (des del directori “store”) un arxiu de plantilla. Si pugeu o importeu un arxiu, el nom de la plantilla es pot prendre, opcionalment, del nom de l’arxiu (per fer-ho deixeu el nom de la plantilla en blanc).',
	'ADD_THEME'				=> 'Crea un tema',
	'ADD_THEME_EXPLAIN'		=> 'Aquí podeu crear un tema nou. Depenent de la configuració del servidor i els permisos dels fitxers, és possible que tingueu opcions addicionals. Per exemple, és posible que pugueu basar aquest tema en un altre que ja existeixi. També és possible que pugueu pujar o importar (des del directori “store”) un arxiu de tema. Si pugeu o importeu un arxiu, el nom del tema es pot prendre, opcionalment, del nom de l’arxiu (per fer-ho deixeu el nom del tema en blanc).',
