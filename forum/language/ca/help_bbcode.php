...
$help = array(
	...
	array(
		...
		1 => 'És clar que sí. Per exemple, per atreure l’atenció d’algú podrieu escriure:<br /><br /><strong>[size=200][color=red][b]</strong>MIRA’M!<strong>[/b][/color][/size]</strong><br /><br /> que es convertiria en <span style="color:red;font-size:200%;"><strong>MIRA’M!</strong></span><br /><br />No obstant, us recomanem que no abuseu dels texts amb aquest estil! Quan escrigueu una entrada, assegureu-vos de que les etiquetes estan tancades correctament. L’exemple següent és incorrecte:<br /><br /><strong>[b][u]</strong>Això és incorrecte<strong>[/b][/u]</strong>'
	),
	array(
		0 => '--',
