...
$help = array(
	...
	array(
		...
		1 => '“Elimina totes les galetes del fòrum” elimina les galetes creades pel phpBB que us mantenen autenticat i amb la sessió iniciada al fòrum. També proporciona funcions com ara el seguiment dels temes llegits si l’administrador del fòrum les ha habilitat. Si experimenteu problemes d’inici i finalització de sessió, és posible que eliminar les galetes del fòrum ho solucioni.',
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Igual com passa amb les entrades, una enquesta només pot editar-la el seu autor, un moderador o un administrador. Per editar una enquesta feu clic al botó “Edita” de la primera entrada del tema ja que sempre té associada l’enquesta. Si no s’ha emès cap vot, els usuaris poden eliminar l’enquesta o editar-ne les opcions. No obstant, si ja hi ha vots, només els moderadors i els administradors poden editar-la o eliminar-la. Això evita que es canvïin les opcions de l’enquesta al mig de la seva durada.'
	),
	array(
	...
	array(
		...
		1 => 'Si feu clic a l’enllaç “Reactiva el tema” que apareix quan el visualitzeu, podeu “reactivar-lo” fent que aparegui a la part superior del fòrum a la primera pàgina. No obstant, si no veieu l’enllaç, llavors és possible que la reactivació de temes estigui inhabilitada o que no hagi transcorregut el temps mínim entre reactivacions. També és possible reactivar el tema simplement escrivint-hi una resposta; assegureu-vos, però, que fent-ho no infringiu les regles del fòrum.'
	),
	array(
		0 => '--',
