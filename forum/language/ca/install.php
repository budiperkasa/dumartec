...
$lang = array_merge($lang, array(
	...
	'FILES_OPTIONAL_EXPLAIN'	=> '<strong>Opcionals</strong> - Aquests fitxers, directoris o configuracions de permisos no són necessaris. El sistema d’instal·lació provarà d’utilitzar diverses tècniques per crear-los si no existeixen o no es poden escriure. No obstant, la seva presència accelerarà la instal·lació.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>Heu instal·lat correctament el phpBB %1$s. A partir d’aquí teniu dues opcions per a la vostra nova instal·lació del phpBB3:</p>
		...
		<p>Si feu clic al botó següent, anireu al Tauler de control de l’administrador (TCA). Preneu-vos un cert temps per estudiar les opcions que teniu disponibles. Recoreu que disposeu d’ajuda en línia a la <a href="http://www.phpbb.com/support/documentation/3.0/">documentació</a> (en anglès) els <a href="http://www.phpbb.com/community/viewforum.php?f=46">fòrums d’assistència oficials</a> (en anglès) i els <a href="http://forums.phpbb.cat/viewforum.php?f=2">fòrums d’assistència en català</a>, teniu més informació al <a href="%3$s">LLEGIU-ME</a>.</p><p><strong>Si us plau elimineu, desplaceu o canvieu el nom del directori “install” abans d’utilitzar els fòrums. Mentre el directori encara hi sigui, només es podrà accedir al Tauler de control de l’administrador (TCA).</strong></p>',
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'La versió de Firebird instal·lda en aquesta màquina és massa antiga,  cal que l’actualitzeu, com a mínim, a la versió 2.0.',
	...
	'PHP_OPTIONAL_MODULE_EXPLAIN'	=> '<strong>Opcional</strong> - Aquests mòduls o aplicacions són opcionals. No obstant, si estan disponibles s’habilitaran funcions addicionals.',
	...
	'PHP_URL_FOPEN_SUPPORT_EXPLAIN'	=> '<strong>Opcional</strong> - Aquest parpàmetre és opcional, no obstant, determinades funcions del phpBB com ara els avatars externs no funcionaran correctament si està inhabilitat. ',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Tots els fitxers estan al dia amb la darrera versió del phpBB. És recomanable que <a href="../ucp.php?mode=login">inicieu la sessió al vostre fòrum</a> i comproveu que tot funciona correctament. No oblideu eliminar, canviar el nom o desplaçar el directori “install”!',
	...
	'CURRENT_FILE'					=> 'Inici del fitxer original actual',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Fi del fitxer original actual / Inici del fitxer nou actualitzat',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Fusiona les diferències i utilitza el codi modificat al bloc amb conflictes',
	'MERGE_NEW_FILE_OPTION'		=> 'Fusiona les diferències i utilitza el codi del fitxer nou al bloc amb conflictes',
	...
	'NEW_FILE'						=> 'Fi del fitxer nou actualitzat',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'De moment, s’han comprobat les diferències sobre %1$d dels %2$d fitxers.<br />Si us plau, espereu fins que es comprobin tots els fitxers.',
	...
	'PERFORM_DATABASE_UPDATE_EXPLAIN'	=> 'A continuació trobareu un botó a l’script d’actualització de la base de dades. L’actualització de la base de dades pot trigar una estona, per tant, no n’atureu l’execució tot i que sembli que s’ha penjat. Després de que s’hagi realitzat l’actualització de la base de dades, simplement seguiu les instruccions per continuar amb el procés d’actualització.',
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Comprova si la versió del phpBB que esteu executant actualment està al dia.',
	'VERSION_NOT_UP_TO_DATE'	=> 'La vostra versió del phpBB no està al dia. Continueu amb el procés d’actualització.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'La vostra versió del phpBB no està al dia.<br />A continuació trobareu un enllaç a l’avís de llançament de la versió més recent així com instruccions sobre com realitzar l’actualització.',
	'VERSION_UP_TO_DATE'		=> 'La vostra versió del phpBB està al dia, no hi ha cap actualització disponible. Si ho desitgeu, podeu realitzar una comprovació de validesa dels fitxers.',
	'VERSION_UP_TO_DATE_ACP'	=> 'La vostra versió del phpBB està al dia, no hi ha cap actualització disponible. No cal que actualitzeu la instal·lació.',
