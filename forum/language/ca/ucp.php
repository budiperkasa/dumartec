...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'S’ha actualitzat el vostre compte. No obstant, aquests fòrums requereixen la reactivació del compte quan es canvia l’adreça electrònica. S’ha enviat una clau de reactivació a la nova adreça electrònica que heu proporcionat. Si us plau comproveu el vostre correu electrònic per més informació.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'S’ha actualitzat el vostre compte. No obstant, aquests fòrums requereixen la reactivació del compte per part dels administradors quan es canvia l’adreça electrònica. Se’ls ha enviat un correu electrònic i se us informarà quan es reactivi el vostre compte.',
	'ACCOUNT_INACTIVE'				=> 'S’ha creat el vostre compte. No obstant, aquests fòrums requereixen l’activació dels comptes. S’ha enviat una clau d’activació a la nova adreça electrònica que heu proporcionat. Si us plau comproveu el vostre correu electrònic per més informació.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'S’ha creat el vostre compte. No obstant, aquests fòrums requereixen l’activació dels comptes per part dels administradors. Se’ls ha enviat un correu electrònic i se us informarà quan s’activi el vostre compte.',
	...
	'COPPA_EXPLAIN'				=> 'Tingueu en compte que en fer clic a Tramet es crearà el vostre compte. No obstant, no es pot activar fins que un dels vostres pares o tutors aprovi el vostre registre. Se us enviarà per correu electrònic una còpia del formulari necessari amb els detalls d’on l’heu d’enviar.',
	...
	'FOES_EXPLAIN'				=> 'Els enemics són usuaris que són ignorats per defecte. Les entrades d’aquests usuaris no seràn completament visibles. El missatges personals dels enemics sí que es permeten. Tingueu en compte que no podeu ignorar els moderadors o els administradors.',
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'Aquest missatge ha estat eliminat pel seu autor abans de que fos entregat.',
	...
	'PASSWORD_UPDATED'			=> 'S’ha enviat la contrasenya a la vostra adreça electrònica original correctament.',
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Tingueu en compte que haureu d’introduir una adreça electrònica vàlida abans de que el vostre compte sigui activat. L’administrador revisarà el vostre compte i si l’aprova rebreu un correu electrònic a l’adreça que heu especificat.',
	'UCP_AIM'					=> 'AOL Instant Messenger',
	'UCP_ATTACHMENTS'			=> 'Fitxers adjunts',
	'UCP_COPPA_BEFORE'			=> 'Abans del %s',
	'UCP_COPPA_ON_AFTER'		=> 'Durant o després del %s',
	'UCP_EMAIL_ACTIVATE'		=> 'Tingueu en compte que haureu d’introduir una adreça electrònica vàlida abans de que el vostre compte sigui activat. Rebreu un correu electrònic que conté un enllaç d’activació a l’adreça que heu especificat.',
	'UCP_ICQ'					=> 'Número ICQ',
