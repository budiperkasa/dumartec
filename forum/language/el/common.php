...
$lang = array_merge($lang, array(
	...
	'TRANSLATION_INFO'	=> '<br />Μετάφραση <a href="http://staff.forumup.gr/profile.php?mode=viewprofile&u=6&mforum=staff">Γιάννης Ορφανίδης</a> και <a href="http://www.phpbb2.gr">phpBB2.gr</a>',
	'DIRECTION'	=> 'ltr',
	'DATE_FORMAT'	=> '|d M Y|',
	'USER_LANG'	=> 'el',
	'1_DAY'	=> '1 ημέρα',
	...
	'AVATAR_PHP_SIZE_OVERRUN'	=> 'Το άβαταρ είναι πάρα πολύ μεγάλο. Το μέγιστο μέγεθος αρχείου που επιτρέπετε στο php.ini έχει καθοριστεί %d MB.<br />Παρακαλώ αυτό έχει οριστεί στο php.ini και δεν μπορεί να αγνοηθεί.',
