...
$lang = array_merge($lang, array(
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Διαφορές συγχώνευσης και τροποποιημένος χρήση κώδικας μέσα στο συγκρουόμενο μπλοκ',
	'MERGE_NEW_FILE_OPTION'		=> 'Διαφορές συγχώνευσης και νέος κώδικας αρχείων χρήσης μέσα στο συγκρουόμενο μπλοκ',
	...
	'NEW_FILE'						=> 'Τέλος του νέου αναβαθμισμένου αρχείου',
