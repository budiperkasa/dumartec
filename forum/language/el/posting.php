...
$lang = array_merge($lang, array(
	...
	'PHP_SIZE_OVERRUN'			=> 'Το μέγεθος του συνημμένου αρχείου είναι μεγάλο. Το μέγιστο μέγεθος που επιτρέπετε είναι %d ΜΒ.<br />Παρακαλώ σημειώστε ότι αυτό έχει οριστεί στο php.ini και δεν μπορεί να αγνοηθεί.',
