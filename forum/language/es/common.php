...
$lang = array_merge($lang, array(
	...
	'ACTIVE'	=> 'Activo',
	'ACTIVE_ERROR'	=> 'Ha especificado un usuario inactivo. Por favor active su cuenta e inténtelo de nuevo. Si continúa teniendo problemas, por favor contacte con La Administración del Sitio.',
	...
	'ATTACHED_IMAGE_NOT_IMAGE'	=> 'El archivo de imagen que intenta adjuntar no es válido.',
	'AUTHOR'	=> 'Autor',
	...
	'AVATAR_EMPTY_REMOTE_DATA'	=> 'No se puede subir el avatar, el archivo remoto parece inválido o corrupto.',
	...
	'AVATAR_NO_SIZE'	=> 'No se puede obtener ancho o alto del avatar, por favor ingréselo manualmente.',
	'AVATAR_PARTIAL_UPLOAD'	=> 'El archivo fue subido solo parcialmente',
	'AVATAR_PHP_SIZE_NA'	=> 'El tamaño del avatar es muy grande.<br />No se puede determinar el tamaño máximo definido por PHP en php.ini.',
	'AVATAR_PHP_SIZE_OVERRUN'	=> 'El tamaño del avatar es muy grande, el máximo a subir es %d MB.<br />Por favor obsérve que ese dato está definido en php.ini y no puede ser cambiado.',
	...
	'LOGIN_ERROR_PASSWORD_CONVERT'	=> 'No fue posible convertir su contraseña cuando se actualizó el software de este Sitio. Por favor %solicite nueva contraseña%s. Si sigue teniendo problemas por favor contacte con %sLa Administración del Sitio%s.',
