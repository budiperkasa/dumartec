...
$lang = array_merge($lang, array(
	...
	'USER_IS_MEMBER_OF_DEFAULT'	=> 'es miembro de los siguiente grupos pre-definidos',
	...
	'WRONG_PERMISSION_TYPE'	=> 'El tipo de permiso seleccionado es incorrecto.',
...
//	'TRACE_USER_YES_TOTAL_YES'				=> 'The user’s permission is set to <samp>YES</samp> and the total value is set to <samp>YES</samp>, so nothing is changed.',
	...
	'WRONG_PERMISSION_SETTING_FORMAT'   => 'Los parámetros de permisos están en un formato incorrecto, phpBB no es capaz de procesarlos correctamente.',
