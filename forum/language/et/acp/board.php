...
$lang = array_merge($lang, array(
        ...
        'ACP_AVATAR_SETTINGS_EXPLAIN'   => 'Avatarid on üldiselt väikesed, unikaalsed pildid, mida kasutaja saab endale määrata. Sõltuvalt stiilist on nad tavaliselt kuvatud kasutajanime all. Sini saad sa määrata, kuidas kasutajad saavad avatare endale lisada. Et lubada üleslaadimist, peab sul olema selleks erladi kaust, kuhu veebiserver saab kirjutada. Faili suuruse limiidid kehtivad vaid üleslaetud avataride puhul, limiit ei rakendu lingitud avatarile.',
        ...
        'ACP_MESSAGE_SETTINGS_EXPLAIN'  => 'Siina saad sa määrata privaatsõnumite seadeid',
        ...
        'ALLOW_MASS_PM' => 'Luba privaatsõnumite saatmist korraga mitmele kasutajale ja grupile.',
        ...
        'ENABLE_QUEUE_TRIGGER'         => 'Luba postituste järjekord',
        'ENABLE_QUEUE_TRIGGER_EXPLAIN'   => 'Võimalus panna kasutaja postitused heakskiidu järjekorda, kui tal pole vähemalt nii palju postitusi. See seade ei mõju õiguste seadetele.',
        'QUEUE_TRIGGER_POSTS'         => 'Maksimaalne postituste arv järjekorrastamiseks',
        'QUEUE_TRIGGER_POSTS_EXPLAIN'   => 'Kui järjekord on lubatud, on see number postituste arv, milleni kasutaja peab jõudma, et postitada ilma heakskiiduta. Kui kasutajal pole nii palju postitusi, pannakse tema postitus automaatselt järjekorda.',
        'BUMP_INTERVAL' => 'Tõstatamisintervall',
        'BUMP_INTERVAL_EXPLAIN' => 'Päevade, tundide või minutite arv, mis jääb viimase postituse ja teema tõstatamise võimaluse vahele.',
        ...
        'MAX_SIG_SMILIES'       => 'Mkasimaalne arv smailisid signatuurides',
        ...
        'ACP_REGISTER_SETTINGS_EXPLAIN' => 'Siin saad sa määrat registreerimise ja profiiliga seotud seaded',
        'ACC_ACTIVATION'        => 'Konto aktiveerimine',
        'ACC_ACTIVATION_EXPLAIN'        => 'Siin saab määrata, kas kasutajad saavad kohe foorumit kasutada või peavad nad enne aktiveerima oma konta. Võid ka keelata registreerimise.',
        ...
        'ACP_VC_SETTINGS_EXPLAIN'       => 'Siin saad sa määrata visuaalkinnituse vaikeväärtused ja CAPTCHA seaded',
        ...
        'CAPTCHA_PREVIEW_MSG'   => 'Sinu seadeid ei salvestatud. See on lihtsalt eelvaade.',
        'CAPTCHA_PREVIEW_EXPLAIN'       => 'CAPTCHA, nagu see välja näeb, kasutades praegusi seadeid. Kasuta eelvaate nuppu värskendamiseks.',
        'VISUAL_CONFIRM_POST'   => 'Luba visuaalkinnitus külaliste postistamisel',
        'VISUAL_CONFIRM_POST_EXPLAIN'   => 'Nõuab anonüümsetelt kasutajatelt koodi sisestamist, et vältida masspostitusi',
        'VISUAL_CONFIRM_REG'    => 'Luba visuaalkinnitus registreerimisel',
        'VISUAL_CONFIRM_REG_EXPLAIN'    => 'Nõuab uutelt kasutajatelt koodi sisestamist, et vältida massilist registreerimist',
        ...
        'CUSTOM_PROFILE_FIELDS' => 'Omaloodud profiiliväljad',
        ...
        'LIMIT_SESSIONS'        => 'Limiteeri sesssioone',
        ...
        'LOAD_CPF_MEMBERLIST'   => 'Luba stiilidel kuvada omaloodud profiilivälju kasutajate nimekirjas',
        'LOAD_CPF_VIEWPROFILE'  => 'Kuva omaloodud profiili väljad profiilis',
        'LOAD_CPF_VIEWTOPIC'    => 'Kuva omaloodud profiili väljad teemades',
        ...
        'LDAP_USER_FILTER_EXPLAIN'      => 'Võid piirata otsistavaid objekte filtritega. Näiteks, <samp>objectClass=posixGroup</samp> annab tulemuse ka <samp>(&(uid=$username)(objectClass=posixGroup))</samp> kasutades.',
        ...
        'CHECK_DNSBL_EXPLAIN'   => 'Kui lubatud, kontrollitakse kasutaja IP\'d registreerimisel ja postitamisel.',
        'CLASS_B'       => 'A.B',
        'CLASS_C'       => 'A.B.C',
        ...
        'CONTACT_EMAIL_EXPLAIN' => 'Seda aadressi kasutatakse, kui mingit kontakti on vaja, näiteks spämm, veateated jne. Seda kasutatakse <samp>Kellelt</samp> ja <samp>Kellele</samp> aadressine e-kirjades.',
        ...
        'ENABLE_EMAIL_EXPLAIN'  => 'Kui see on keelatud, ei saadeta ühtegi e-kirja läbi foorumi.',
        ...
        'JAB_PACKAGE_SIZE_EXPLAIN'      => 'See on sõnimite arv, mis saadetakse ühes pakis. Kui on määratud 0\'ks, saadetakse sõnumid automaatselt.',
        ...
        'JAB_USE_SSL_EXPLAIN'   => 'IKui lubatud, üritatakse turvaliselt ühenduda. Port muudetakse 5223, kui algne port on 5222.',
