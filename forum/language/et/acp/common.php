...
$lang = array_merge($lang, array(
        ...
        'ACP_CRITICAL_LOGS'     => 'Errorite logi',
        'ACP_CUSTOM_PROFILE_FIELDS'     => 'Vabavalikulised profiili väljad',
        'ACP_DATABASE'  => 'Andmebaasi haldus',
        'ACP_DISALLOW'  => 'Keelamine',
        'ACP_DISALLOW_USERNAMES'        => 'Keela kasutajanimesid',
        'ACP_EMAIL_SETTINGS'    => 'E-maili seaded',
        'ACP_EXTENSION_GROUPS'  => 'Halda faililaiendi gruppe',
        'ACP_FORUM_BASED_PERMISSIONS'   => 'Foorumi põhised õigused',
        ...
        'ACP_ICONS'     => 'Teema ikoonid',
        'ACP_ICONS_SMILIES'     => 'Teema ikoonid/smailid',
        ...
        'ACP_VC_SETTINGS'       => 'Kinnituskoodi seaded',
        ...
        'LOGIN_ADMIN'   => 'Et administreerida foorumit, pead olema autentitud kasutaja.',
        'LOGIN_ADMIN_CONFIRM'   => 'Et administreerida foorumit, pead ennast uuesti autentima.',
        'LOGIN_ADMIN_SUCCESS'   => 'Sa oled edukalt autentitud ja sind viiakse automaatselt nüüd Administraatori juhtpaneeli.',
        ...
        'NO_EMAILS_DEFINED'     => 'Ühtegi õiget e-maili aadressi ei leitud.',
        'NO_PASSWORD_SUPPLIED'  => 'Sa pead sisestama oma salasõna, et siseneda Administraatori juhtpaneeli.',
        'OFF'   => 'Väljas',
        'ON'    => 'Sees',
        'PARSE_BBCODE'  => 'Parsi BBCode´t',
        'PARSE_SMILIES' => 'Parsi smailisid',
        'PARSE_URLS'    => 'Parsi linke',
        ...
        'ACP_ADMIN_LOGS_EXPLAIN'        => 'See näitab kõiki toiminguid, mis on teinud foorumi administraator. Sa saad neid sorteerida kasutajanime, kuupäeva, IP või teo järgi.  Kui sul on vajalikud õigused, siis saad kustutada ka logisid.',
        'ACP_CRITICAL_LOGS_EXPLAIN'     => 'See näitab kõiki toiminguid, mis on teinud foorum ise. Sa saad neid sorteerida kasutajanime, kuupäeva, IP või teo järgi. Kui sul on vajalikud õigused, siis saad kustutada ka logisid.',
        'ACP_MOD_LOGS_EXPLAIN'  => 'See näitab kõiki toiminguid, mis on teinud moderaator. Sa saad neid sorteerida kasutajanime, kuupäeva, IP või teo järgi. Kui sul on vajalikud õigused, siis saad kustutada ka logisid.',
        ...
        'ADMIN_LOG_INDEX_EXPLAIN'       => 'See annab sulle ülevaate viiest viimasest teost, mille on läbi viinud foorumi administraator. Täiskoopia logist saab näha, kui vajutad linki siin all.',
        ...
        'INACTIVE_USERS_EXPLAIN_INDEX'  => 'See on nimekiri 10 viimasest kasutajast, kes registreerusid aga on mitteaktiivsed. Täielik nimekiri on saadaval kui vajutad siin all olevat linki.',
        ...
        'LOG_APPROVE_TOPIC'     => '<strong>Teem heaks kiidetud</strong><br />» %s',
        ...
        'LOG_FORUM_DEL_MOVE_POSTS_FORUMS'       => '<strong>Foorum ja selle alafoorumid kustutatud, sõnumid liigutatud</strong> %1$s foorumisse<br />» %2$s',
        'LOG_FORUM_DEL_MOVE_POSTS_MOVE_FORUMS'  => '<strong>Foorum kustutatud, postituse liigutatud</strong> %1$s foorumisse <strong>ja alafoorumid</strong> %2$s foorumisse<br />» %3$s',
        'LOG_FORUM_DEL_POSTS'   => '<strong>Foorum ja selle sõnumid kustutatud</strong><br />» %s',
        'LOG_FORUM_DEL_POSTS_FORUMS'    => '<strong>Foorum, selle sõnumid ja alafoorumid kustutatud</strong><br />» %s',
        'LOG_FORUM_DEL_POSTS_MOVE_FORUMS'       => '<strong>Foorum ja selle sõnumid kustutatud, alafoorumid liigutatud</strong> %1$s foorumissel<br />» %2$s',
        ...
        'LOG_GROUP_PROMOTED'    => '<strong>Kasutajad edutatud liidrtik kasutajagrupis</strong> %1$s<br />» %2$s',
        ...
        'LOG_USERS_APPROVED'    => '<strong>Kasutaja võetud kasutajagruppi</strong> %1$s<br />» %2$s',
        ...
        'LOG_SEARCH_INDEX_CREATED'      => '<strong>Otsingu ondeks loodud</strong><br />» %s',
        ...
        'LOG_STYLE_EXPORT'      => '<strong>Stiil eksportditud</strong><br />» %s',
        ...
        'LOG_UPDATE_DATABASE'   => '<strong>Uuendatud adnmebaas versioonilt %1$s versioonile %2$s</strong>',
        'LOG_UPDATE_PHPBB'      => '<strong>Uuuendatud phpBB versioonilt %1$s versioonile %2$s</strong>',
        'LOG_USER_ACTIVE'       => '<strong>Ksutaja aktiveeritud</strong><br />» %s',
        ...
        'LOG_USER_DEL_POSTS'    => '<strong>Eemaldatud kõik postitused, mis on teinud kasutaja</strong><br />» %s',
