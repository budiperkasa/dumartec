...
'ACP_RESTORE_EXPLAIN' => 'See teostab täistaastamise kõikidest phpBB tabelitest salvestatud failist. Kui sinu server toetab siis saad kasutada gzip või bzip2 kokku pakitud teksti faili. <strong>Hoiatus</strong> See kirjutab üle olemas olevad andmed. Taastamise protsess võib võtta kaua aega, palun ära liigu sellelt lehelt minema enne kui see on lõpetatud. Varukoopiad on salvestatud <samp>store/</samp> kausta ja on teeseldud et genereerida phpBB´s varukoopia funktsionaalselt. Varukoopiate taastamised mis ei ole tehtud süsteemis sees võivad töötada ja võivad mitte.',
