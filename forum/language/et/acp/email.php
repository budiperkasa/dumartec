...
'ACP_MASS_EMAIL_EXPLAIN' => 'Siin saad saata e-mail kirja kõigile kasutajatele või valitud grupile, <strong>millel on valikus lubatud mass e-maile vastu võtta</strong> Pimekoopia saadetakse ka administraatori e-mailile. Kui üritad saata kirja väga paljudele kasutajatele, siis ära lahku enne lehelt, kui script on lõpetanud saatmise, sest saatmisega lähebki kaua aega.',
'ALL_USERS' => 'Kõik kasutajad',
'COMPOSE' => 'Kirjuta uus kiri',
'EMAIL_SEND_ERROR' => 'Tekkis üks või rohkem erroreid e-maili saatmisel. Palun kontrolli %sErrorite logi%s täpsema errori kirjelduse saamiseks.',
...
'SEND_TO_USERS_EXPLAIN' => 'Kirjutades siia nimesid võib see tühistada valituid gruppe eelnevalt',
