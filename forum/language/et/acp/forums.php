...
$lang = array_merge($lang, array(
        ...
        'COPY_PERMISSIONS_EDIT_EXPLAIN' => 'Kui otsustad õigused kopeerida, saab foorum samad õigused, mis siin valitud. TSee kirjutab kõik eelnevad õigused üle. Kui ühtegi foorumit ei valita, jäetakse praegused õigused.',
        ...
        'FORUM_ADMIN_EXPLAIN'   => 'phpBB3\'s pole kategooriaid, kõik on foorumipõhine. Igal foorumil saab olla piiramatu arv alafoorumeid ja saad määrata, kas neisse saab poastitada.Siin saad lisada, muuta, kustutada, sulgeda ja avada foorumeid koos teiste seadetega. *Kui sinu postitused ja teemad on sünkroonist välja läinud, saad resünkroniseerida foorumeid. <strong>Pead kopeerima või määrama foorumile õigused enne, kui foorum nähtavale ilmub.</strong>',
        ...
        'FORUM_PASSWORD_OLD'    => 'Foorumi parool kasutab vana enkrüpteerimist ja seda peaks muutma.',
        ...
        'PRUNE_OLD_POLLS_EXPLAIN'       => 'Eemldab teemad, kus on hääletus, millesse pole postitatud postitus vanuse arv päevi.',
