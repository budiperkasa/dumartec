...
$lang = array_merge($lang, array(
	...
	'ACL_YES'	=> 'Jah',
	'ACP_ADMINISTRATORS_EXPLAIN'	=> 'Siin saad määrata administraatoriõigused kasutajale või grupile. Kõik kasutajad administraatori õigustega saavad vaadaata ADministraatori juhtpnaeeli.',
	'ACP_FORUM_MODERATORS_EXPLAIN'	=> 'Siin saad määrata kasutajaid ja gruppe moderaatoriteks. Et määrata kasutajate ligipäs foorumitele, et määrata üldmoderaatori õigused või administraatorid, kasuta vastavat lehte.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'	=> 'Siin saad määrata kasutajaid ja gruppe üldmodderaatoriteks. Need moderaatorid on nagu tavalisedki, kuid nad saavad modereerida iga foorumit.',
	...
	'APPLY_PERMISSIONS_EXPLAIN'	=> 'Õigused vja valitud roll sellele objektile rakendatakse sellel objektil ja teistel valitud objektidel.',
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'Selle rolli määramine ei muuda õigusi paremal. Kui soovid keelata/eemaldada kõik õigused, peakid kasutama "Kõik <samp>EI</samp>” linki.',
	...
	'ROLE_DESCRIPTION_FORUM_NOACCESS'	=> 'Ei saa näha ega oma ligipäsu foorumile.',
	...
	'ROLE_DESCRIPTION_USER_LIMITED'	=> 'Sab kasutada mõningaid kasutaja võimalusi. Manused, e-kirjad ja kiirsuhtluse sõnumid on keelatud.',
	...
	'ROLE_DESCRIPTION_USER_STANDARD'	=> 'Saab kasutada enamkke, kuid mitte kõiki funktsioone. Ei saa muuta kasutajanime ja ingoreerida postituste intervalli, näiteks.',
	...
	'ROLE_DESCRIPTION_LONG'	=> 'Rolli kirjeldus on liiga pikk, palun lhenda seda 4000 sümbolini.',
	...
	'TRACE_GROUP_YES_TOTAL_YES'	=> 'Selle grupi õigused on määratud <samp>JAH</samp> peale, ja koguväärtused on ka <sampZJAH</samp> peal, seega jäetakse koguväärtus.',
	...
	'TRACE_USER_FOUNDER'	=> 'Kasutaja on määratud asutajaks, seega administraatori õigused on vaikimisi<samp>JAH</samp>.',
	'TRACE_USER_KEPT'	=> 'Kasutaja õigused on <samp>EI</samp>, seega jäetakse vana koguväärtus.',
	'TRACE_USER_KEPT_LOCAL'	=> 'Kasutaja õigused sellel foorumile on <samp>EI</samp>, seega jäetaksevana koguväärtus.',
	...
	'WRONG_PERMISSION_TYPE'	=> 'Vale õiguste tüp valitud',
