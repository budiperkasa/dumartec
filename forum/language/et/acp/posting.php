...
$lang = array_merge($lang, array(
        ...
        'tokens'        => array(
                'TEXT'  => 'Suvaline tekst, sisaldades võõraid sümboleid, numbreid jne. Sa ei tohiks seda vormi kasutada HTML tag\'ides. Selle asemel proovi kasutada IDENTIFIER või SIMPLETEXT vormi.',
                ...
                'URL'   => 'Kehtiv URL suvalise protokolliga (http, ftp, jne. Ei saa kasutada javascripti jaoks). Kui ühtegi pole sisestatud, on &quot;http://&quot; protokolliks määratud',
        ...
        'SMILIES_CONFIG'        => 'Smailide koonfiguratsioon',
        ...
        'ACP_WORDS_EXPLAIN'     => 'Siin lehel saad sa lisada, muuta ja eemaldada sõnu, mis automaatselt tsenseeritakse sinu foorumis. Lisaks ei lubata inimestel registreerida neid sõnu sisaldavate kasutajanimedega. Wildcard\'e (*) saab kasutada sõnade väljal, näiteks. *ont* tsenseerib ka sõna "kontroll", kont* tsenseerib ka sõna "kontroll", *troll tsenseerib ka sõna "kontroll".',
        ...
        'ACP_DISALLOW_EXPLAIN'  => 'Sini saad hallata kasutajanimesid, millega ei tohi registreerida. Keelatud kasutajanimed võivad sisaldada wildcard\'i sümbolit e. "*".Sa ei saa sisestada siin ütegi kasutajanime, millega on juba registreeritud, pead esmalt kustutama selle nime ja siis keelama.',
