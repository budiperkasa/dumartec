...
$lang = array_merge($lang, array(
        'ACP_SEARCH_INDEX_EXPLAIN'      => 'Siin saad hallata otsingu indekseid. Kuna tavaliselt kasutada sa vaid ühte backend\'i, kustuta kõik teised indeksid, mida sa ei kasuta.Pärast mõnede otsinguseadete muutmist (nätieks miinimum/maksimumsümbolite arv) võib olla soovitav indeksi taasloomine.',
        ...
        'GENERAL_SEARCH_SETTINGS'       => 'Üldised osingu seaded',
        ...
        'MIN_SEARCH_CHARS'      => 'Miinimumumarv sümboleid, mida otsingus indekseeritakse',
        ...
        'SEARCH_INDEX_CREATE_REDIRECT'  => 'Kõik postitused kuni ID\'ni %1$d on indekseeritud, millest %2$d postitust selles indekseerimises.<br />Hetkene indekseerimissagedus on umbes %3$.1f postitust sekundis.<br />Indekseerimine käib...',
        ...
        'YES_SEARCH_EXPLAIN'    => 'Lubaba kasutada mitut täpset otsingut, sh kasutajate otsing.',
