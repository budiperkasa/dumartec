...
$lang = array_merge($lang, array(
        ...
        'ADD_IMAGESET_EXPLAIN'  => 'Siin saad luua uue pildikogu. Olenevalt serveri kofiguratsioonis ja faili õigustest, võib sul siin olla mitmeid valikuid. Näiteks saad võtta uue pildikogu loomisel olemasoleva põhjaks. Võid saada ka üles laadida või importida (/store/ kaustast) pildikogu arhiivifaili. Kui laed üles või impordid, saab pildikogu nime võtta pildikogu arhiivifailist (et seda teha, jäta vastav väli tühjaks).',
        'ADD_STYLE'     => 'Loo stiil',
        'ADD_STYLE_EXPLAIN'     => 'Siin saad lisada uue stiili. Olenevalt serveri kofiguratsioonis ja faili õigustest, võib sul siin olla mitmeid valikuid. Näiteks saad võtta uue stiili loomisel olemasoleva põhjaks. Võid saada ka üles laadida või importida (/store/ kaustast) stiili arhiivifaili.Kui laed üles või impordid, määatakse stiili nimi automaatselt.',
        'ADD_TEMPLATE'  => 'Loo templeit',
        'ADD_TEMPLATE_EXPLAIN'  => 'Siin saad lisada uue templeidi. Olenevalt serveri kofiguratsioonis ja faili õigustest, võib sul siin olla mitmeid valikuid. Näiteks saad võtta uue templeidi loomisel olemasoleva põhjaks. Võid saada ka üles laadida või importida (/store/ kaustast) templeidi arhiivifaili. Kui laed üles või impordid, saab templeidi nime võtta templeidi arhiivifailist (et seda teha, jäta vastav väli tühjaks).',
        'ADD_THEME'     => 'Loo teema',
        'ADD_THEME_EXPLAIN'     => 'Siin saad lisada uue teema. Olenevalt serveri kofiguratsioonis ja faili õigustest, võib sul siin olla mitmeid valikuid. Näiteks saad võtta uue teema loomisel olemasoleva põhjaks. Võid saada ka üles laadida või importida (/store/ kaustast) teema arhiivifaili. Kui laed üles või impordid, saab teema nime võtta teema arhiivifailist (et seda teha, jäta vastav väli tühjaks).',
        ...
        'CONFIRM_IMAGESET_REFRESH'      => 'Oled kindel, et soovid värskendada kõik pildikogu andmed? Seaded pildikogu kofiguratsioonifailis kirjutavad üle kõik tehtud muutused pildikogu redigeerijas.',
        ...
        'DELETE_IMAGESET'       => 'Kustuta pldikogu',
        ...
        'EDIT_IMAGESET_EXPLAIN' => 'Siin saad muuta pilte erladi, mis moodustavad pildikogu. Saad ka määrata pildile mõõtmed. Mõõtmed on valikulised, nende määramine võib aidata renderdamisprobleemide puhul mõnedes brauserites. Kui sa neid ei määra, vähendad veidi andmebaasi suurust.',
        ...
        'IMAGESET_EXPORT_EXPLAIN'       => 'Siin saad ekspoertida pildikogu arhiivifailina. See sisaldab kõiki vajalikke andmeid, et installeerida pildikogu uuele foorumile. Võid valida, kas laadida fail kohe alla või panna se FTP kausta, et pärast alla laadida.',
        ...
        'IMG_ICON_TOPIC_UNAPPROVED'     => 'Keelatud psotitus',
        ...
        'NO_UNINSTALLED_IMAGESET'       => 'Ei tuvastatud mahainstalleeritud pildikogusid.',
        'NO_UNINSTALLED_STYLE'  => 'Ei tuvastatud mahainstalleeritud stiile.',
        'NO_UNINSTALLED_TEMPLATE'       => 'Ei tuvastatud mahainstalleeritud templeite.',
        'NO_UNINSTALLED_THEME'  => 'Ei tuvastatud mahainstalleeritud teemasid.',
        'NO_UNIT'       => 'Pole',
        ...
        'REPLACE_IMAGESET_EXPLAIN'      => 'See pildikogu asnedab kustutatava pildkogu igas stiilis, milles see esineb.',
        ...
        'REPLACE_TEMPLATE_EXPLAIN'      => 'See templeit asnedab kustutatava templeidi igas stiilis, milles see esineb.',
        'REPLACE_THEME' => 'Asenda teema',
        'REPLACE_THEME_EXPLAIN' => 'See teema asnedab kustutatava teema igas stiilis, milles see esineb.',
        ...
        'STYLE_DETAILS_UPDATED' => 'Stiil muuetud.',
        ...
        'STYLE_ERR_NAME_LONG'   => 'Stiili imi ei tohi olla pikem kui 30 sümbolit.',
        ...
        'TEMPLATE_DELETED_FS'   => 'Templeit adnmebaasist eemaldatud, kuid mõned failid võisid jääda veel failisüsteemi.',
        ...
        'TEMPLATE_ERR_COPY_LONG'        => 'Kopeerimisõigused ei tohi oll pikemad kui 60 sümbolit',
        ...
        'THEME_ERR_NOT_THEME'   => 'Vslitud arhiiv ei sisalda teemat.',
        ...
        'THEME_EXPORT_EXPLAIN'  => 'Siin saad eksportida teema arhiivina. See arhiiv sisaldab vajalikke andmeid uuele foorumile installeerimiseks. Võdi valida, kas laadida fail kohe alla või salvestada FTP\'sse.',
        ...
        'UNINSTALLED_IMAGESET'  => 'Mahainstalleeritud pidikogud',
        'UNINSTALLED_STYLE'     => 'Mahainstalleeritud stiilid',
        'UNINSTALLED_TEMPLATE'  => 'Mahainstalleeritud templeidid',
        'UNINSTALLED_THEME'     => 'Mahainstalleeritud teemad',
        'UNSET' => 'Määramata',
));
