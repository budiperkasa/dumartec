...
$lang = array_merge($lang, array(
        ...
        'AVATAR_PHP_SIZE_OVERRUN'       => 'Avatarifaili suurus ületab lubatu. Maksimaalset lubatud failisuurus on %d MB.<br />See on kirjutatud php.ini faili ja seda ei saa ületada.',
        ...
        'EMAIL_SMTP_ERROR_RESPONSE'     => 'Tekkis probleem: Ran into problems sending e-mail at <strong>Line %1$s</strong>. Response: %2$s.',
        ...
        'FOLDER'        => 'Kaust',
        'FORGOT_PASS'   => 'Ma unustasin oma parool',
        ...
        'FROM'  => 'from',
        'FSOCK_DISABLED'        => 'Error: The operation could not be completed because the <var>fsockopen</var> function has been disabled or the server being queried could not be found.',
        ...
        'IF'    => 'Kui',
        'IMAGE' => 'Pilt',
        'IMAGE_FILETYPE_INVALID'        => 'Pilditüüp %d mimetype %s jaoks pole lubatud.',
        'IMAGE_FILETYPE_MISMATCH'       => 'Pildifaili tüübi viga: arvatav faililühend %1$s aga oli hoopis %2$s .',
        'IN'    => '',
        'INDEX' => 'Pealeht',
        'INFORMATION'   => 'Teade/Info',
        'INTERESTS'     => 'Huvid',
        'INVALID_DIGEST_CHALLENGE'      => 'Error: Invalid digest challenge.',
        'INVALID_EMAIL_LOG'     => '<strong>%s</strong> on ilmselt vale email?',
        'IP'    => 'IP',
        'IP_BLACKLISTED'        => 'Sinu IP %1$s on blokitud, sest see on mustas nimekirjas. Detailide jaoks vaata: <a href=',
        'JABBER'        => 'Jabber',
        'JOINED'        => 'Liitunud',
        ...
        'NO_AUTH_ADMIN_USER_DIFFER'     => 'Sa ei saa end uuesti autentiseerida teise kasutajana.',
      ...
      2         => '%d postitust järjekorras',      // 2+
        ...
        'OPTIONS'       => 'Valikud',
        'PAGE_OF'       => 'Leht <strong>%1$d</strong> koguhulgast <strong>%2$d</strong>',
        'PASSWORD'      => 'Parool',
        ...
        'SORT_RANK'     => 'taseme järgi',
        'SORT_TOPIC_TITLE'      => 'teema pealkirja järgi',
        'SORT_USERNAME' => 'kasutajanimejärgi',
        'SPLIT_TOPIC'   => 'Poolita teema',
        'SQL_ERROR_OCCURRED'    => 'SQL error tuli kui taheti lehte tõmmata serverist alla. Palun viita sellest %sfoorumi administraatorile%s kui see probleem kordub.',
        ...
        'THE_TEAM'      => 'Juhtkond',
        'TIME'  => 'Kellaaeg',
        'TOO_LONG'                  => 'Sisestatud väärtus on ligia pikk.',
        ...
        'TRACKED_PHP_ERROR'     => 'Jälitatud PHP erroreid: %s',
