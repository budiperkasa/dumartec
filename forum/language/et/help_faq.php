...
$help = array(
        array(
                0 => '--',
                1 => 'Sisselgimise ja registreerimise küsimused'
        ),
        array(
        ...
        array(
                ...
                1 => 'Kõigepealt kontrolli oma kasutajanime ja paroole. Teine võimalus on, et administraator on su konto kustutanud. Foorumitel on tavaks kustutada ebkaaktiivseid kasutajaid, et vähendada andmebaasi suurust.'
        ),
        array(
                0 => 'Miks ma ei saa registreeruda?',
                1 => 'On võimalik, et foorumi omanik on bänninud su IP aadressi või keelanud kasutajanime, millega üritasid registreeruda. Omanik võib olla keelustanud üldse uute kasutajate registreerimise. Võta ühenudst foorum administraatoriga, et saada abi.'
        ),
        array(
        ...
        array(
                0 => 'Kuidas ma panen kasutajanime alla omale pildi?',
                1 => 'Kasutajanime all saab olla kaks pilti. Esimene on seotud tiitliga ja selle määrab administraator. Teine on avatar ja selle saad ise panna <em>Juhtpaneel</em> alt (kui avataride kasutamine pole foorumis keelatud).'
        ),
        array(
                0 => 'Mis on mu tiitel ja kuidas ma seda muudan?',
                1 => 'Tiitlid näitavad, mitu postitust oeld teinud või identfitseerivad kindlaid kasutajaid, näiteks moderaatoreid ja administraatoreid. Enamasti ei saa tiitleid muuta, kuna need määrab administraator. Palun ära riku foorumit, tehes mõttetuid postitusi, et tiitlit kõrgemaks saada. Enamik foorumite administraatoreid seda ei kannata ja nad madaldavad su postituste arvu.'
        ),
        array(
        ...
        array(
                ...
                1 => 'Vajutades "Tõstata teemat" linki teemat vaadates, saad sa "tõstada" teema foorumi esimesele lehele. Kui sa seda linki ei näe, on see moodus ilmselt keelatud või tõstatamiste intervall on veel liiga väike. Samuti on võimalik teemat tõstatada sellele vastates, kuid jälgi foorumi reegleid seda tehes.'
        ),
        array(
                0 => '--',
        ...
        array(
                ...
                1 => 'On võmalik, et administraator on määranud gruppidele omad värvid, et neid kergemini eristada.'
        ),
        array(
        ...
        array(
                ...
                1 => 'Sisesta sõna otsinguväljale teemas, foorumis või esilehel. Täiendatud otsingu seed teemas või foorumis "Täiendatud otsingu" linki vajutades.'
        ),
        array(
        ...
        array(
                ...
                1 => 'Sinu osingul oli veebiserveri jaoks liga palju vasteid. Täpsusta ja proovi uuesti.'
        ),
        array(
