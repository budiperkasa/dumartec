...
$lang = array_merge($lang, array(
        ...
        'BOARD_NOT_INSTALLED_EXPLAIN'   => 'phpBB ühtne konverteerija raamistik vajab algset phpbb 3-e installatsiooni, palun <a href=',
        'CATEGORY'      => 'Kategooria',
        ...
        'DEV_NO_TEST_FILE'      => 'Väärtust ei määratud testifaili muutujale konvertijas. Kui oled selle konvertija kasutaja, ei tohiks sa näha seda veateadet, palun teata sellest veast konvertija autorile.Kui oled konvertija autor, pead sisestama nime failile, mis on algfoorumiset lubada tee selleni kinnitada.',
        ...
        'INITIAL_CONFIG_EXPLAIN'        => 'Nüüd, kui installatsioon on tuvastanud, et sinu server saab jooksutada phpBB\'d, pead sisestama seaded. Kui sa ei tea, kuidas andmebaasi ühendada, võta ühendust veebiteenuse pakkujaga või kasuta phpBB tugifoorumeid. Kui sisestad andmed, kontrolli nender õigsust enne jätkamist.',
        'INSTALL_CONGRATS'      => 'Õnnitleme!',
        'INSTALL_CONGRATS_EXPLAIN'      => '<p>Oled nüüd edukalt installeerinud phpBB %1$s. Siit alates on sul kaks võimalust, mida foorumiga edasi teha:</p>',
        ...
        'INST_ERR_DB_NO_ORACLE' => 'Installeeritud Oracle\'u versioon nõuab sult <var>NLS_CHARACTERSET</var> parameetri muutmist väärtusele <var>UTF8</var>. Kas uuenda versoonile 9.2+ või muuda parameetrit',
        'INST_ERR_DB_NO_FIREBIRD'       => 'Installeeritud Firebird\'i versioon on vanem kui 2.0, palun uuenda.',
        ...
        'INST_ERR_FATAL_DB'     => 'Ilmnes tõsine ja parandamatu andmebaasi viga. See võib tuleneda sellest, e valitud kasutajal pole vajalikke õigusi <code>CREATE TABLES</code> või <code>INSERT</code> käskude täitmisks. Edasine info võib olla antud all. Palun kontakteeru teenusepakkujaga või otsi abi phpBB tugifoorumitest.',
        ...
        'LONG_SCRIPT_EXECUTION' => 'See võib aega võtta... ära peataa skripti.',
        ...
        'SEARCH_INDEX_UNCONVERTED'      => 'Otsingu indeksit ei konversitud',
        ...
        'SYNC_TOPICS'   => 'Alusten teemade sünkroniseerimist',
        ...
        'TABLE_PREFIX_SAME'     => 'Eeliide peab olema saval, mis konverditaval foorumil.<br />» Valitud eesliide oli %s.',
        ...
        'WRITABLE'      => 'Kirjutatav',
        'ALL_FILES_UP_TO_DATE'  => 'Kõik failid on uuendatud. Peaksid nüüd kustutama install kausta ja minema foorumi esilehele.',
        ...
        'CURRENT_FILE'  => 'Praegune originaalfail',
        ...
        'DIFF_SEP_EXPLAIN'      => 'Praeguse faili lõpp / uuendatud faili algus',
        ...
        'FILES_NEW_CONFLICT_EXPLAIN'    => 'Järgnevad failid on uued, kuid on kindalks tehtud, et juba sama nimega fail on olemas samas kohas. See fail kirjutatakse üle uue faili poolt.',
        'FILES_NOT_MODIFIED'    => 'Muutmata failid',
        'FILES_NOT_MODIFIED_EXPLAIN'    => 'Järgnevad failid on muutmata ja on praegu olemas sinu vanas ppBB installatsioonis.',
        ...
        'INLINE_UPDATE_SUCCESSFUL'      => 'Andmebaasi uuendus oli edukas. Nüüdd pead jätkama uuendamisprotsessiga.',
        ...
        'MERGE_MOD_FILE_OPTION' => 'Ühenda erinevused ja kasuta muudetud koodi vastuolulises osas',
        'MERGE_NEW_FILE_OPTION' => 'Ühenda erinevused ja kasuta uue faili koodi vastuolulses osas',
        ...
        'VERSION_UP_TO_DATE'    => 'Sinu versioon on kõige uuem, uuendusi pole saadaval. Võid jätkata, et teha failide korrektsuse kontroll.',
