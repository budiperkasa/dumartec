...
'BBCODE_IS_OFF' => '%sBBCode%s on <em>VÄLJAS</em>',

'BBCODE_IS_ON' => '%sBBCode%s on <em>SEES</em>',
...
'PHP_SIZE_OVERRUN' => 'Manuse failisuurus on liiga suur, Maksimaalne lubatud suurus on %d MB.<br />See on seatud php.ini failis ja seda ei saa muuta.',
...
'POLL_TITLE_COMP_TOO_LONG' => 'Su hääletuse pealkiri on liiga pikk, kaalu BBcode või smailide eemaldamist.',
...
'STICK_TOPIC_FOR_EXPLAIN' => 'Sisesta 0 või jäta tühjaks ajalimiidita kleebise/teadaande jaoks.',
...
'UNAUTHORISED_BBCODE' => 'Sa ei saa kasutada teatud BBcode: %s.',
