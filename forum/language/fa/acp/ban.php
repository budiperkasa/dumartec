...
$lang = array_merge($lang, array(
	...
	'EMAIL_BAN'	=> 'تحريم کردن يک يا چند آدرس ايمل',
	'EMAIL_BAN_EXCLUDE_EXPLAIN'	=> 'فعال بودن اين براي راه ندادن آدرس ايميل هاي وارد شده براي همه تحريم هاي کنوني.',
	'EMAIL_BAN_EXPLAIN'	=> 'در صورتي که قصد تايين بيش از يک آدرس ايمل را داريد هر کدام را در يک خطر جداگانه قرار دهيد. براي هماهنگ سازي بخشي از آدرس ها از * استفاده کنيد, مثال. <span dir=ltr><samp>*@hotmail.com</samp>, <samp>*@*.domain.tld</samp></span>, و غيره.',
	'EMAIL_NO_BANNED'	=> 'هيچ آدرس ايملي تحريم نشده است',
	'EMAIL_UNBAN'	=> 'لغو تحريم ايمل ها',
