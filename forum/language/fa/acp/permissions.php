...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '		<p>سطوح دسترسي به گروه هاي مختفي تقسيم بندي شده اند و از اين گروه ها 4 دسته اصلي به شرح زير مي باشند :</p>

		<h2>سطوح دسترسي کلي</h2>
		<p>در اين حالت سطح دسترسي ، کنترل کامل وجود دارد و شما مي توانيد تمام تراز ها و بکارگيري هاي بولتين بورد را کنترل کنيد. در اين حالت براي کاربران حالت هاي مختلفي وجود دارد که به شرح روبرو است :’ سطح دسترسي گروه ها, سطح دسترسي مديران کل و مديران انجمن.</p>

		<h2>سطوح دسترسي هر انجمن</h2>
		<p>اين نوع سطح دسترسي قابل استفاده براي هر انجمن است. بخش هاي مجزايي براي طح دسترسي انجمن وجود دارد, مديران انجمن, کاربران’ سطوح دسترسي و گروه ها’ سطوح دسترسي انجمن.</p>

		<h2>نقش هاي سطوح دسترسي</h2>
		<p>در اين حالت مي توانيد تنظيمات متمايزي براي سطوح دسترسي و حالت هاي مختلفي براي آن ها برگزينيد و در صورت نياز مي توانيد نقوش جديدي مستقر نماييد. نقش هاي پيشفرض مي بايست بصورت بزرگ و کوچک در بولتين بورد مديريت شوند, همچنين شما مي توانيد نقش ها را ويرايش ، اضافه و حذف کنيد و فراخور هاي آنها را مشاهده نماييد.</p>

		<h2>سطوح دسترسي انتخابي</h2>
		<p>در اين حالت شما مي توانيد سطوح دسترسي موثر براي کاربران مورد نظر انتخاب نماييد, مديران انجمن (منطقه اي و کلي), و مديران کل دخيل هستند.</p>
	
		<br />

		<p>براي کسب اطلاعات بيشتر درباره زمينه هاي بالا و و مديريت سطوح دسترسي در phpBB3 خود, لطفا <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/quick_permissions.html"><b>فصل 1.5 از راهنماي شروع سريع ما را ببينيد</b></a>.</p>
	',
	'ACL_NEVER'	=> 'هیچگاه',
	...
	'ROLE_USER_NOPM'	=> 'بدون پيغام هاي خصوصي',
