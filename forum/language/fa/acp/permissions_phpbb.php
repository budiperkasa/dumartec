<?php
/**
* acp_permissions_phpbb (phpBB Permission Set) [Farsi]
*
* @package language
...
$lang = array_merge($lang, array(
	...
	'acl_u_sendpm'		=> array('lang' => 'توانايي ارسال پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_masspm'		=> array('lang' => 'توانايي ارسال پيغام به کاربران و گروه هاي متعدد', 'cat' => 'pm'),
	'acl_u_readpm'		=> array('lang' => 'توانايي خواندن پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_edit'		=> array('lang' => 'توانايي ويرايش پيغام هاي خصوصي خودش', 'cat' => 'pm'),
	'acl_u_pm_delete'	=> array('lang' => 'توانايي حذف پيغام هاي خصوصي از فولدر هاي خودش', 'cat' => 'pm'),
	'acl_u_pm_forward'	=> array('lang' => 'توانايي فوروارد پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_emailpm'	=> array('lang' => 'توانايي ايميل پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_printpm'	=> array('lang' => 'توانايي پرينت پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_attach'	=> array('lang' => 'توانايي پيوست فايل ها در پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_download'	=> array('lang' => 'توانايي دريافت فايل ها در پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_bbcode'	=> array('lang' => 'توانايي ارسال BBCode در پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_smilies'	=> array('lang' => 'توانايي ارسال شکلک ها در پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_img'		=> array('lang' => 'توانايي ارسال تصاوير در پيغام هاي خصوصي', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'توانايي ارسال فايل Flash در پيغام هاي خصوصي', 'cat' => 'pm'),

	'acl_u_sendemail'	=> array('lang' => 'توانايي ارسال ايميل', 'cat' => 'misc'),
	'acl_u_sendim'		=> array('lang' => 'توانايي ارسال پيغام هاي فوري', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_icons'		=> array('lang' => 'توانايي بکارگيري آيکون ها در مباحث و پست ها', 'cat' => 'post'),
	...
	'acl_f_bbcode'		=> array('lang' => 'توانايي ارسال BBCode', 'cat' => 'content'),
	'acl_f_smilies'		=> array('lang' => 'توانايي ارسال شکلک ها', 'cat' => 'content'),
	'acl_f_img'			=> array('lang' => 'توانايي ارسال تصاوير', 'cat' => 'content'),
	'acl_f_flash'		=> array('lang' => 'توانايي ارسال فايل فلش', 'cat' => 'content'),
...
$lang = array_merge($lang, array(
	...
	'acl_m_lock'	=> array('lang' => 'توانايي بستم مباحث', 'cat' => 'topic_actions'),
	'acl_m_split'	=> array('lang' => 'توانايي شکفتن مباحث', 'cat' => 'topic_actions'),
...
$lang = array_merge($lang, array(
	...
	'acl_a_icons'		=> array('lang' => 'توانايي تغيير آيکون پست ها / مبحث ها و شکلکها', 'cat' => 'posting'),
