...
$lang = array_merge($lang, array(
	...
	'BBCODE_HELPLINE'			=> 'خط راهنما',
	'BBCODE_HELPLINE_EXPLAIN'	=> 'اين فيلد مي بايست متوني را که پس از حضور موس بر روي BBCode نمايش مي دهد در بر گيرد.',
	'BBCODE_HELPLINE_TEXT'		=> 'متن خط راهنما',
	...
	'BBCODE_USAGE_EXPLAIN'		=> 'از اينجا شما مي توانيد چگونگي بکارگيري BBCode را تعريف کنيد. همه متغيرات input مطابق مشخصه ها جايگزين مي شوند (%sپايين را ببينيد%s).',

	'EXAMPLE'						=> 'مثال:',
	'EXAMPLES'						=> 'مثال ها:',

	'HTML_REPLACEMENT'				=> 'جايگزيني HTML',
	'HTML_REPLACEMENT_EXAMPLE'		=> '&lt;span style="background-color: {COLOR};"&gt;{TEXT}&lt;/span&gt;<br /><br />&lt;span style="font-family: {SIMPLETEXT1};"&gt;{SIMPLETEXT2}&lt;/span&gt;',
	'HTML_REPLACEMENT_EXPLAIN'		=> 'شما در اينجا مي بايست HTML تعويض شونده را تعريف کنيد. لطفا فراموش نکنيد که مشخصه هاي بالا ارائه شده باشند!',
...
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'از اينجا شما مي توانيد آيکون هايي را که کاربران مي توانند در مباحث يا پست هايشان بکار گيرند را اضافه ، حذف، يا ويرايش کنيد. اين آيکون ها معمولا در فهرست انجمن ها و يا در ليست مباحث در مجاورت عنوان مباحث قابل رويت مي باشند. شما نيز مي توانيد بسته هاي آيکون را نصب و يا بسته هاي جديدي را ايجاد کنيد.',
	'ACP_SMILIES_EXPLAIN'	=> 'شکلک ها و احساسات براي ايجاد نوعي جو هستند, بعضي از اوقات تصاوير انيميشني براي نقل کردن برخي هيجانات و احساسات گنجانده مي شوند. از اينجا شما مي توانيد شکلک هايي را که کاربران مي توانند در پست ها و پيغام هاي خصوصي خود از آنها استفاده کنند ، اضافه ، حذف  و يا ويرايش کنيد . شما نيز مي توانيد بسته هاي شکلک را نصب و يا بسته هاي جديدي را ايجاد کنيد.',
	'ADD_SMILIES'			=> 'افزودن شکلک هاي متعدد',
	'ADD_SMILEY_CODE'		=> 'Add additional smiley code',
	'ADD_ICONS'				=> 'افزودن آيکون هاي متعدد',
	'AFTER_ICONS'			=> 'بعد از %s',
	'AFTER_SMILIES'			=> 'بعد از %s',

	'CODE'						=> 'کد',
	'CURRENT_ICONS'				=> 'آيکون هاي کنوني',
	...
	'ICONS_ADD'				=> 'افزودن يک آيکون جديد',
	'ICONS_NONE_ADDED'		=> 'No icons were added.',
	'ICONS_ONE_ADDED'		=> 'آيکون با موفقيت اضافه شد.',
	'ICONS_ADDED'			=> 'آيکون ها با موفقيت اضافه شدند.',
	'ICONS_CONFIG'			=> 'پيکربندي آيکون ها',
	'ICONS_DELETED'			=> 'آيکون با موفقيت حذف شد.',
	'ICONS_EDIT'			=> 'ويرايش آيکون',
	'ICONS_ONE_EDITED'		=> 'آيکون با موفقيت بروز شد.',
	'ICONS_NONE_EDITED'		=> 'No icons were updated.',
	'ICONS_EDITED'			=> 'آيکون ها با موفقيت بروز شدند.',
	'ICONS_HEIGHT'			=> 'ارتفاع آيکون',
	'ICONS_IMAGE'			=> 'تصوير آيکون',
	'ICONS_IMPORTED'		=> 'بسته آيکون با موفقيت نصب شد.',
	'ICONS_IMPORT_SUCCESS'	=> 'بسته آيکون با موفقيت وارد شد.',
	'ICONS_LOCATION'		=> 'موقعيت آيکون',
	'ICONS_NOT_DISPLAYED'	=> 'آيکون هاي ذيل در صفحه ارسال پست قابل رويت نيستند',
	'ICONS_ORDER'			=> 'ترتيب آيکون',
	'ICONS_URL'				=> 'فايل تصوير آيکون',
	'ICONS_WIDTH'			=> 'عرض آيکون',
	'IMPORT_ICONS'			=> 'نصب بسته آيکون',
	...
	'NO_ICONS_ADD'		=> 'هيچ آيکوني براي اضافه شدن در دسترس نيست.',
	'NO_ICONS_EDIT'		=> 'هيچ آيکوني براي ويرايش در دسترس نيست.',
	'NO_ICONS_EXPORT'	=> 'You have no icons with which to create a package.',
	'NO_ICONS_PAK'		=> 'هيچ بسته آيکوني يافت نشد.',
