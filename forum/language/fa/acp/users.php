...
$lang = array_merge($lang, array(
	...
	'CONFIRM_EMAIL_EXPLAIN'	=> 'در صورتي که قصد داريد ايمل را تغيير دهيد بايد اين را هم تعيين کنيد.',
	'DELETE_POSTS'	=> 'حذف پست ها',
	'DELETE_USER'	=> 'حذف کاربر',
	'DELETE_USER_EXPLAIN'	=> 'لطفا در نظر داشته باشيد که حذف کاربران پايان کار است, آنها قادر به بازيافتن نيستند.',
	...
	'NOT_MANAGE_FOUNDER'	=> 'شما مجاز به اداره يک کاربر با وضعيت " بنيانگذار " نيستيد. فقط بنيانگذاران قادرند بنيانگذاران ديگر را ويرايش کنند.',
	'QUICK_TOOLS'	=> 'ابزارهاي سريع',
	'REGISTERED'	=> 'تاريخ عضويت',
	'REGISTERED_IP'	=> 'عضو شده از IP',
	'RETAIN_POSTS'	=> 'حفظ کردن پست ها',
	...
	'USER_ADMIN_AVATAR_REMOVED'	=> 'نماد با موفقيت از حساب کاربري حذف شد.',
	'USER_ADMIN_BAN_EMAIL'	=> 'قطع دسترسي توسط ايمل',
	...
	'USER_ADMIN_DEL_AVATAR'	=> 'حذف نماد',
	...
	'USER_AVATAR_UPDATED'	=> 'نمادها و جزييات کاربر بروز شد.',
	...
	'USER_OVERVIEW_UPDATED'	=> 'جزييات کاربر بروز شد.',
	...
	'USER_PREFS_UPDATED'	=> 'پيکربندي کاربر بروز شد.',
	'USER_PROFILE'	=> 'مشخصات کاربر',
	'USER_PROFILE_UPDATED'	=> 'مشخصات کاربر بروز شد.',
	'USER_RANK'	=> 'رتبه کاربر',
	'USER_RANK_UPDATED'	=> 'رتبه کاربر بروز شد.',
	'USER_SIG_UPDATED'	=> 'امضاي کاربر با موفقيت بروز شد.',
