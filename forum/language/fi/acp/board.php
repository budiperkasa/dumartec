...
$lang = array_merge($lang, array(
    ...
    'ENABLE_QUEUE_TRIGGER'         		=> 'Ota valvontajono käyttöön',
    'ENABLE_QUEUE_TRIGGER_EXPLAIN'   	=> 'Voit laittaa rekisteröityneen käyttäjän valvontajonoon mikäli heidän viestiensä lukumäärä on pienempi kuin alhaalla oleva arvo. Tällä asetuksella ei ole vaikutusta viestien/viestiketjujen hyväksymiseen, joka on asetettu oikeuksista.',
    'QUEUE_TRIGGER_POSTS'        		=> 'Maksimi viestimäärä jonoa varten',
    'QUEUE_TRIGGER_POSTS_EXPLAIN'   	=> 'Käyttäjän tulee kirjoittaa näin monta hyväksyttyä viestiä päästäkseen pois jonosta. Mikäli käyttäjällä on tätä vähemmän viestejä kaikki viestit joutuvat jonoon hyväksyntää varten.',
