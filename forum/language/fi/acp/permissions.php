...
$lang = array_merge($lang, array(
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Täällä voit liittää yleisiä oikeuksia käyttäjille - käyttäjän oikeudet, yleisvalvojan tai ylläpitäjän oikeudet. Käyttäjän oikeudeta sallivat tiettyjä toimintoja, kutan avatar-kuvan käyttämisen, yksityisviestien lähettämisen, jne. Yleisvalvojan oikeuksia, kuten viestien hyväksyminen, viestiketjujen hallinta, porttikieltojen hallinta, jne ja viimeisenä ylläpitäjän asetukset, kuten oikeuksien määrittely, mukautetun BBCoden luominen, alueiden hallinta, jne. Sinun kannattaa käyttää ryhmän oikeuksien hallintaa muokataksesi useampaa käyttäjää kerralla. Käyttäjän henkilökohtaisia asetuksia tarvitsee muuttaa vain tietyissä tapauksissa. Suositeltava tapa on isätä käyttäjä ryhmään ja antaa ryhmälle oikeuksia.',
