...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Täällä voit määritellä käyttäjätunnuksia, joiden käyttö ei ole sallittu. Kielletyissä nimimerkeissä voi käyttää myös erikoismerkkiä *. Huomaa, että et voi kieltää jo rekisteröityä nimimerkkiä. Sinun tulee esnin poistaa tuo nimimerkki ja sitten vasta kieltää sen käyttäminen',
