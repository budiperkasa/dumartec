...
/**
*
* memberlist.php [Faroese]
*
* @package language
* @version $Id: $
* @copyright (c) 2008 phpBB Group
* @author 2008-02-25 - VV Midlar
...
$lang = array_merge($lang, array(
	'ABOUT_USER'	=> 'Alt um %s ',
	'ACTIVE_IN_FORUM'	=> 'Mest aktivu kjak',
	'ACTIVE_IN_TOPIC'	=> 'Mest aktivu evni',
	'ADD_FOE'	=> 'Add foe',
	'ADD_FRIEND'	=> 'Add friend',
	'AFTER'	=> 'After',
	'ALL'	=> 'All',
	'BEFORE'	=> 'áðrenn',
	'CC_EMAIL'	=> 'Send eitt kopi av hesum telduposti til tín sjálvs',
	...
	'EMAIL_SENT'	=> 'Hesin telduposturin er sendur.',
	...
	'EMPTY_MESSAGE_EMAIL'	=> 'Tú mást skriva okkurt innihald til teldupostin.',
	'EMPTY_MESSAGE_IM'	=> 'You must enter a message to be send.',
	'EMPTY_NAME_EMAIL'	=> 'You must enter the real name of the recipient.',
	'EMPTY_SUBJECT_EMAIL'	=> 'Tú mást skriva eitt evni til teldupostin.',
	'EQUAL_TO'	=> 'Equal to',
	'FIND_USERNAME_EXPLAIN'	=> 'Use this form to search for specific members. You do not need to fill out all fields. To match partial data use * as a wildcard. When entering dates use the format <kbd>YYYY-MM-DD</kbd>, e.g. <samp>2004-02-29</samp>. Use the mark checkboxes to select one or more usernames (several usernames may be accepted depending on the form itself) and click the Select Marked button to return to the previous form.',
	'FLOOD_EMAIL_LIMIT'	=> 'Tú kann ikki senda fleiri teldubrøv beint nú. Royn aftur seinni.',
	'GROUP_LEADER'	=> 'Bólkaleiðari',
	...
	'SEARCH_USER_POSTS'	=> 'Leita eftir øllum innleggum frá %s ',
	'SELECT_MARKED'	=> 'Select marked',
	'SELECT_SORT_METHOD'	=> 'Vel máta at flokka',
	'SEND_AIM_MESSAGE'	=> 'Send AIM message',
	'SEND_ICQ_MESSAGE'	=> 'Send ICQ message',
	'SEND_IM'	=> 'Instant messaging',
	'SEND_JABBER_MESSAGE'	=> 'Send Jabber message',
	'SEND_MESSAGE'	=> 'Send boð',
	'SEND_MSNM_MESSAGE'	=> 'Send MSNM/WLM message',
	'SEND_YIM_MESSAGE'	=> 'Send YIM message',
	'SORT_EMAIL'	=> 'Teldupostur',
	'SORT_LAST_ACTIVE'	=> 'Seinast aktivur',
	'SORT_POST_COUNT'	=> 'Post count',
	'USERNAME_BEGINS_WITH'	=> 'Brúkaranavn byrjar við',
	'USER_ADMIN'	=> 'Administrate user',
	'USER_FORUM'	=> 'Brúkarahagtøl',
	'USER_ONLINE'	=> 'Online',
	'USER_PRESENCE'	=> 'Board presence',
	'VIEWING_PROFILE'	=> 'Hyggar at vangamynd',
	'VISITED'	=> 'Seinasta vitjan',
	'WWW'	=> 'Heimasíða',
));
