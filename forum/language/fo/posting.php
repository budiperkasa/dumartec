...
$lang = array_merge($lang, array(
	...
	'ADD_POLL'					=> 'Ger ein vallista',
	'ADD_POLL_EXPLAIN'			=> 'Um tú ikki vilt gera ein vallista, so lat hesi felt vera tóm.',
	'ALREADY_DELETED'			=> 'Sorry but this message is already deleted.',
	'ATTACH_QUOTA_REACHED'		=> 'Sorry, the board attachment quota has been reached.',
	'ATTACH_SIG'				=> 'Attach a signature (signatures can be altered via the UCP)',

	'BBCODE_A_HELP'				=> 'Enda øll opin bbKotu spjøldur',
	'BBCODE_B_HELP'				=> 'Feitur tekstur: [b]tekstur[/b]  (alt+b)',
	'BBCODE_C_HELP'				=> 'Kotu tekstur: [code]tekstur[/code]  (alt+c)',
	'BBCODE_E_HELP'				=> 'List: Add list element',
	'BBCODE_F_HELP'				=> 'Tekst stødd: [size=x-small]lítil tekstur[/size]',
	'BBCODE_IS_OFF'				=> '%sBBkota%s er <u>óvirkin</u>',
	'BBCODE_IS_ON'				=> '%sBBkota%s er <u>virkin</u> ',
	'BBCODE_I_HELP'				=> 'Skákskrivaður tekstur: [i]tekstur[/i]  (alt+i)',
	'BBCODE_L_HELP'				=> 'Listi: [list]tekstur[/list] (alt+l)',
	'BBCODE_LISTITEM_HELP'		=> 'List item: [*]text[/*]',
	'BBCODE_O_HELP'				=> 'Raðfestur listi: [list=]tekstur[/list]  (alt+o)',
	'BBCODE_P_HELP'				=> 'Innset mynd: [img]http:',
	'BBCODE_Q_HELP'				=> 'Siteraður tekstur: [quote]tekstur[/quote]  (alt+q)',
	'BBCODE_S_HELP'				=> 'Tekst litur: [color=red]tekstur[/color]  Hint: tú kann eisini brúka color=#FF0000',
	'BBCODE_U_HELP'				=> 'Undirstrikaður tekstur: [u]tekstur[/u]  (alt+u)',
	'BBCODE_W_HELP'				=> 'Innset URL: [url]http:',
	'BBCODE_D_HELP'				=> 'Flash: [flash=width,height]http://url[/flash]',
	'BUMP_ERROR'				=> 'You cannot bump this topic so soon after the last post.',

	'CANNOT_DELETE_REPLIED'		=> 'Tíðverri, tú kann ikki sletta innlegg, sum eru svaraði til.',
	...
	'CLOSE_TAGS'				=> 'Lat spjøldur aftur',
	'CURRENT_TOPIC'				=> 'Current topic',

	'DELETE_FILE'				=> 'Delete file',
	'DELETE_MESSAGE'			=> 'Strikað boð',
	'DELETE_MESSAGE_CONFIRM'	=> 'Are you sure you want to delete this message?',
	'DELETE_OWN_POSTS'			=> 'Tíðverri, tú kann einans sletta tíni egnu innlegg.',
	...
	'EMPTY_MESSAGE'				=> 'Tú mást skriva ein boðskap í innleggið.',
	...
	'FLOOD_ERROR'				=> 'Tú kann ikki gera eitt nýtt innlegg so skjótt aftur; vinarligað royn aftur um eina løtu.',
	'FONT_COLOR'				=> 'Tekst litur',
	'FONT_COLOR_HIDE'			=> 'Hide font colour',
	'FONT_HUGE'					=> 'Sera stór',
	'FONT_LARGE'				=> 'Stór',
	'FONT_NORMAL'				=> 'Vanlig',
	'FONT_SIZE'					=> 'Tekst stødd',
	'FONT_SMALL'				=> 'Lítil',
	'FONT_TINY'					=> 'Sera lítil',
	...
	'POLL_DELETE'				=> 'Tín atkvøðugreiðsla bleiv sletta.',
	'POLL_FOR'					=> 'Vallistin skal koyra í',
	'POLL_FOR_EXPLAIN'			=> '[ Skriva 0 fyri at atkvøðugreiðslan aldri skal enda ]',
	...
	'SMILIES'					=> 'Smilies',
	'SMILIES_ARE_OFF'			=> 'Íkorn eru <u>óvirkin</u>',
	'SMILIES_ARE_ON'			=> 'Íkorn eru <u>virkin</u>',
	...
	'STYLES_TIP'				=> 'Hint: Stílur kann tilegnast skjótt til merktan tekst',
