...
$lang = array_merge($lang, array(
	'ACCOUNT_ACTIVE'				=> 'Tín konto er nú gjørd virkin. Takk fyri tína skráseting',
	'ACCOUNT_ACTIVE_ADMIN'			=> 'Kontoin er nú gjørd virkin',
	'ACCOUNT_ACTIVE_PROFILE'		=> 'Your account has now been successfully reactivated.',
	'ACCOUNT_ADDED'					=> 'Takk fyri tína skráseting. Tín konto er nú gjørd. Tú kann nú logga teg á við tínum brúkaranavnið og loyniorðið',
	...
	'ACCOUNT_INACTIVE'				=> 'Tín konto er nú gjørd. Tó krevur hetta forum, at kontoin verður gjørd virkin. Ein lykil er sendur til teldupost adressuna tú upplýsti. Vinarligað kanna tín teldupost fyri fleiri upplýsingar.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Tín konto er nú gjørd. Tó krevur hetta forum, at ein kjakstjóri ger konto tína virkna. Ein teldupostur er sendur til tín, og tú verður upplýst/ur tá kontoin er gjørd virkin',
	...
	'ALREADY_ACTIVATED'				=> 'Tú hevur longu gjørt kontoina virkna',
	'ATTACHMENTS_EXPLAIN'			=> 'This is a list of attachments you have made in posts to this board.',
	'ATTACHMENTS_DELETED'			=> 'Attachments successfully deleted.',
	'ATTACHMENT_DELETED'			=> 'Attachment successfully deleted.',
	'AVATAR_CATEGORY'				=> 'Category',
	'AVATAR_EXPLAIN'				=> 'Vísir eina lítla mynd undir tínum brúkaranavni í innleggum. Bara ein mynd kann vísast í senn, breiddin kann ikki vera meiri enn %d pikslar, hæddin ikki meiri enn %d pikslar, og fílu støddin í mesta lagi %d KB.',
	'AVATAR_FEATURES_DISABLED'		=> 'The avatar functionality is currently disabled.',
	'AVATAR_GALLERY'				=> 'Myndasavn',
	...
	'CONFIRM_PASSWORD'			=> 'Vátta loyniorðið',
	'CONFIRM_PASSWORD_EXPLAIN'	=> 'Tú skal vátta loyniorðið, um tú ynskir at broyta tað ella broyta teldupost adressu.',
	...
	'ITEMS_REQUIRED'			=> 'Teigar merktir við einum * skulu útfyllast, um ikki annað er viðmerkt',

	'JOIN_SELECTED'				=> 'Join selected',

	'LANGUAGE'					=> 'Language',
	'LINK_REMOTE_AVATAR'		=> 'Ger leinkju til mynd á aðrari síðu',
	...
	'NEW_PASSWORD'					=> 'Nýggja loyniorðið',
	...
	'PASSWORD'					=> 'Loyniorð',
	'PASSWORD_ACTIVATED'		=> 'Tín konto er blivin gjørd virkin aftur. Fyri at logga á, vinarligað brúkað loyniorðið í teldupostinum tú hevur fingið.',
	'PASSWORD_UPDATED'			=> 'Eitt nýtt loyniorð er gjørt; vinarligað kanna tín teldupost fyri upplýsingar um, hvussu tað verður gjørt virki.',
	...
	'PM_DISABLED'				=> 'Privat boð eru gjørd óvirkin',
	'PM_FROM'					=> 'From',
	...
	'POST_NEW_PM'				=> 'Send boð',
	'POST_PM_LOCKED'			=> 'Private messaging is locked',
	'POST_PM_POST'				=> 'Quote post',
	'POST_QUOTE_PM'				=> 'Sitera boð',
	'POST_REPLY_PM'				=> 'Svara til boð',
	'PRINT_PM'					=> 'Print view',
	...
	'PROFILE_UPDATED'			=> 'Tín vangamynd bleiv goymd',

	'RECIPIENT'							=> 'Móttakari',
	'RECIPIENTS'						=> 'Recipients',
	'REGISTRATION'						=> 'Samtykkingarbræv til limaskap',
	...
	'SEARCH_YOUR_POSTS'			=> 'Sí tíni innlegg',
	'SEND_PASSWORD'				=> 'Send mær eitt nýtt loyniorð ',
	'SENT_AT'					=> 'Sent at',
	'SHOW_EMAIL'				=> 'Users can contact me by e-mail',
	'SIGNATURE_EXPLAIN'			=> 'Hesin tekstur kann leggjast aftrat innleggum, ið tú gert. Tú kann í mesta lagið skriva %d  tekin',
	'SIGNATURE_PREVIEW'			=> 'Your signature will appear like this in posts',
	'SIGNATURE_TOO_LONG'		=> 'Tín undirskrift er ov long.',
	'SORT'						=> 'Flokka',
	...
	'TOO_MANY_REGISTERS'		=> 'Tú hevur nú uppbrúkt tínar møguleikar fyri at skráseta teg í hesum umfarinum. Vinarligað royn aftur seinni.',
	...
	'UPLOAD_AVATAR_FILE'			=> 'Heinta mynd frá tíni teldu',
	'UPLOAD_AVATAR_URL'				=> 'Heinta mynd um eina leinkju',
	'UPLOAD_AVATAR_URL_EXPLAIN'		=> 'Skriva leinkjuna til plássið har myndin liggur, og myndin verður avrita til hesa síðuna.',
	...
	'WRONG_ACTIVATION'			=> 'Lykilin tú hevur upplýst samsvarar ikki við nakran lykil í dátugrunninum.',
