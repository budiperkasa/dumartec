...
$lang = array_merge($lang, array(
	...
	'ACP_ADMIN_LOGS'			=> 'Historiques des administrateurs',
	...
	'ACP_BAN_EMAILS'			=> 'Bannir des e-mail',
	...
	'ACP_CRITICAL_LOGS'			=> 'Historiques des erreurs',
	...
	'ACP_FORUM_BASED_PERMISSIONS'	=> 'Permissions de base des forums',
	'ACP_FORUM_LOGS'				=> 'Historiques des forums',
	...
	'ACP_LANGUAGE_PACKS'		=> 'Packs de langues',
	...
	'ACP_MOD_LOGS'				=> 'Historiques des modérateurs',
	...
	'ACP_USERS_LOGS'				=> 'Historiques des utilisateurs',
  ...
  'ADM_LOGOUT'			=> 'Déconnexion de l’ACP',
	...
	'LOGIN_ADMIN_SUCCESS'	=> 'Vous vous êtes authentifié avec succès et allez être redirigé à présent vers le panneau de contrôle de l’administrateur.',
	...
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> 'Vous utilisez actuellement les permissions de %1$s. Vous pouvez parcourir le forum avec ces permissions mais vous ne pouvez plus accéder au panneau de contrôle de l’administrateur car les permissions des administrateurs n’ont pas été transférées. Vous pouvez <a href="%2$s"><strong>retourner aux réglages de vos permissions</strong></a> à tout moment.',
	'PIXEL'								=> 'px',
	...
	'SETTING_TOO_LOW'		=> 'La valeur que vous avez spécifiée pour le réglage “%1$s” est trop faible. La valeur minimale autorisée est de %2$d.',
	'SETTING_TOO_BIG'		=> 'La valeur que vous avez spécifiée pour le réglage “%1$s” est trop élevée. La valeur maximale autorisée est de %2$d.',	
	'SETTING_TOO_LONG'		=> 'La valeur que vous avez spécifiée pour le réglage “%1$s” est trop longue. La longueur maximale autorisée est de %2$d.',
	'SETTING_TOO_SHORT'		=> 'La valeur que vous avez spécifiée pour le réglage “%1$s” est trop courte. La longueur minimale autorisée est de %2$d.',
...
$lang = array_merge($lang, array(
	...
	'PURGE_CACHE_EXPLAIN'	=> 'Vide le cache de tous les fichiers et les requêtes des templates stockés.',
	...
	'VALUE'					=> 'Valeur',
	'VIEW_ADMIN_LOG'		=> 'Voir les historiques des administrateurs',
	'VIEW_INACTIVE_USERS'	=> 'Voir les utilisateurs inactifs',

	'WELCOME_PHPBB'			=> 'Bienvenue sur phpBB',
	'WRITABLE_CONFIG'      => 'Votre fichier de configuration (config.php) peut actuellement être écrit par tout le monde. Nous vous encourageons fortement de modifier les permissions en 640 ou au moins en 644 (par exemple : <a href="http://fr.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
));
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_REASON_REGISTER'		=> 'Le compte est nouvellement inscrit',
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Ceci est la liste des 10 derniers utilisateurs inscrits mais dont le compte est actuellement inactif. Une liste complète est disponible depuis le menu approprié ou en cliquant le lien ci-dessous d’où vous pourrez activer, supprimer ou rappeler (en envoyant un e-mail) ces utilisateurs.',
...
$lang = array_merge($lang, array(
  ...
  'LOG_MOVE'               => '<strong>Déplacement d’un sujet</strong><br />» de %1$s vers %2$s',
	...
	'LOG_GROUP_DEMOTED'		=> '<strong>Rétrogradation du responsable dans le groupe d’utilisateurs</strong> %1$s<br />» %2$s',
	'LOG_GROUP_PROMOTED'	=> '<strong>Promotion d’un membre en responsable dans le groupe d’utilisateurs</strong> %1$s<br />» %2$s',
