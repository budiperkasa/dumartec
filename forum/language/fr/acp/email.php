...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'Vous pouvez envoyer ici un e-mail à tous vos utilisateurs ou aux groupes d’utilisateurs <strong>ayant activés la réception des e-mail de masse</strong>. Pour cela, un e-mail sera envoyé à l’adresse e-mail fournie par l’administrateur et une copie sera adressée à tous les destinataires. Le réglage par défaut n’inclut que 50 destinataires par e-mail car plus il y a de destinataires, plus le temps d’attente est important. Il est normal que l’envoi d’un e-mail de masse prenne du temps, vous serez averti lorsque l’opération sera terminée.',
	...
	'EMAIL_SENT_QUEUE'		=> 'Ce message a été mis en file d’attente.',
