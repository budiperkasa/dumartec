...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_VIEWED_EXPLAIN'	=> 'Nombre de jours entre la dernière consultation du sujet à sa suppression.',

	'COPY_PERMISSIONS'				=> 'Copier les permissions de',
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> 'Une fois créé, le forum détiendra les mêmes permissions que celles que vous avez sélectionnées ici. Si aucun forum n’est sélectionné, le forum que vous avez créé ne sera pas visible car il ne détiendra aucune permission.',
	...
	'DECIDE_MOVE_DELETE_CONTENT'		=> 'Supprimer le contenu ou le déplacer au forum',
	'DECIDE_MOVE_DELETE_SUBFORUMS'		=> 'Supprimer les sous-forums ou les déplacer au forum',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'Dans phpBB3, les catégories n’existent plus, tout est basé sur la notion de forums. Chaque forum peut contenir un nombre illimité de sous-forums et vous pouvez déterminer s’ils peuvent contenir ou non des messages, comme c’était le cas grâce aux anciennes catégories. Vous pouvez ajouter, éditer, supprimer, verrouiller ou déverrouiller ici individuellement des forums aussi bien que régler certains contrôles additionnels. Si vos messages et vos sujets se désynchronisent, vous pouvez également resynchroniser un forum. <strong>Vous devez copier ou régler les permissions appropriées de chaque nouveau forum créé afin qu’ils soient visibles.</strong>',
	...
	'FORUM_CREATED'						=> 'Le forum a été crée avec succès.',
	...
	'FORUM_EDIT_EXPLAIN'				=> 'Le formulaire ci-dessous vous permet de personnaliser ce forum. La modération et les paramètres de contrôle du compteur de messages sont réglés par l’intermédiaire des permissions du forum pour chaque utilisateur ou groupe d’utilisateurs.',
	...
	'FORUM_NAME_EMPTY'					=> 'Veuillez saisir un nom pour ce forum.',
	'FORUM_PARENT'						=> 'Forum parent',
	'FORUM_PASSWORD'					=> 'Mot de passe du forum',
	'FORUM_PASSWORD_CONFIRM'			=> 'Confirmer le mot de passe du forum',
	'FORUM_PASSWORD_CONFIRM_EXPLAIN'	=> 'Ne complétez que si le mot de passe du forum a été spécifié.',
	'FORUM_PASSWORD_EXPLAIN'			=> 'Mettre en place un mot de passe pour ce forum. Utilisez de préférence un système de permissions.',
	...
	'FORUM_PASSWORD_MISMATCH'			=> 'Les mots de passes que vous avez saisis ne concordent pas.',
	...
	'FORUM_RULES_LINK_EXPLAIN'			=> 'Vous pouvez saisir ici le lien de la page ou du message contenant les règles de votre forum. Ce réglage écrasera les règles du forum que vous avez spécifié.',
	...
	'MOVE_POSTS_NO_POSTABLE_FORUM'	=> 'Le forum que vous avez sélectionné pour y déplacer le contenu n’est pas approprié. Veuillez sélectionner un forum dans lequel il est possible d’accueillir des messages.',
	'MOVE_POSTS_TO'					=> 'Déplacer les messages vers',
	'MOVE_SUBFORUMS_TO'				=> 'Déplacer les sous-forums vers',

	'NO_DESTINATION_FORUM'			=> 'Vous n’avez spécifié aucun forum pour y déplacer le contenu.',
	'NO_FORUM_ACTION'				=> 'Aucune action n’a été définie pour savoir ce qui se produit avec le contenu du forum.',
