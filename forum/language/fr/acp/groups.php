...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'De ce panneau vous pouvez administrer tous vos groupes d’utilisateurs. Vous pouvez également supprimer, créer et éditer les groupes existants. De plus, vous pouvez choisir des responsables de groupe, ouvrir, fermer et masquer les statuts des groupes et régler le nom et la description d’un groupe.',
	...
	'GROUP_COLOR_EXPLAIN'			=> 'Définit la couleur dans laquelle les noms d’utilisateurs des membres apparaîtront, laissez vide afin de conserver la couleur par défaut du membre.',
	...
	'GROUP_DEFAULT'					=> 'Définir le groupe comme celui par défaut pour les membres',
	...
	'GROUP_EDIT_EXPLAIN'			=> 'Vous pouvez éditer ici un groupe existant. Vous pouvez modifier son nom, sa description et son type (ouvert, fermé, etc.). Vous pouvez également régler certaines options du groupe comme sa coloration, son rang, etc. Les modifications effectués ici écraseront les réglages actuels des utilisateurs. Veuillez noter que les membres d’un groupe pourront écraser l’avatar du groupe, si les permissions des utilisateurs le permettent.',
	...
	'GROUP_LEADERS_ADDED'			=> 'Les nouveaux responsables ont été ajoutés au groupe avec succès.',
	...
	'GROUP_MEMBERS_EXPLAIN'			=> 'Ceci est la liste complète de tous les membres de ce groupe d’utilisateurs. Ils sont classés en différentes sections par responsables, membres en attente et membres existants. Vous pouvez gérer ici tous les adhérents de ce groupe ainsi que leurs rôles. Pour supprimer un responsable tout en le conservant dans le groupe, utilisez plutôt la rétrogradation au lieu de la suppression. De même, pour promouvoir un membre existant en responsable, utilisez la promotion.',
	'GROUP_MESSAGE_LIMIT'			=> 'Limite des messages privés des groupes par dossier',
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Ce réglage écrasera la limite des messages privés par dossier des utilisateurs. Une valeur de <samp>0</samp> signifie que la limite par défaut des utilisateurs sera utilisée.',
  ...
  'GROUP_MAX_RECIPIENTS_EXPLAIN'   => 'Le nombre maximum de destinataires autorisés dans un message privé. Si la valeur <samp>0</samp> est saisie, le réglage de la largeur du forum est utilisée.',
	...
	'GROUP_RECEIVE_PM_EXPLAIN'		=> 'Veuillez noter que les groupes invisibles ne sont pas autorisés à recevoir des messages.',
	...
	'SPECIAL_GROUPS_EXPLAIN'	=> 'Les groupes prédéfinis sont des groupes spéciaux, ils ne peuvent pas être supprimés ou directement modifiés. Cependant, vous pouvez y ajouter des utilisateurs et y modifier les réglages de base.',
	...
	'USER_DEF_GROUPS_EXPLAIN'		=> 'Ce sont des groupes créés par vous-même ou un autre administrateur du forum. Vous pouvez y gérer ses membres, éditer ses propriétés ou même le supprimer.',
