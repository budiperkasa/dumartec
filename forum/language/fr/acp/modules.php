...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Vous pouvez gérer ici l’ensemble des modules. Veuillez noter que le PCA a une structure à trois niveaux de menu (Catégorie -> Catégorie -> Module) alors que les autres ont une structure à deux niveaux de menu (Catégorie -> Module), ce qui doit être conservé. Veuillez également prendre conscience que vous pouvez vous bloquer si vous désactivez ou supprimez les modules responsables de la gestion des modules.',
	'ADD_MODULE'					=> 'Ajouter un module',
	'ADD_MODULE_CONFIRM'			=> 'Êtes-vous sûr de vouloir ajouter le module que vous avez sélectionné avec le mode sélectionné ?',
	...
	'CHOOSE_MODE_EXPLAIN'	=> 'Sélectionner les modes de module qui sera utilisé.',
