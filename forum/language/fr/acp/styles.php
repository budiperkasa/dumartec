...
$lang = array_merge($lang, array(
	...
	'EDIT_THEME_EXPLAIN'				=> 'Vous pouvez éditer ici le thème sélectionné, modifier les couleurs, les images, etc.',
	...
	'IMG_STICKY_READ_LOCKED_MINE'	=> 'Note pointée verrouillée',
	...
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Note pointée verrouillée avec nouveaux messages',

	'IMG_ANNOUNCE_READ'					=> 'Annonce',
	'IMG_ANNOUNCE_READ_MINE'			=> 'Annonce pointée',
	'IMG_ANNOUNCE_READ_LOCKED'			=> 'Annonce verrouillée',
	'IMG_ANNOUNCE_READ_LOCKED_MINE'		=> 'Annonce pointée verrouillée',
	...
	'INSTALL_IMAGESET_EXPLAIN'	=> 'Vous pouvez installer ici votre pack d’images sélectionné. Vous pouvez éditer certaines informations si vous le souhaitez ou utiliser les valeurs par défaut de l’installation.',
	'INSTALL_STYLE'				=> 'Installer un style',
	'INSTALL_STYLE_EXPLAIN'		=> 'Vous pouvez installer ici un nouveau style, et, si besoin, les éléments correspondants au style. Si vous avez déjà les éléments appropriés au style d’installés, ils ne seront pas écrasés. Quelques styles requièrent que les éléments existants soient déjà installés. Si vous essayez d’installer un style de ce genre et que vous n’avez pas les éléments requis, vous serez averti.',
	'INSTALL_TEMPLATE'			=> 'Installer un template',
	'INSTALL_TEMPLATE_EXPLAIN'	=> 'Vous pouvez installer ici un nouveau pack de templates. Selon la configuration de votre serveur, vous pouvez avoir un certain nombre d’options ici.',
	'INSTALL_THEME'				=> 'Installer un thème',
	'INSTALL_THEME_EXPLAIN'		=> 'Vous pouvez installer ici votre thème sélectionné. Vous pouvez éditer certains informations si vous le souhaitez ou utiliser les valeurs par défaut de l’installation.',
	...
	'LOCATION_DISABLED_EXPLAIN'   => 'Ce réglage est hérité et ne peut être modifié.',
	...
	'STYLE_EXPORT_EXPLAIN'		=> 'Vous pouvez exporter ici un style dans le formulaire d’une archive. Un style ne devra pas contenir tous les éléments, mais il doit en contenir au moins un. Par exemple, si vous créez un nouveau thème et un pack d’images pour un template fréquemment utilisé, vous pourriez simplement exporter le thème et le pack d’images et omettre le template. Vous pouvez choisir entre télécharger le dossier directement ou le placer dans votre répertoire de stockage pour le télécharger plus tard, ou par FTP.',
	...
	'TEMPLATE_DELETE_DEPENDENT'   => 'Le pack de templates ne peut être supprimé car un ou plusieurs autres templates héritent de lui :',
	...
	'TEMPLATE_ERR_REQUIRED_OR_INCOMPLETE' => 'Le nouveau pack de template doit avoir le template %s d’installé et ne pas hériter de lui.',
	'TEMPLATE_ERR_STYLE_NAME'	=> 'Vous devez entrer un nom pour ce template.',
	'TEMPLATE_EXPORT'			=> 'Exporter des templates',
	'TEMPLATE_EXPORT_EXPLAIN'	=> 'Vous pouvez exporter ici un pack de templates dans le formulaire d’une archive. L’archive ne devra pas contenir tous les fichiers nécessaires pour installer les templates sur un autre forum. Vous pouvez choisir entre télécharger le dossier directement ou le placer dans votre répertoire de stockage pour le télécharger plus tard, ou par FTP.',
	...
	'TEMPLATE_INHERITS'         => 'Ces packs de templates héritent de %s et ne peuvent donc pas avoir de réglages de stockage différents que ce super template.',
	...
	'THEME_EXPORT_EXPLAIN'		=> 'Vous pouvez exporter ici un thème dans le formulaire d’une archive. Cette archive contiendra toutes les données nécessaires à installer le thème dans un autre forum. Vous pouvez choisir entre télécharger le fichier directement, ou le placer dans votre dossier de stockage pour le télécharger plus tard ou par FTP.',
