...
$lang = array_merge($lang, array(
	...
	'BAN_ALREADY_ENTERED'	=> 'Le bannissement a déjà été spécifié avec succès. La liste des bannissements n’a pas été mise à jour.',
	'BAN_SUCCESSFUL'		=> 'Le bannissement a été spécifié avec succès.',
	...
	'CANNOT_DEACTIVATE_BOT'			=> 'Vous n’êtes pas autorisé à désactiver les comptes des robots. Veuillez plutôt désactiver le robot dans la page des robots.',
	...
	'CANNOT_FORCE_REACT_BOT'		=> 'Vous n’êtes pas autorisé à forcer la réactivation des comptes des robots. Veuillez plutôt réactiver le robot dans la page des robots.',
	...
	'CONFIRM_EMAIL_EXPLAIN'			=> 'Vous n’avez besoin de spécifier cela que si vous modifiez les adresses e-mail des utilisateurs.',
	...
	'FOUNDER'						=> 'Fondateur',
	'FOUNDER_EXPLAIN'				=> 'Les fondateurs ont toutes les permissions des administrateurs et ne peuvent pas être bannis, supprimés ou modifiés par des membres qui ne sont pas des fondateurs.',

	'GROUP_APPROVE'					=> 'Approuver le membre',
	'GROUP_DEFAULT'					=> 'Définir comme groupe par défaut pour le membre',
	...
	'MOVE_POSTS_EXPLAIN'	=> 'Veuillez sélectionner le forum dans lequel vous souhaitez déplacer tous les messages que cet utilisateur a publié.',
	...
	'USER_ADMIN_EXPLAIN'			=> 'Vous pouvez modifier ici les informations de vos utilisateurs ainsi que certaines options qui leur sont spécifiques.',
	...
	'USER_POSTS_MOVED'				=> 'Les messages des utilisateurs ont été déplacés sur le forum que vous avez spécifié avec succès.',
