...
$help = array(
	...
	array(
		...
		1 => 'L’option “Supprimer tous les cookies du forum” permet d’effacer tous les cookies crées par phpBB3 qui conservent votre authentification et votre connexion sur le forum. Cela fournit également des fonctionnalités telles que l’enregistrement du statut des messages, lu ou non-lu, si cela a été activé par le propriétaire du forum. Si vous avez des problèmes de connexion ou de déconnexion, la suppression des cookies du forum peut vous les corriger.',
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Comme avec les messages, les sondages ne peuvent être édités que par leur auteur, un modérateur ou un administrateur. Pour éditer un sondage, cliquez sur “Éditer” dans le premier message du sujet ; il y aura toujours le sondage associé à celui-ci. Si personne n’a voté, les utilisateurs peuvent supprimer le sondage ou éditer chaque option du sondage. Cependant, si les membres ont déjà exprimés leurs votes, seuls les modérateurs ou les administrateurs peuvent l’éditer ou le supprimer. Cela empêche les options d’un sondage à être modifiés en cours de route.'
	),
	array(
	...
	array(
		...
		1 => 'Les permissions pour ajouter des pièces jointes sont accordées par forum, par groupe, ou par utilisateur. L’administrateur du forum n’a peut-être pas autorisé les pièces jointes à être ajoutées dans le forum spécifique dans lequel vous souhaitez les insérer, ou seuls certains groupes sont peut-être autorisés à insérer des pièces jointes. Contactez l’administrateur du forum si vous ne savez pas pourquoi vous ne pouvez pas insérer de pièces jointes.'
	),
	array(
	...
	array(
		...
		1 => 'Cela autorise à sauvegarder les messages qui doivent être complétés et envoyés à une date ultérieure. Pour recharger un message sauvegardé, rendez-vous sur le panneau de contrôle de l’utilisateur.'
	),
	array(
	...
	array(
		...
		1 => 'Les icônes de sujets sont des images sélectionnées par l’auteur et sont associées à des messages afin d’indiquer leur contenu. La possibilité d’utiliser des icônes de sujets dépend des permissions définies par l’administrateur du forum.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Cette page vous fournit la liste de l’équipe du forum, incluant les administrateurs, les modérateurs et quelques informations telles que les forums qu’ils modèrent.'
	),
	array(
		0 => '--',
		1 => 'Messagerie privée'
	...
	array(
		0 => 'Comment puis-je effectuer une recherche dans un forum ou des forums ?',
		1 => 'Vous pouvez effectuer une recherche dans un forum ou des forums en saisissant un terme dans la boîte de recherche située sur l’index, sur les pages des forums et sur les pages des sujets. La recherche avancée peut être accessible en cliquant sur le lien “Recherche” disponible sur toutes les pages du forum. L’accès à la recherche dépend du style utilisé.'
	),
	array(
	...
	array(
		...
		1 => 'Pour s’abonner à un forum spécifique, cliquez sur le lien “Surveiller le forum” sur le forum souhaité. Pour s’abonner à un sujet, répondez au sujet en sélectionnant l’option d’abonnement ou cliquez sur le lien “Surveiller le sujet” sur la page du sujet.'
	),
	array(
