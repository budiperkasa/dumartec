...
$lang = array_merge($lang, array(
	...
	'BLANK_PREFIX_FOUND'			=> 'Une vérification de vos tables a détectée une installation valide n’utilisant aucun préfixe de table.',
	'BOARD_NOT_INSTALLED'			=> 'Aucune installation n’a été trouvée',
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'Une installation par défaut est exigée afin que l’outil de conversion de phpBB puisse fonctionner, veuillez <a href="%s">procéder à la première installation de phpBB3</a>.',

	'CATEGORY'					=> 'Catégorie',
	'CACHE_STORE'				=> 'Type de cache',
	'CACHE_STORE_EXPLAIN'		=> 'L’emplacement physique où les données sont mises en cache, le système de fichiers est préférable.',
	...
	'CONFIG_FILE_UNABLE_WRITE'	=> 'Il n’a pas été possible d’écrire le fichier de configuration. Des méthodes alternatives afin que ce fichier soit créé sont affichées ci-dessous.',
	'CONFIG_FILE_WRITTEN'		=> 'Le fichier de configuration a été écrit avec succès. Vous pouvez à présent continuer à la prochaine étape de l’installation.',
	...
	'CONV_ERROR_CONFIG_EMPTY'			=> 'Aucune information de configuration n’est disponible pour la conversion.',
	...
	'CONV_ERROR_INCONSISTENT_GROUPS'	=> 'Une contradiction a été détectée dans la table des groupes dans <var>add_bots()</var> - vous devez ajouter tous les groupes spéciaux si vous souhaitez le faire manuellement.',
	...
	'CONV_OPTIONS_BODY'					=> 'Cette page collecte les informations nécessaires afin d’accéder à votre forum source. Veuillez saisir les informations de la base de données de votre ancien forum ; le convertisseur ne modifiera pas la base de données que vous avez spécifiée ci-dessous. Il est recommandé de désactiver le forum source afin de permettre une conversion en toute sécurité.',
	...
	'DB_ERR_INSERT'				=> 'Erreur lors de l’exécution de la requête <code>INSERT</code>.',
	'DB_ERR_LAST'				=> 'Erreur lors de l’exécution de <var>query_last</var>.',
	...
	'DEFAULT_PREFIX_IS'			=> 'Le convertisseur n’a pu trouver aucune table avec le préfixe spécifié. Veuillez vous assurer d’avoir correctement saisi toutes les informations relatives au forum que vous souhaitez convertir. Le préfixe de la table par défaut pour %1$s est <strong>%2$s</strong>.',
	'DEV_NO_TEST_FILE'			=> 'Aucune valeur n’a été spécifiée pour la variable <var>test_file</var> dans le convertisseur. Si vous êtes un utilisateur de ce convertisseur, vous ne devriez pas avoir cette erreur, veuillez rapporter ce message à l’auteur du convertisseur. Si vous êtes l’auteur du convertisseur, vous devez saisir le nom du fichier qui existe dans le forum source afin de permettre au chemin d’être vérifié.',
	...
	'FORUM_ADDRESS_EXPLAIN'		=> 'Ceci est le lien de votre ancien forum, par exemple <samp>http://www.example.com/phpBB2/</samp>. Si une adresse est saisie ici et sur la gauche, chaque exemple de cette adresse sera remplacé par l’adresse de votre nouveau forum que vous avez saisie dans les messages, les messages privés et les signatures.',
	'FORUM_PATH'				=> 'Chemin du forum',
	'FORUM_PATH_EXPLAIN'		=> 'Ceci est le chemin <strong>relatif</strong> sur le disque vers votre ancien forum depuis la <strong>racine de cette installation de phpBB3</strong>.',
	'FOUND'						=> 'Trouvé',
	'FTP_CONFIG'				=> 'Transférer la configuration par FTP',
	'FTP_CONFIG_EXPLAIN'		=> 'phpBB a détecté la présence du module FTP sur ce serveur. Si vous le souhaitez, vous pouvez essayer d’installer votre fichier de configuration par l’intermédiaire du module. Vous devrez spécifier les informations demandées ci-dessous. Souvenez-vous que votre nom d’utilisateur et votre mot de passe sont ceux de votre serveur ! Demandez-les à votre hébergeur si vous n’êtes pas certain de les avoir.',
	'FTP_PATH'					=> 'Chemin FTP',
	...
	'INITIAL_CONFIG_EXPLAIN'	=> 'Maintenant que l’installation a déterminée que votre serveur peut correctement faire fonctionner phpBB, vous devez spécifier certaines informations. Si vous ne savez pas vous connecter à votre base de données, veuillez contacter en premier lieu votre hébergeur ou utiliser les forums de support phpBB. Lorsque vous saisissez des données, assurez-vous de les vérifier intégralement avant de continuer.',
	'INSTALL_CONGRATS'			=> 'Félicitations !',
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>Vous avez installé phpBB %1$s avec succès. Vous avez à présent le choix entre deux options afin de décider ce que vous souhaitez faire avec phpBB3 que vous avez nouvellement installé :</p>
		...
		<p>En cliquant sur le bouton ci-dessous, vous accéderez à votre panneau de contrôle de l’administrateur. Prenez votre temps afin d’examiner toutes les options qui vous sont disponibles. Souvenez-vous que de l’aide en ligne sur l’utilisation de phpBB est disponible par l’intermédiaire de la <a href="http://www.phpbb.com/support/documentation/3.0/">documentation</a>, des <a href="http://www.phpbb.com/community/viewforum.php?f=46">forums de support officiels</a> et des <a href="http://forum.phpbb.fr/">forums de support francophones</a>. Pour plus d’informations, consultez le fichier <a href="%3$s">README</a>.</p><p><strong>Veuillez à présent supprimer, déplacer ou renommer le répertoire d’installation avant d’utiliser votre forum. Tant que ce répertoire est présent, vous n’aurez accès qu’au panneau de contrôle de l’administrateur.</strong></p>',
	...
	<ul>
		...
		<li>Port du serveur de la base de données (le port du serveur de la base de données, mais dans la plupart des cas, il n’est pas obligatoire).</li>
	...
	<p><strong>Note :</strong> si vous procédez à une installation en utilisant SQLite, vous devriez saisir le chemin complet de votre fichier de la base de donnée dans le champ DNS et laisser le champ du nom d’utilisateur et du mot de passe vide. Pour des raisons de sécurité, vous devriez vous assurer que le fichier de la base de données ne soit pas stocké dans un endroit accessible depuis Internet.</p>
	...
	'INSTALL_NEXT_FAIL'			=> 'Certains tests ont échoués et vous devriez corriger ces problèmes avant de continuer à la prochaine étape. Un échec pourrait rendre une installation incomplète.',
	'INSTALL_NEXT_PASS'			=> 'Tous les tests de base ont été passés avec succès et vous pouvez à présent continuer à l’étape suivante de l’installation. Vous pouvez décider de tester à nouveau dans le cas où vous avez modifié certains modules, permissions, etc.',
	'INSTALL_PANEL'				=> 'Panneau de l’installation',
	'INSTALL_SEND_CONFIG'		=> 'Malheureusement, l’écriture directe des informations nécessaires sur le fichier de configuration a échouée. Il est possible que ce fichier n’existe pas ou qu’il ne soit pas inscriptible. Un certain nombre d’options seront énumérées ci-dessous afin de vous permettre d’accomplir correctement l’installation de ce fichier.',
	'INSTALL_START'				=> 'Commencer l’installation',
	'INSTALL_TEST'				=> 'Tester à nouveau',
	'INST_ERR'					=> 'Erreur lors de l’installation',
	...
	'INST_ERR_DB_NO_MYSQLI'		=> 'La version de MySQL installée sur votre serveur est incompatible avec l’option “MySQL avec extension MySQLi” que vous avez sélectionnée. Veuillez essayer de sélectionner l’option “MySQL” à la place.',
	'INST_ERR_DB_NO_SQLITE'		=> 'La version de l’extension SQLite installée sur votre serveur semble antérieure à la 2.8.2. Veuillez la mettre à jour afin de pouvoir procéder à l’installation de phpBB 3.0.',
	'INST_ERR_DB_NO_ORACLE'		=> 'La version d’Oracle installée sur votre serveur nécessite le réglage du paramètre <var>NLS_CHARACTERSET</var> sur <var>UTF8</var>. Veuillez mettre à jour votre version vers la 9.2+ ou modifier ce paramètre.',
	'INST_ERR_DB_NO_FIREBIRD'	=> 'La version de Firebird installée sur votre serveur semble antérieure à la 2.0. Veuillez la mettre à jour afin de pouvoir procéder à l’installation de phpBB 3.0.',
	'INST_ERR_DB_NO_FIREBIRD_PS'=> 'La base de données que vous avez sélectionnée pour Firebird est limitée à une taille des pages de 8192. Veuillez sélectionner une base de donnée plus grande ou augmenter cette taille.',
	'INST_ERR_DB_NO_POSTGRES'	=> 'La base de données que vous avez sélectionnée n’est pas encodée en <var>UNICODE</var> ou en <var>UTF8</var>. Veuillez sélectionner une base de données appropriée ou modifier cet encodage.',
	...
	'INST_ERR_EMAIL_MISMATCH'	=> 'Les adresses e-mail que vous avez saisies ne concordent pas.',
	...
	'PHP_OPTIONAL_MODULE_EXPLAIN'	=> '<strong>Facultatif</strong> - ces modules ou applications sont facultatives mais ils permettront l’activation de fonctionnalités supplémentaires s’ils sont disponibles.',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Les réglages de cette page ne sont nécessaires que s’ils diffèrent des réglages par défaut. Si vous avez un doute, ne modifiez pas ces réglages et continuez à l’étape suivante car ils pourront être modifiés ultérieurement sur le panneau de contrôle de l’administrateur.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Tous les fichiers sont à jour avec la dernière version de phpBB. Vous devriez à présent <a href="../ucp.php?mode=login">vous connecter sur votre forum</a> et vérifier si tout fonctionne correctement. N’oubliez pas de supprimer, de renommer ou de déplacer votre répertoire d’installation !',
	...
	'CHECK_FILES_UP_TO_DATE'		=> 'Selon votre base de données, votre version est à jour. Cependant, vous pouvez effectuer une vérification de tous vos fichiers pour vous assurer qu’ils soient bien à jour avec la dernière version de phpBB.',
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> 'Vous pouvez à présent <a href="../ucp.php?mode=login">vous connecter sur votre forum</a> et vérifier si tout fonctionne correctement. N’oubliez pas de supprimer, de renommer ou de déplacer votre répertoire d’installation !',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Fin du fichier original actuel / Début du nouveau fichier à jour',
	...
	'INCOMPATIBLE_UPDATE_FILES'		=> 'Les fichiers de mise à jour qui ont été trouvés sont incompatibles avec la version qui est actuellement installée. La version installée est la %1$s alors que les fichiers de mise à jour sont pour la mise à jour de phpBB %2$s vers phpBB %3$s.',
	...
	'MAPPING_FILE_STRUCTURE'	=> 'Pour faciliter le transfert, les emplacements des différents fichiers conduisant à votre installation sont affichés.',
	...
	'NEW_FILE'						=> 'Fin du nouveau fichier à jour',
	'NEW_USERNAME'					=> 'Nouveau nom d’utilisateur',
	'NO_AUTH_UPDATE'				=> 'Impossible de mettre à jour',
	...
	'OLD_UPDATE_FILES'		=> 'Les fichiers de mise à jour sont obsolètes. Les fichiers de mise à jour sont à exécuter pour effectuer la mise à jour de phpBB %1$s vers phpBB %2$s mais la dernière version est phpBB %3$s.',
  ...
  'TRY_DOWNLOAD_METHOD_BUTTON'=> 'Essayer maintenant cette méthode',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Rendez-vous sur <a href="http://www.phpbb.fr/" title="http://www.phpbb.fr/">la communauté francophone</a> ou sur <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">pla communauté officielle</a> et téléchargez l’“archive de mise à jour automatique”.<br /><br /></li>
		...
		<p>Une fois le répertoire transféré, votre forum sera mis hors-ligne aux utilisateurs pour une simple raison de sécurité.<br /><br />
	...
	'UPDATE_INSTRUCTIONS_INCOMPLETE'	=> '
		...
		<p>phpBB a détecté une mise à jour automatique incomplète. Veuillez vous assurer d’avoir suivi chaque étape de l’outil de mise à jour automatique correctement. Vous trouverez ci-dessous le lien afin de recommencer à nouveau ou vous pouvez vous rendre directement sur votre répertoire d’installation.</p>
	',
	'UPDATE_METHOD'					=> 'Méthode de mise à jour',
	'UPDATE_METHOD_EXPLAIN'			=> 'Veuillez à présent sélectionner votre méthode de mise à jour préférentielle. En utilisant le transfert FTP, vous devrez saisir les informations de votre compte FTP dans un formulaire. Grâce à cette méthode, les fichiers seront déplacés automatiquement vers le nouvel emplacement et vos anciens fichiers seront sauvegardés avec l’extension <strong>.bak</strong> à la fin du nom du fichier. Si vous choisissez de télécharger les fichiers modifiés, vous pourrez les décompresser et les transférer manuellement vers l’emplacement qui leur est spécifique.',
	...
	'UPDATE_SUCCESS_EXPLAIN'		=> 'Tous les fichiers ont été mis à jour avec succès. La prochaine étape consiste à revérifier tous les répertoires afin de vous assurer que les fichiers ont été mis à jour correctement.',
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Vérifie que la version de phpBB que vous utilisez actuellement est à jour.',
	'VERSION_NOT_UP_TO_DATE'	=> 'Votre version de phpBB n’est pas à jour. Veuillez continuer la procédure de mise à jour.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'Votre version de phpBB n’est pas à jour.<br />Vous trouverez ci-dessous un lien vers l’annonce de sortie de la dernière version et les instructions nécessaires afin d’effectuer correctement cette mise à jour.',
	'VERSION_UP_TO_DATE'		=> 'Votre installation est à jour, aucune mise à jour n’est disponible pour votre version de phpBB. Cependant, vous pouvez vérifier intégralement vos fichiers afin de s’assurer qu’ils soient corrects.',
