...
$lang = array_merge($lang, array(
	...
	'DELETE_SHADOW_TOPIC'		=> 'Supprimer la redirection de sujet',
	...
	'EMPTY_REPORT'					=> 'Vous devez saisir une description lors de la sélection de cette raison.',
	...
	'IPS_POSTED_FROM'		=> 'Adresses IP que cet utilisateur a utilisé',
	...
	'LEAVE_SHADOW'				=> 'Laisser sur place une redirection de sujet',
	...
	'MCP_QUEUE'								=> 'File d’attente de la modération',
	'MCP_QUEUE_APPROVE_DETAILS'				=> 'Approuver les informations',
	'MCP_QUEUE_UNAPPROVED_POSTS'			=> 'Messages en attente d’approbation',
	'MCP_QUEUE_UNAPPROVED_POSTS_EXPLAIN'	=> 'Ceci est la liste de tous les messages qui nécessitent une approbation avant qu’ils soient visibles aux utilisateurs.',
	'MCP_QUEUE_UNAPPROVED_TOPICS'			=> 'Sujets en attente d’approbation',
	'MCP_QUEUE_UNAPPROVED_TOPICS_EXPLAIN'	=> 'Ceci est la liste de tous les sujets qui nécessitent une approbation avant qu’ils soient visibles aux utilisateurs.',
	...
	'NO_ENTRIES'					=> 'Aucun historique n’existe pour cette période.',
	...
	'NO_POST'						=> 'Vous devez sélectionner un message avant d’avertir un utilisateur pour un message.',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Veuillez utiliser ce formulaire afin de rapporter le message sélectionné. Seuls les messages violant des règles du forum devraient être rapportés.',
	...
	'SPLIT_TOPIC_EXPLAIN'				=> 'En utilisant le formulaire ci-dessous vous pouvez diviser un sujet en deux. Pour ce faire, sélectionnez individuellement les sujets ou divisez à partir d’un sujet sélectionné.',
	...
	'WARNED_USERS_EXPLAIN'	=> 'Ceci est la liste des utilisateurs avertis dont la période n’est pas encore expirée.',
