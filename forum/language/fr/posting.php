...
$lang = array_merge($lang, array(
	...
	'ATTACH_QUOTA_REACHED'		=> 'Désolé, la limite du nombre de pièces jointes sur le forum a été atteinte.',
	...
	'LOAD_DRAFT_EXPLAIN'		=> 'Vous pouvez sélectionner ici le brouillon que vous souhaitez continuer à rédiger. Votre message actuel sera annulé et tout son contenu sera supprimé. Vous pouvez consulter, éditer et supprimer vos brouillons dans votre panneau de contrôle de l’utilisateur.',
	...
	'NO_DELETE_POLL_OPTIONS'	=> 'Vous ne pouvez pas supprimer les options d’un sondage qui sont déjà existantes.',
	...
	'PHP_SIZE_OVERRUN'			=> 'La taille de la pièce jointe est trop importante, la taille maximale autorisée est de %d Mo.<br />Veuillez noter que ce réglage est situé dans le fichier <var>php.ini</var> et ne peut pas être écrasé.',
	'PLACE_INLINE'				=> 'Insérer dans la ligne',
	'POLL_DELETE'				=> 'Supprimer le sondage',
	'POLL_FOR'					=> 'Ouvrir le sondage pendant',
	...
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Insérez chaque option sur une nouvelle ligne. Vous pouvez saisir jusqu’à <strong>%d</strong> options. Si vous supprimez ou ajoutez des options, tous les votes précédents seront réinitialisés.',
	...
	'POLL_TITLE_COMP_TOO_LONG'	=> 'La taille du titre de votre sondage est trop importante, le BBCode ou les émoticônes devant être supprimés.',
	...
	'POST_STORED_MOD'			=> 'Ce message a été envoyé avec succès mais il doit être approuvé par un modérateur avant qu’il soit visible publiquement.',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Saisissez <samp>0</samp> ou laissez vide pour ne jamais terminer la note/annonce.',
	'STYLES_TIP'				=> 'Astuce : les styles peuvent être rapidement appliqués en sélectionnant le texte.',
	...
	'TOO_MANY_ATTACHMENTS'		=> 'Impossible d’ajouter une nouvelle pièce jointe, %d est le maximum.',
	...
	'TOO_MANY_POLL_OPTIONS'		=> 'Vous avez essayé de voter pour trop d’options pour le sondage.',
