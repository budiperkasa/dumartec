...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'En accédant à “%1$s” (désigné ici par “nous”, “notre”, “nos”, “%1$s”, “%2$s”), vous acceptez d’être légalement responsable des conditions suivantes. Si vous n’acceptez pas d’être légalement responsable de toutes les conditions suivantes, veuillez ne pas utiliser et/ou accéder à “%1$s”. Nous pouvons modifier ces conditions à n’importe quel moment et nous essaierons de vous informer de ces modifications, bien qu’il soit conseillé de vérifier régulièrement cela de vous-même car si vous continuez à participer à “%1$s” après que les modifications aient été effectuées, vous acceptez d’être légalement responsable des conditions modifiées et/ou mises à jour.<br />
	<br />
	...
	<br />
	Vous acceptez de ne publier aucun contenu à caractère abusif, obscène, vulgaire, diffamatoire, choquant, menaçant, pornographique ou autre qui pourrait transgresser les lois de votre pays, le pays où “%1$s” est hébergé ou la Loi Internationale. Ne pas respecter cela peut vous mener à un bannissement immédiat et permanent, en plus de l’envoi d’un avertissement à votre fournisseur d’accès à Internet si nous jugeons cela nécessaire. L’adresse IP de tous les messages est enregistrée afin d’aider au renforcement de ces conditions. Vous acceptez le fait que “%1$s” ait le droit de supprimer, éditer, déplacer ou verrouiller n’importe quel sujet lorsque nous estimons que cela est nécessaire. n tant qu’utilisateur, vous acceptez que toutes les informations que vous avez saisies soient stockées dans notre base de données. Bien que cette information ne sera pas diffusée à une tierce partie sans votre consentement, ni “%1$s” et ni phpBB ne pourront être tenus comme responsables en cas de tentative de piratage visant à compromettre les données.
	',
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_COPPA'					=> 'Votre compte a été créé mais il doit être approuvé. Veuillez vérifier vos e-mail pour plus d’informations.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Votre compte a été mis à jour avec succès. Cependant, vous devez le réactiver car vous avez modifié votre adresse e-mail. Une clé d’activation a été envoyée sur la nouvelle adresse e-mail que vous avez fournie. Veuillez vérifier vos e-mail pour plus d’informations.',
	...
	'ACCOUNT_INACTIVE'				=> 'Votre compte a été créé avec succès. Cependant, vous devez activer votre compte. Une clé d’activation a été envoyée sur l’adresse e-mail que vous avez fournie. Veuillez vérifier vos e-mail pour plus d’informations.',
	...
	'BACK_TO_DRAFTS'			=> 'Retourner aux brouillons sauvegardés',
	...
	'CONFIRM_EXPLAIN'			=> 'Afin d’empêcher les inscriptions automatisées, vous devez saisir un code de confirmation. Le code est affiché dans l’image que vous devriez voir ci-dessous. Si vous êtes visuellement déficient ou que vous éprouvez des difficultés à lire ce code correctement, veuillez contacter l’%sadministrateur du forum%s.',
	'CONFIRM_PASSWORD'			=> 'Confirmer le mot de passe',
	'CONFIRM_PASSWORD_EXPLAIN'	=> 'Vous ne devez confirmer votre mot de passe que si vous l’avez modifié ci-dessus.',
	'COPPA_BIRTHDAY'			=> 'Pour continuer la procédure d’inscription, veuillez nous renseigner votre date de naissance.',
	'COPPA_COMPLIANCE'			=> 'Conformité de la COPPA',
	'COPPA_EXPLAIN'				=> 'Veuillez noter que si vous cliquez sur le bouton <em>Envoyer</em>, cela créera votre compte. Cependant, celui-ci ne peut être activé que si un parent ou un tuteur légal approuve votre inscription. Vous recevrez une copie du formulaire avec les renseignements à nous envoyer.',
	'CREATE_FOLDER'				=> 'Ajouter un dossier…',
	'CURRENT_IMAGE'				=> 'Image actuelle',
	'CURRENT_PASSWORD'			=> 'Mot de passe actuel',
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Vous devez confirmer votre mot de passe actuel si vous souhaitez le modifier, tout comme votre adresse e-mail ou votre nom d’utilisateur.',
	...
	'FORCE_PASSWORD_EXPLAIN'	=> 'Avant que vous ne puissiez continuer à naviguer sur le forum, vous devez modifier votre mot de passe.',
	'FRIEND_MESSAGE'			=> 'Message d’un ami',
	'FRIENDS'					=> 'Amis',
	'FRIENDS_EXPLAIN'			=> 'Les amis vous permettent d’accéder rapidement aux membres avec qui vous communiquez fréquemment. Si le template le permet, les messages de vos amis seront mis en surbrillance.',
	...
	'INVALID_CHARS_NEW_PASSWORD'=> 'Le mot de passe que vous avez spécifié ne contient pas les caractères exigés.',
	...
	'LOGOUT_FAILED'				=> 'Vous n’avez pas été déconnecté car la requête n’a pas fonctionnée sur votre session. Veuillez contacter l’administrateur du forum si vous continuez à rencontrer des problèmes.',
	...
	'NOT_ADDED_FRIENDS_ANONYMOUS'	=> 'Vous ne pouvez pas ajouter les utilisateurs anonymes dans votre liste d’amis.',
	...
	'NOT_ADDED_FOES_MOD_ADMIN'		=> 'Vous ne pouvez pas ajouter les administrateurs et les modérateurs dans votre liste d’ignorés.',
	'NOT_ADDED_FOES_ANONYMOUS'		=> 'Vous ne pouvez pas ajouter les utilisateurs anonymes dans votre liste d’ignorés.',
  ...
  'NO_AUTH_SEND_MESSAGE'         => 'Vous n’êtes pas autorisé à envoyer des messages privés.',
	...
	'NO_EMAIL_USER'				=> 'Les informations sur l’e-mail ou sur le nom d’utilisateur sont introuvables.',
	...
	'NO_NEW_FOLDER_NAME'		=> 'Vous devez spécifier un nom pour le nouveau dossier.',
	...
	'PASSWORD_UPDATED'			=> 'Votre mot de passe a été envoyé à votre adresse e-mail avec succès.',
	...
	'PM_TO'						=> 'Envoyer à',
	'PM_USERS_REMOVED_NO_PM'	=> 'Certains utilisateurs ne peuvent pas être ajoutés car ils ont désactivés la réception des messages privés.',
	'POPUP_ON_PM'				=> 'Afficher une pop-up lors d’un nouveau message privé',
	...
	'REPLIED_MESSAGE'					=> 'Réponse du message',
	...
	'WATCHED_EXPLAIN'			=> 'La liste ci-dessous vous informe des forums et des sujets auxquels dans lesquels vous êtes abonné. Vous serez averti lorsque de nouveaux messages seront publiés dans ces derniers. Pour vous désabonner, sélectionnez le forum ou le sujet souhaité puis cliquez sur le bouton <em>Ne plus surveiller la sélection</em>.',
