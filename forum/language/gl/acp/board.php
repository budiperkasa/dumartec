...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER'			=> 'Activar mensaxes en cola',
	'ENABLE_QUEUE_TRIGGER_EXPLAIN'	=> 'Posibilidade de subordinar as mensaxes de usuarios rexistrados á aprobación das mesmas se a conta daquelas é inferior á especificada embaixo. Este axuste non ten efectos na configuración de permisos para a aprobación de mensaxestemas.',
	'QUEUE_TRIGGER_POSTS'			=> 'Conta máxima para os mensaxes en cola',
	'QUEUE_TRIGGER_POSTS_EXPLAIN'	=> 'Se as mensaxes en cola están activadas, este é o número delas que precisa acadar o usuario para poder publicar sen aprobación previa. Se a conta de mensaxes dos usuarios é inferior a este número, a mensaxe en cuestión será gardada na cola de xeito automático.',
	...
	'CHAR_LIMIT'					=> 'Número máximo de caracteres por mensaxe publicada',
	'CHAR_LIMIT_EXPLAIN'			=> 'Pono a 0 para número ilimitado de caracteres.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Con isto determínase se os usuarios teñen acceso inmediatamente ao foro ou se se precisa confirmación. Tamén podes deshabilitar novos rexistros.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'		=> 'Aquí podes definir os valores por defecto da confirmación visual e mais as opcións captcha.',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'O CAPTCHA aparecerá así se usas os axustes actuais. Usa o botón de previsualizar para refrescar a mostra. Ten en conta que os captchas son aleatorios e polo tanto variarán dunha vista á seguinte.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> 'O contido xerado será comprimido denantes de ser enviado ao usuario. Isto pode reducir o tráfico da rede pero tamén pode incrementar o uso da CPU tanto no cliente coma no servidor.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Se desactivas isto ningún correo será enviado polo foro.',
