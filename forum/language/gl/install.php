...
$lang = array_merge($lang, array(
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>A instalación do phpBB %1$s rematou de xeito correcto. De aquí en diante tes dúas opcións a escoller para levar a cabo no teu phpBB3 recentemente instalado:</p>
		...
		<p>Premendo no botón de embaixo accederás ao teu Panel de Control de Administración (PCA). Inviste algo de tempo en examinar as opcións que alí tes dispoñibles. E lembra que a axuda é accesible en liña a traverso da <a href="http://www.phpbb.com/support/documentation/3.0/">Documentación</a>, <a href="http://www.phpbb.com/community/viewforum.php?f=46">os foros de soporte oficiais</a> e <a href="http://www.ciberirmandade.org/foros/">os foros da CiberIrmandade da Fala</a> (non oficiais, agás no apartado de tradución ao galego). Bótalle unha ollada ao arquivo <a href="%3$s">LEME</a> para ter máis información.</p><p><strong>Agora elimina, move ou renomea o directorio de instalación denantes de usar o teu taboleiro. Se o directorio estivese aínda presente, só sería accesible o Panel de Control de Administración (PCA).</strong></p>',
...
// TODO: write some more introductions here
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'A versión do FireBird instalado neste equipo é anterior á versión 2.0, actualizao á versión máis nova.',
	...
	'SUPPORT_BODY'				=> 'Durante a fase de lanzamento candidato a versión final ofrecerase soporte completo no <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">foros de soporte do phpBB 3.0.x</a>. Daremos resposta a cuestións de configuración xerais, problemas de configuración determinados, problemas de conversión e problemas habituais relacionados cos bugs. Tamén permitiremos discusións sobre modificacións e adicións de código/estilos á medida.</p><p> Para asistencia adicional, vai á nosa <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Guía de Inicio Rápido</a> e <a href="http://www.phpbb.com/support/documentation/3.0/">á documentación en liña</a>.</p><p> Para asegurarte de estar ao día coas últimas novas e versións, por que non <a href="http://www.phpbb.com/support/" target="_new">te subscribes a nosa lista de correo?</a>',
	'SYNC_FORUMS'				=> 'Comezando a sincronización dos foros',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Tódolos arquivos están actualizados coa última versión do phpBB. Agora xa podes executar a actualización da base de datos.',
	...
	'CURRENT_FILE'					=> 'Arquivo orixinal actual',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Remate do ficheiro actual / Comezo do novo ficheiro actualizado',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Usar código de ficheiro modificado na unión final.',
	'MERGE_NEW_FILE_OPTION'		=> 'Usar código de ficheiro novo na unión final.',
	...
	'NEW_FILE'						=> 'Novo arquivo actualizado',
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Verifica se a versión phpBB que estás utilizando está actualizada.',
	'VERSION_NOT_UP_TO_DATE'	=> 'A túa versión de phpBB non está actualizada. Por favor continúa o proceso de actualización.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'A túa versión de phpBB non está actualizada.<br /> Debaixo atoparás unha ligazón á presentación da nova versión así como instrucións para levar a cabo a actualización.',
	...
	'VERSION_UP_TO_DATE_ACP'	=> 'A túa instalación está ao día, non hai actualizacións dispoñíbeis para a túa versión de phpBB. Non precisas actualizar a túa instalación.',
