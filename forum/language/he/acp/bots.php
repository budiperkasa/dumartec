...
$lang = array_merge($lang, array(
	'BOTS'				=> 'ניהול בוטים',
	'BOTS_EXPLAIN'		=> '”בוטים”, ”עכבישים” או ”תולעים” הם נציגים אוטומטים אשר בשימוש בדרך כלל על-ידי מנועי חיפוש כדי לעדכן את בסיס הנתונים שלהם. מכיוון שהם עושים לעיתים רחוקות שימוש נכון בפעולות (sessions) הם יכולים לעוות מוני ביקורים, להגדיל טעינה ולפעמים להכשל בהכנסת האתרים כראוי. כאן תוכל להגדיר סוג מיוחד של משתמש על מנת להתגבר על בעיות אלו.',
