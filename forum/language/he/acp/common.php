...
$lang = array_merge($lang, array(
	...
	'ACP_VC_SETTINGS'					=> 'הגדרות אישור חזותי',
	'ACP_VC_CAPTCHA_DISPLAY'			=> 'תצוגה מקדימה לתמונת האישור החזותי',
    ...
    'SETTING_TOO_LOW'      => 'הערך שהוזן עבור ההגדרה “%1$s” קטן מידי. הערך המינימאלי המאושר הינו %2$d.',
    'SETTING_TOO_BIG'      => 'הערך שהוזן עבור ההגדרה “%1$s” גדול מידי. הערך המאקסימאלי המאושר הינו %2$d.',   
    'SETTING_TOO_LONG'      => 'הערך שהוזן עבור ההגדרה “%1$s” ארוך מידי. הערך המאקסימאלי המאושר הינו %2$d.',
    'SETTING_TOO_SHORT'      => 'הערך שהוזן עבור ההגדרה “%1$s” קצר מידי מידי. הערך המינימאלי המאושר הינו %2$d.',
...
$lang = array_merge($lang, array(
	...
	'PURGE_CACHE_CONFIRM'	=> 'אתה בטוח שאתה רוצה לטהר את המטמון?',
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>שינה הגדרות אישור חזותי</strong>',
	...
	'LOG_UNLOCK'				=> '<strong>שחרר נעילה לנושא</strong><br />» %s',
	'LOG_UNLOCK_POST'			=> '<strong>שחרר נעילה להודעה</strong><br />» %s',
	...
	'LOG_FORUM_SYNC'						=> '<strong>סנכרן מחדש פורום</strong><br />» %s',
	...
	'LOG_USERS_APPROVED'	=> '<strong>משתמשים אושרו בקבוצת משתמשים</strong> %1$s<br />» %2$s',
	...
	'LOG_REFERER_INVALID'      => '<strong>בדיקת דף מפנה נכשלה</strong><br />»הדף המפנה היה “<em>%1$s</em>”. הבקשה נדחתה.',
	...
	'LOG_USER_LOCK'				=> '<strong>משתמש נעל נושא שלו</strong><br />» %s',
	...
	'LOG_USER_UNLOCK'			=> '<strong>משתמש שחרר מנעילה נושא שלו</strong><br />» %s',
