...
$lang = array_merge($lang, array(
	...
	'ENABLE_POST_REVIEW'			=> 'אפשר דירוג הודעה',
	'ENABLE_POST_REVIEW_EXPLAIN'	=> 'אם סימנת כן משתמשים יוכלו לדרג את הודעותיהם אם הודעות חדשות נוצרו לנושא בזמן שהמשתמשים כתבו בו. אפשרות זאת אמורה להיות מבוטלת בפורומים שעקרונם הבסיסי הוא דיבורים נרחבים על כלל הנושאים.',
