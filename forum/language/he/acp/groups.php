...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'בדף זה תוכל לערוך את כל קבוצות המשתמשים הקיימות בפורום שלך, אתה יכול למחוק, ליצור ולערוך קבוצות קיימות. בנוסף, אתה יכול לבחור אחראיי קבוצה, לשנות את מצב הקבוצה בין פתוח/מוסתר/סגור ולקבוע את שם ותיאור הקבוצה.',
	'ADD_USERS'						=> 'הוסף משתמשים',
	'ADD_USERS_EXPLAIN'				=> 'כאן אתה יכול להוסיף משתמשים חדשים לקבוצה. אתה יכול לבחור אם קבוצה זו תהפוך לברירת המחדל החדשה של המשתמשים שיבחרו. בנוסף באפשרותך להפוך אותם לאחראיי קבוצה. אנא הכנס כל שם משתמש עם רווח בין שם לשם.',
	...
	'GROUPS_NO_MODS'				=> 'לא נבחר אחראי קבוצה',
	...
	'GROUP_LEAD'					=> 'אחראיי קבוצה',
	'GROUP_LEADERS_ADDED'			=> 'אחראיים נוספים נוספו לקבוצה בהצלחה.',
	...
	'GROUP_MEMBERS_EXPLAIN'			=> 'זוהי הרישמה המלאה של כל המשתמשים החברים בקבוצה זו. כולל רווחים לזיהוי האחראיים, הממתינים והחברים הקיימים. מפה אתה יכול לערוך הכל. בכדי להסיר אחראי אך להשאיר את החברים בקבוצה השתמש בהדחה ולאחר מכן מחק. וההפך השתמש בקידום בכדי להפוך משתמש קיים לאחראי קבוצה.',
	...
	'GROUP_MODS_ADDED'				=> 'אחראי קבוצה חדשים נוספו בהצלחה.',
	'GROUP_MODS_DEMOTED'			=> 'אחראי הקבוצה הודחו בהצלחה.',
	...
	'GROUP_PROMOTE'					=> 'קדם לאחראי הקבוצה',
	...
	'USER_GROUP_LEADER'				=> 'הגדר כאחראי הקבוצה',
));
