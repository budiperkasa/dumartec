...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'כאן אתה יכול לנהל את כל סוגי המודלים. שים לב שלוח הבקרה למנהל הראשי יש שלוש רמות של מבנה (קטגוריה -> קטגוריה -> מודל) באמצעותו לאחרים יש את מבנה התפריט (קטגוריה -> מודל) שחייב להישמר. אנא היה עירני שלא תנעל את עצמך אם אתה מבטל או מוחק את המודלים האחראים על ניהול המודלים בעצמם.',
