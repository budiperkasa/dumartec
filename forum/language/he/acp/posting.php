...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'מלוח בקרה זה אתה יכול להוסיף, לערוך, ולהסיר מילים אשר יצונזרו אוטומטית בפורומים. בנוסף אנשים לא יוכלו להרשם עם שמות משתמשים המכילים מילים אלו. סימנים כוללים (*) מתקבלים בשדה המילה.',
...
// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'כאן אתה יכול לנהל את הסיבות עבור הדיווחים ולאבחין בין הודעות כאשר אתה לא מאשר אותן. ישנה סיבת ברירת מחדל אחת המסומנת ה* (כוכבית) ואותה אינך יכול למחוק, הסיבה הזאת בשימוש עבור דיווח מותאם אישית במידה ואין סיבה מתאימה.',
