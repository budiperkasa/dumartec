...
$lang = array_merge($lang, array(
	...
	'AVATAR_PHP_SIZE_OVERRUN'		=> 'קובץ הסמל האישי גדול מדי. הגודל המירבי המורשה להעלאה הוא %d MB.<br />שים לב שהגודל נקבע ב php.ini ואינו ניתן לשינוי.',
	...
	'NEW_PM'					=> '<strong>%d</strong> הודעה חדשה',
