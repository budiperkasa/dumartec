...
$help = array(
	...
	array(
		...
		1 => 'אם אתה בטוח שהגדרת את אזור הזמן ושעון קיץ נכון והזמן עדין אינו מכוון כראוי, אז כנראה והזמנים המוגדרים בשרת אינם מוגדרים כראוי. אנא יידע את מנהל המערכת לטיפול בבעיה זו.'
	),
	array(
