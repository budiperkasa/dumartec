...
$lang = array_merge($lang, array(
	...
	'DLL_GD'					=> 'תמיכה בגראפיקות GD [ אישור חזותי ]',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>התקנת בהצלחה את גרסת הפיתוח phpBB %1$s. מכאן, מכאן יש לך שתי אפשרויות כיצד להמשיך ולהשתמש במערכת phpBB3 שלך:</p>
		...
		<p>לחיצה על הכפתור הבא תעביר אותך ללוח הבקרה למנהלים ראשיים. קח לעצמך מעט זמן על מנת לבחון את האפשרויות הזמינות לך. זכור שעזרה תינתן דרך <a href="http://www.phpbb.com/support/documentation/3.0/">התיעוד</a> ו<a href="http://www.phpbb.co.il/">פורומי התמיכה</a>, ראה את <a href="%3$s">README</a> למידע נוסף.</p><p><strong>אנא מחק, העבר או שנה כעת את שם התיקיה install לפני שתשתמש במערכת שלך. אם התיקיה עדיין קיימת, רק לוח הבקרה למנהלים ראשיים יהיה נגיש.</strong></p>',
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'הגרסה של Firebird המותקנת על שרת זה ישנה יותר מגרסה 2.0, שדרג לגרסה חדשה יותר.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'כל הקבצים מעודכנים לגרסה האחרונה של phpBB. אתה צריך כעת <a href="../ucp.php?mode=login">להתחבר לפורום שלך</a> ולבדוק אם הכל עובד כשורה. אל תשכח למחוק, לשנות שם או להעביר את תיקית ההתקנה!',
	...
	'CURRENT_FILE'					=> 'תחילת הקובץ המקורי הנוכחי',
	...
	'DIFF_SEP_EXPLAIN'					=> 'סוף הקובץ המקורי הנוכחי / תחילת הקובץ החדש המעודכן',	
	...
	'MERGE_MOD_FILE_OPTION'		=> 'מזג הבדלים והשתמש בקוד ששונה באיזור ההתנגשות',
	'MERGE_NEW_FILE_OPTION'		=> 'מזג הבדלים והשתמש בקוד הקובץ החדש באיזור ההתנגשות',
	'MERGE_SELECT_ERROR'		=> 'מצבי מיזוג קבצים עם התנגשות לא נבחרו כראוי.',
	'MERGING_FILES'				=> 'ממזג שינויים',
	'MERGING_FILES_EXPLAIN'		=> 'אוסף כרגע שינויי קובץ סופי.<br /><br />אנא המתן עד ש phpBB תשלים את כל הפעולות על קבצים ששונו.',

	'NEW_FILE'						=> 'סוף הקובץ החדש המעודכן',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'כרגע התבצעו שינויים על %1$d מתוך %2$d קבצים שנאספו.<br />אנא המתן עד שכל הקבצים יאספו.',
	...
	'VERSION_CHECK_EXPLAIN'		=> 'בודק אם הגרסה הנוכחית של PHPBB בה כרגע אתה משתמש מעודכנת.',
	'VERSION_NOT_UP_TO_DATE'	=> 'הגרסה של phpBB3 שרשותך אינה עדכנית. אנא המשך בתהליך העדכון.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'הגרסה של phpBB3 שברשותך אינה עדכנית.<br />להלן תמצא קישור להכרזת השחרור של הגרסה האחרונה וכמו כן הוראות על כיצד לבצע את תהליך העדכון.',
	'VERSION_UP_TO_DATE'		=> 'המערכת שברשותך עדכנית, אין עדכונים זמינים לגרסה של phpBB3 שלך. תוכל להמשיך בכל זאת ולבצע את בדיקת חוקיות הקבצים.',
	'VERSION_UP_TO_DATE_ACP'	=> 'הינך משתמש בגרסה העדכנית ביותר של phpBB3.',
	'VIEWING_FILE_CONTENTS'		=> 'רואה תוכן קובץ',
	'VIEWING_FILE_DIFF'			=> 'רואה הבדלי קובץ',
