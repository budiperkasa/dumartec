...
$lang = array_merge($lang, array(
	...
	'PHP_SIZE_OVERRUN'			=> 'גודל הקובץ המצורף גדול מדי, הגודל להעלאה המירבי הוא %d MB.<br />שים לב שהגודל נקבע בקובץ php.ini ואינו ניתן לשינוי.',
	...
	'POST_EDITED_MOD'			=> 'ההודעה נערכה בהצלחה, אך היא צריכה לקבל אישור ממנהל לפני שתפורסם לכולם. ',
	'POST_GLOBAL'				=> 'גלובאלי',
	...
	'POST_STORED_MOD'			=> 'ההודעה נשלחה בהצלחה, אבל היא צריכה לקבל אישור ממנהל לפני שתפורסם לכולם.',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'הזן 0 או השאר ריק להכרזה/דביק ללא תאריך לסיום.',
