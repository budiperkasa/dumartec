...
// Updater
$lang = array_merge($lang, array(
'ALL_FILES_UP_TO_DATE'=> '(Sve) Datoteke su <em/>up to date</em> (najnovije) u odnosu na zadnju verziju phpBB-a.<br />Trebao/la bi se <a href="../ucp.php?mode=login">prijaviti na forum</a> i provjeriti radi li sve kako spada. Nemoj zaboraviti izbrisati/preimenovati/premjestiti install mapu!',
...
'CONTINUE_UPDATE_NOW'=> 'Nastavi (sada) s procesom ažuriranja',	// Shown within the database update script at the end if called from the updater
