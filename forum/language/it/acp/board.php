...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER'          => 'Abilita coda approvazione messaggi',
    'ENABLE_QUEUE_TRIGGER_EXPLAIN'  => 'Permette di inserire in coda approvazione i messaggi degli utenti con un numero messaggi minore del valore specificato. Questa impostazione non ha effetto sul sistema dei permessi di approvazione messaggio/argomento.',
    'QUEUE_TRIGGER_POSTS'           => 'Numero messaggi massimo per coda approvazione messaggi',
    'QUEUE_TRIGGER_POSTS_EXPLAIN'   => 'Se la coda approvazione messaggi è attiva, questo è il numero di messaggi che l’utente deve possedere per inviare messaggi che non necessitano di approvazione. Se il numero di messaggi dell’utente è minore, il messaggio verrà automaticamente inserito in coda approvazione.',
