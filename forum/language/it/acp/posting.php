...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Da qui è possibile aggiungere, modificare o cancellare le parole che saranno automaticamente censurate nel sistema. Tieni presente che nessuno potrà utilizzare la parola censurata nel sistema nemmeno come nome utente. Nel campo parola, sono accettate le abbreviazioni (*), Es. *test* vale anche per detestabile, test* va bene per testaccio, *test va bene per contest.',
