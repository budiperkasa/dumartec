...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'ここでは phpBB のデータベースデータをバックアップできます。バックアップデータを <samp>store/</samp> フォルダに保管するか、パソコンにダウンロードするかを選択してください。 サーバの設定によってファイルの圧縮形式をいくつか選択できます。',
	'ACP_RESTORE_EXPLAIN'	=> 'ここでは phpBB のデータベースデータの復元を行うことができます。サーバが gzip または bzip2 圧縮形式をサポートしている場合、それら圧縮ファイルは自動的に解凍されます。<strong>警告</strong>：データの復元はデータの上書きを意味します。データを復元する前に必ずデータをバックアップしてください。また復元の完了には時間がかかりますが、復元が完了するまでこのページから移動しないようにしてください。phpBB のバックアップ機能を使用した場合、バックアップファイルは <samp>store/</samp> フォルダに保管されます。phpBB 以外のバックアップ機能で作成されたバックアップファイルによるデータの復元はうまくいかない事があるので注意してください。',
	...
	'RESTORE_SUCCESS'		=> 'データベースの復元に成功しました。<br /><br />掲示板はバックアップが作成された時点の状態に戻っているはずです。',
	...
	'TABLE_SELECT_ERROR'=> '少なくともテーブルを１つ選択する必要があります。',
));
