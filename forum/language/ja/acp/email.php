...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'ここでは全登録ユーザーまたは<strong>大量メールの受信オプションを有効にしている</strong>グループにメールを送信できます。 大量メールとは実は、宛先に管理人のメールアドレスを、BCC（ブラインド・カーボン・コピー）に受信ユーザーの全メールアドレスをセットして送信したメールの事です。デフォルトでは１つの大量メールにつき受信ユーザー数は最大で５０人です。５０人以上のユーザーを指定した場合、大量メールは複数回に渡って送信されます。その場合、送信処理が終わるまでページを移動しないでください。大量メールには時間がかかるのが普通です。メール送信処理が完全に終了するとその旨のメッセージがページに表示されます。',
	'ALL_USERS'						=> '全ユーザー',
	...
	'MASS_MESSAGE_EXPLAIN'	=> '平文を入力してください。BBCodeやHTMLは使用できません。',
