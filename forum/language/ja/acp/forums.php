...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_DAYS_EXPLAIN'	=> 'トピックが生存し続ける、最終返信日からの日数です。この日数が経ってもそのトピックに返信が無かった場合、そのトピックはプルーニングされます。',
	'AUTO_PRUNE_FREQ'			=> '自動プルーニングの頻度',
	'AUTO_PRUNE_FREQ_EXPLAIN'	=> 'この日数が経つ毎にトピックのプルーニング（削除）が実行されます',
	'AUTO_PRUNE_VIEWED'			=> 'トピックの閲覧寿命',
	'AUTO_PRUNE_VIEWED_EXPLAIN'	=> 'トピックが生存し続ける、最終閲覧日からの日数です。この日数が経ってもそのトピックが閲覧されなかった場合、そのトピックはプルーニングされます。',
	...
	'DECIDE_MOVE_DELETE_CONTENT'		=> '投稿記事を削除する/別のフォーラムへ移動する',
	'DECIDE_MOVE_DELETE_SUBFORUMS'		=> 'サブフォーラムを削除する/別のフォーラムへ移動する',
	...
	'FORUM_ADMIN'						=> 'フォーラム管理',
	'FORUM_ADMIN_EXPLAIN'				=> 'phpBB3 のシステムを構成する基本的な概念は “フォーラム” であり “カテゴリ” ではありません。いかなるフォーラムも無限に（サブ）フォーラムを持つことが可能であり、それらフォーラム個々についてフォーラムタイプをカテゴリ、フォーラム、リンクのどれかから指定する必要があります。ここではフォーラムの追加、編集、削除、閉鎖、閉鎖解除などを実行できます。もしフォーラムのトピック数、投稿数、トピックの返信数、閲覧数がトピックの削除などによって正確なカウント数でなくなっている場合、同期を実行する事によってカウント数を正確にする事が可能です。<strong>新しく作成したフォーラムを表示させるには他のフォーラムからパーミッションをコピーするか、パーミッションを適切に設定する必要があります。</strong>',
	...
	'FORUM_DELETE_EXPLAIN'				=> 'ここではフォーラムの削除を実行できます。フォーラムが投稿可能フォーラムである場合、そのフォーラムの全トピック（または全サブフォーラム）を他のフォーラムに移動できます。',
	...
	'FORUM_PASSWORD_MISMATCH'			=> '入力したパスワードが不一致です',
	...
	'FORUM_RULES_LINK_EXPLAIN'			=> 'フォーラムルールを記したページまたは投稿記事へのURLを入力できます。入力すると下の “フォーラムルール” オプションが無効になります。',
	'FORUM_RULES_PREVIEW'				=> 'フォーラムルールプレビュー',
	'FORUM_RULES_TOO_LONG'				=> 'フォーラムルールは４０００字以内にしてください',
