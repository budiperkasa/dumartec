...
$lang = array_merge($lang, array(
	...
	'GROUP_EDIT_EXPLAIN'			=> 'ここではグループの編集を行うことができます。グループの名前、説明、タイプを変更できます。グループカラー、ランク等の追加オプションも設定できます。これらの設定はユーザー設定を上書きします。適切なユーザーパーミッションを設定していない場合、グループアバター設定よりもグループメンバーのアバター設定が優先される事に注意してください。 ',
	'GROUP_ERR_USERS_EXIST'			=> '指定したユーザーはすでにグループのメンバーです',
	'GROUP_FOUNDER_MANAGE'			=> 'グループ作成者のみグループを管理する',
	'GROUP_FOUNDER_MANAGE_EXPLAIN'	=> 'このグループを管理できるユーザーをグループ作成者だけに限定します。グループ管理パーミッションを持つユーザーは引き続きグループとそのメンバーを見る事ができます。',
	'GROUP_HIDDEN'					=> '非公開',
	'GROUP_LANG'					=> 'グループの言語',
	'GROUP_LEAD'					=> 'グループリーダー',
	...
	'GROUP_TYPE'					=> 'グループタイプ',
	'GROUP_TYPE_EXPLAIN'			=> '開放：登録ユーザーは誰でもグループに参加できます。<br />申請制：登録ユーザーはグループに参加を申請できます。参加するにはグループリーダーの承認が必要です。<br />閉鎖：グループはメンバーの募集を行いません。メンバーの追加はグループリーダーが行います。<br />非公開：グループメンバーとAdmin以外の全ユーザーに対してグループの存在を隠します。',
	...
	'SPECIAL_GROUPS_EXPLAIN'	=> '特別グループとは掲示板を設置した時に初めから存在しているグループの事です。特別グループを削除したりグループ名を変更したりする事はできません。ユーザーの追加、基本設定の変更は行えます。',
