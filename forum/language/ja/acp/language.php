...
$lang = array_merge($lang, array(
	...
	'LANGUAGE_ENTRIES_EXPLAIN'			=> 'ここでは言語パック内の各ファイルの言語キーを修正、翻訳できます。<br /><strong>注意：</strong>アップロードした場合、修正した言語ファイルはオリジナルファイルとは違う場所に保管されます。修正ファイルを得るには保管ディレクトリからダウンロードしてください。オリジナルファイルを修正ファイルに置き換えるまでユーザーが見る掲示板に変化はありません。',
	...
	'THOSE_MISSING_LANG_FILES'			=> '次の言語ファイルが言語フォルダ %s に見つかりませんでした',
	'THOSE_MISSING_LANG_VARIABLES'		=> '次の言語値が言語パック <strong>%s</strong> に見つかりませんでした',
