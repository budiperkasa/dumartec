...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<h2>グローバルパーミッション</h2>
		<p>グローバルレベルでのパーミッションをコントロールし、掲示板全体に渡って効力を発揮します。グローバルパーミッションとして、ユーザーパーミッション、グローバルモデレータパーミッション、Adminパーミッションの３つがあります。</p>

		<h2>ローカルパーミッション</h2>
		<p>ローカルレベルでのパーミッションをコントロールし、掲示板の各フォーラムにのみ効力を発揮します。 ローカルパーミッションとして、フォーラムパーミッションとフォーラムモデレータパーミッションの２つがあります。</p>

		<h2>パーミッションセット</h2>
		<p>パーミッションセット（パーミッションオプションの集まり）を管理できます。パーミッションの種類としてユーザー、フォーラム、モデレータ、Adminの４つが存在します。デフォルトで用意されているパーミッションセットは掲示板を管理しやすいように権限が大きいものから小さいものまでありますが、より掲示板を管理しやすいようにパーミッションセットの追加/編集/削除をあなたの裁量で自由に行う事ができます。</p>
	...
	'ACL_NEVER'				=> 'Never',
	'ACL_SET'				=> 'パーミッションの設定',
	'ACL_SET_EXPLAIN'		=> 'ユーザーまたはグループにパーミッションを割り当てるには、それぞれのユーザーまたはグループに対してパーミッションセットを割り当てるか、カスタム設定でパーミッションオプションを個別に選択する（ “はい” にする）必要があります。<br /><em>パーミッション設定が重複している状況について分かり易く説明するために、例としてユーザーＸさんがグループＡとグループＢのメンバーである状況を想定してみましょう。<br />例１：あるパーミッションオプションがグループＡで <samp>はい</samp> 、グループＢで <samp>いいえ</samp> に設定されている場合、たとえユーザーＸで <samp>いいえ</samp> に設定されていたとしても、ユーザーＸはそのパーミッションオプションを<b>持ちます</b>。<br />例２：あるパーミッションオプションがグループＡで <samp>はい</samp>、グループＢで <samp>Never</samp> に設定されている場合、たとえユーザーＸで <samp>はい</samp> に設定されていたとしても、ユーザーＸはそのパーミッションオプションを<b>持ちません</b>。<br />つまり要約するとパーミッション設定の力関係は <samp>いいえ</samp> ＜ <samp>はい</samp> ＜ <samp>Never</samp> であるという事です。</em><br />通常は <samp>Never</samp> の使用はグループではなく個々のユーザーのみに控えた方が良いでしょう。また、複数のユーザーまたはグループを同時にパーミッション設定する場合、ユーザー名またはグループ名の隣にあるチェックボックスをチェックする事でパーミッション設定をコピーできます。',
	'ACL_SETTING'			=> '設定値',
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'ここではユーザーとグループに対してAdminパーミッションを割り当てる事ができます。Adminパーミッションを持つユーザーは AdminCP へ入室できます。',
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'ここではグループに対してグローバルパーミッション（ユーザーパーミッション、グローバルモデレータパーミッション、Adminパーミッション）を割り当てる事ができます。ユーザーパーミッションはアバターやプライベートメッセージの使用などの権限を、グローバルモデレータパーミッションは投稿記事の承認やトピック管理やアクセス禁止などの権限を、Adminパーミッションはパーミッション設定やBBCodeのカスタム設定やフォーラム管理などの権限をそれぞれ含みます。ユーザー個々のパーミッションの設定は特別な事情がある場合のみに限るべきです。推奨される方法はユーザーをまずグループに振り分け、そのグループに対してパーミッションを割り当てる方法です。',
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'ここではAdminパーミッションセットを管理できます。パーミッションセットとはパーミッションオプションの集まりの事であり、もしパーミッションセットの構成を変更するとそのパーミッションセットを持つユーザーとグループのパーミッションも変更されます。',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'ここではフォーラムパーミッションのパーミッションセットを管理できます。パーミッションセットとはパーミッションオプションの集まりの事であり、もしパーミッションセットの構成を変更するとそのパーミッションセットを持つユーザーとグループのパーミッションも変更されます。',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'ここではモデレータパーミッションのパーミッションセットを管理できます。パーミッションセットとはパーミッションオプションの集まりの事であり、もしパーミッションセットの構成を変更するとそのパーミッションセットを持つユーザーとグループのパーミッションも変更されます。',
	'ACP_USER_ROLES_EXPLAIN'					=> 'ここではユーザーパーミッションのパーミッションセットを管理できます。パーミッションセットとはパーミッションオプションの集まりの事であり、もしパーミッションセットの構成を変更するとそのパーミッションセットを持つユーザーとグループのパーミッションも変更されます。',
	'ACP_USERS_FORUM_PERMISSIONS_EXPLAIN'		=> 'ここではユーザーに対してローカルパーミッション（フォーラムパーミッション、モデレータパーミッション）を割り当てる事ができます。',
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'ここではユーザーに対してグローバルパーミッション（ユーザーパーミッション、グローバルモデレータパーミッション、Adminパーミッション）を割り当てる事ができます。ユーザーパーミッションはアバターやプライベートメッセージの使用などの権限を、グローバルモデレータパーミッションは投稿記事の承認やトピック管理やアクセス禁止などの権限を、Adminパーミッションはパーミッション設定やBBCodeのカスタム設定やフォーラム管理の権限などをそれぞれ含みます。多数のユーザーに対して同じ設定をする場合はグローバルパーミッション [ グループ ] を利用した方が良いでしょう。ユーザー個々のパーミッションの設定は特別な事情がある場合のみに限るべきです。推奨される方法はユーザーをまずグループに振り分け、そのグループに対してパーミッションを割り当てる方法です。',
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> 'ここではユーザーまたはグループに割り当てられたAdminパーミッションを閲覧・確認できます',
	...
	'DELETE_ROLE_CONFIRM'		=> 'パーミッションセットを本当に削除してもよろしいですか？もし削除した場合、このパーミッションセットを持つユーザーとグループはパーミッションオプションを<strong>失いません</strong>。',
	'DISPLAY_ROLE_ITEMS'		=> 'このパーミッションセットを持つユーザー/グループの閲覧',

	'EDIT_PERMISSIONS'			=> 'パーミッション編集',
	'EDIT_ROLE'					=> 'パーミッションセットの編集',

	'GROUPS_NOT_ASSIGNED'		=> 'このパーミッションセットを持つグループはありません',
	...
	'PERMISSION_APPLIED_TO_ALL'		=> 'ユーザー/グループのチェックボックスをチェックすると、パーミッションオプションまたはパーミッションセットはそれらチェックしたユーザー/グループにも同様に設定されます',
	...
	'ROLE_ASSIGNED_TO'				=> 'パーミッションセット %s を持つユーザー/グループ',
	...
	'ROLE_DESCRIPTION_ADMIN_STANDARD'		=> 'ほとんどの管理機能へのアクセスが可能ですが、サーバ/システム関連ツールの使用は許可されていません。',
	...
	'ROLE_DESCRIPTION_LONG'			=> 'パーミッションセットの説明文が長すぎます。４０００字以内にしてください。',
	...
	'ROLE_NOT_ASSIGNED'				=> 'このパーミッションセットを持つユーザー/グループはありません',
	...
	'TRACE_DEFAULT'					=> 'パーミッションのデフォルトは <samp>いいえ</samp>（未設定） です。以下に続く各グループまたはユーザーのパーミッション設定次第でトータル値は <samp>はい</samp> か <samp>NEVER</samp> に上書きされます。',
	'TRACE_FOR'						=> 'トレース',
	...
	'TRACE_GROUP_NEVER_TOTAL_NO'			=> '<samp>NEVER</samp> に設定されています。トータル値がまだ設定されていないのでこの値が新しいトータル値となります。',
 	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'		=> '<samp>NEVER</samp> に設定されています。トータル値がまだ設定されていないのでこの値が新しいトータル値となります。',
	'TRACE_GROUP_NEVER_TOTAL_YES'			=> '<samp>NEVER</samp> に設定されています。よってトータル値は <samp>はい</samp> から <samp>NEVER</samp> に上書きされます。',
 	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'		=> '<samp>NEVER</samp> に設定されています。よってトータル値は <samp>はい</samp> から <samp>NEVER</samp> に上書きされます。',
	'TRACE_GROUP_NO'						=> '<samp>いいえ</samp> に設定されているので、トータル値に変更はありません。',
 	'TRACE_GROUP_NO_LOCAL'				=> '<samp>いいえ</samp> に設定されているので、トータル値に変更はありません。',
	'TRACE_GROUP_YES_TOTAL_NEVER'			=> '<samp>はい</samp> に設定されていますが、直前のトータル値が <samp>NEVER</samp> なので、トータル値に変更はありません。',
 	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'		=> '<samp>はい</samp> に設定されていますが、直前のトータル値が <samp>NEVER</samp> なので、トータル値に変更はありません。',
	'TRACE_GROUP_YES_TOTAL_NO'				=> '<samp>はい</samp> に設定されています。トータル値がまだ設定されていないので、この値が新しいトータル値となります。',
 	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'			=> '<samp>はい</samp> に設定されています。トータル値がまだ設定されていないので、この値が新しいトータル値となります。',
	'TRACE_GROUP_YES_TOTAL_YES'				=> '<samp>はい</samp> に設定されています。直前のトータル値も <samp>はい</samp> なので、トータル値に変更はありません。',
 	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'		=> '<samp>はい</samp> に設定されています。直前のトータル値も <samp>はい</samp> なので、トータル値に変更はありません。',
	'TRACE_PERMISSION'				=> 'パーミッションのトレース - %s',
 	'TRACE_RESULT'					=> 'トレース結果',
	'TRACE_SETTING'					=> 'トレース',

	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> '<samp>はい</samp> に設定されていますが、トータル値が既に <samp>はい</samp> なのでトータル値に変更はありません。%sグローバルパーミッションのトレース%s',
	...
	'TRACE_USER_FOUNDER'					=> 'このユーザーはウェブマスターなので、Adminパーミッションはデフォルトで <samp>はい</samp> に設定されています。',
	'TRACE_USER_KEPT'					=> '<samp>いいえ</samp> に設定されているので、トータル値に変更はありません。',
	'TRACE_USER_KEPT_LOCAL'				=> '<samp>いいえ</samp> に設定されているので、トータル値に変更はありません。',
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> '<samp>NEVER</samp> に設定されています。トータル値も <samp>NEVER</samp> なので, トータル値に変更はありません。',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'		=> '<samp>NEVER</samp> に設定されています。トータル値も <samp>NEVER</samp> なので, トータル値に変更はありません。',
	'TRACE_USER_NEVER_TOTAL_NO'			=> '<samp>NEVER</samp> に設定されています。直前が <samp>いいえ</samp> なので、トータル値は <samp>NEVER</samp> に上書きされます。',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> '<samp>NEVER</samp> に設定されています。直前が <samp>いいえ</samp> なので、トータル値は <samp>NEVER</samp> に上書きされます。',
	'TRACE_USER_NEVER_TOTAL_YES'			=> '<samp>NEVER</samp> に設定されています。よってトータル値は <samp>はい</samp> から <samp>NEVER</samp> に上書きされます。',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> '<samp>NEVER</samp> に設定されています。よってトータル値は <samp>はい</samp> から <samp>NEVER</samp> に上書きされます。',
	'TRACE_USER_NO_TOTAL_NO'				=> '<samp>いいえ</samp> に設定されています。直前のトータル値も <samp>いいえ</samp> なので、トータル値は <samp>NEVER</samp> に変更されます。',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> '<samp>いいえ</samp> に設定されています。直前のトータル値も <samp>いいえ</samp> なので、トータル値は <samp>NEVER</samp> に変更されます。',
	'TRACE_USER_YES_TOTAL_NEVER'			=> '<samp>はい</samp> に設定されていますが、直前のトータル値が <samp>NEVER</samp> なので、トータル値は上書きされません。',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> '<samp>はい</samp> に設定されていますが、直前のトータル値が <samp>NEVER</samp> なので、トータル値は上書きされません。',
	'TRACE_USER_YES_TOTAL_NO'				=> '<samp>はい</samp> に設定されています。直前のトータル値が <samp>いいえ</samp> なので、トータル値は <samp>はい</samp> に上書きされます。',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> '<samp>はい</samp> に設定されています。直前のトータル値が <samp>いいえ</samp> なので、トータル値は <samp>はい</samp> に上書きされます。',
	'TRACE_USER_YES_TOTAL_YES'				=> '<samp>はい</samp> に設定されています。直前のトータル値が <samp>はい</samp> なので、トータル値に変更はありません。',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'			=> '<samp>はい</samp> に設定されています。直前のトータル値が <samp>はい</samp> なので、トータル値に変更はありません。',
	'TRACE_WHO'								=> '設定対象',
	'TRACE_TOTAL'							=> 'トータル値',
