...
$lang = array_merge($lang, array(
	...
	'acl_u_pm_bbcode'	=> array('lang' => 'プライベートメッセージでのBBCodeの使用', 'cat' => 'pm'),
	'acl_u_pm_smilies'	=> array('lang' => 'プライベートメッセージでのスマイリーの使用', 'cat' => 'pm'),
	'acl_u_pm_img'		=> array('lang' => 'プライベートメッセージでのBBCode [Img] の使用', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'プライベートメッセージでのBBCode [Flash] の使用', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_bbcode'		=> array('lang' => '投稿記事でのBBCodeの使用', 'cat' => 'content'),
	'acl_f_smilies'		=> array('lang' => '投稿記事でのスマイリーの使用', 'cat' => 'content'),
	'acl_f_img'			=> array('lang' => '投稿記事でのBBCode [Img] の使用', 'cat' => 'content'),
	'acl_f_flash'		=> array('lang' => '投稿記事でのBBCode [Flash] の使用', 'cat' => 'content'),
	...
	'acl_f_search'		=> array('lang' => 'フォーラムで検索', 'cat' => 'misc'),
	'acl_f_ignoreflood' => array('lang' => '連続投稿制限の無視', 'cat' => 'misc'),
	'acl_f_postcount'	=> array('lang' => '投稿数のカウント<br /><em>記事が投稿された場合のみカウントされる事に注意してください。投稿記事が削除、移動された場合にカウント数が影響を受ける事はありません。</em>', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_a_aauth'		=> array('lang' => 'Adminパーミッションセットの変更', 'cat' => 'permissions'),
	...
	'acl_a_reasons'		=> array('lang' => '理由（リポート/却下）の管理', 'cat' => 'misc'),
