...
$lang = array_merge($lang, array(
	...
	'BBCODE_HELPLINE_TOO_LONG'	=> '入力したヘルプラインが長すぎます',
	
	'BBCODE_INVALID_TAG_NAME'	=> 'その BBCode タグは既に存在しています',
	'BBCODE_INVALID'			=> 'BBCode の定義に問題があります',
	'BBCODE_OPEN_ENDED_TAG'		=> 'BBCode は開始タグと終了タグの両方を含んでいる必要があります',
	'BBCODE_TAG'				=> 'タグ',
	'BBCODE_TAG_TOO_LONG'		=> 'タグが長すぎます',
	'BBCODE_TAG_DEF_TOO_LONG'	=> '入力したタグが長すぎます。タグを短くしてください。',
	'BBCODE_USAGE'				=> 'BBCode の定義',
...
$lang = array_merge($lang, array(
	...
	'EXPORT_ICONS_EXPLAIN'		=> '%sこちらをクリックするとアイコンパックファイル <samp>icons.pak</samp> のダウンロードを開始します。パックファイル <samp>icons.pak</samp> を images/icons ディレクトリにアップロードすればアイコン設定をインストールできます。画像ファイルとパックファイルを１つのファイルにまとめる事でインストールパックを作成できるでしょう。',
	'EXPORT_SMILIES'			=> 'smilies.pak のエクスポート &amp; ダウンロード',
	'EXPORT_SMILIES_EXPLAIN'	=> '%sこちらをクリックするとスマイリーパックファイル <samp>smilies.pak</samp> のダウンロードを開始します。パックファイル <samp>smilies.pak</samp> を images/smilies ディレクトリにアップロードすればスマイリー設定をインストールできます。画像ファイルとパックファイルを１つのファイルにまとめる事でインストールパックを作成できるでしょう。',
	...
	'WRONG_PAK_TYPE'	=> '指定したパック内のデータは適切なデータではありません',
));

// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'ここでは言語フィルターの追加、編集、削除を行うことができます。投稿記事にもし言語フィルターに登録されている言葉があれば自動的に指定された言葉に置き換えられて文章が表示されます。ユーザー登録の際、言語フィルターリストに追加されている言葉をユーザー名に含める事はできません。部分一致としてワイルドカード(*)を使用できます（例： *test* という言語フィルターの場合、detestable, detest といった言葉も置換します）。',
	'ADD_WORD'				=> '言語フィルターの追加',
...
// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'ここでは、ユーザーが投稿記事をモデレータにリポートする時の理由（なぜリポートしたか）と、モデレータが記事の承認を却下する時に選択する理由（なぜ却下したか）を管理できます。デフォルト理由（ * でマークされています）は削除できません。デフォルト理由は該当する理由がない場合に使用されます。',
	'ADD_NEW_REASON'		=> '理由の追加',
	'AVAILABLE_TITLES'		=> '定義済み理由',
	
	'IS_NOT_TRANSLATED'			=> '言語ファイルで定義されて<strong>いません</strong>',
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'この理由は言語ファイルで定義されて<strong>いません</strong>。もし定義済み理由を追加したい場合、言語ファイル（language/jp/acp/mcp.php）で定義されている理由（言語キー）を入力してください。',
	'IS_TRANSLATED'				=> '言語ファイルで定義されています',
	'IS_TRANSLATED_EXPLAIN'		=> 'この理由は言語ファイルで定義されています。ここで入力した理由タイトルが言語ファイル（language/jp/mcp.php）で定義されていれば、その定義済み理由のタイトルと説明が使用されます。',
	
	'NO_REASON'					=> '理由が見つかりません。',
	'NO_REASON_INFO'			=> '理由タイトルと理由の説明の両方を入力する必要があります。',
	'NO_REMOVE_DEFAULT_REASON'	=> 'デフォルト理由である “Other” を削除する事はできません。',

	'REASON_ADD'				=> '理由の追加',
	'REASON_ADDED'				=> '理由の追加に成功しました',
	'REASON_ALREADY_EXIST'		=> '入力した理由タイトルは既に存在しています。別のタイトルを入力してください。',
	'REASON_DESCRIPTION'		=> '理由の説明',
	'REASON_DESC_TRANSLATED'	=> '定義済み理由の説明',
	'REASON_EDIT'				=> '理由（リポート/却下）の編集',
	'REASON_EDIT_EXPLAIN'		=> 'ここでは理由の追加と編集を行う事ができます。入力した理由が定義済み理由である場合は定義済み理由が表示されます。',
	'REASON_REMOVED'			=> '理由の削除に成功しました',
	'REASON_TITLE'				=> '理由タイトル',
	'REASON_TITLE_TRANSLATED'	=> '定義済み理由タイトル',
