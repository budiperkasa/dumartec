...
$lang = array_merge($lang, array(
	...
	'BAN_SUCCESSFUL'		=> 'アクセス禁止データの入力に成功しました',

	'CANNOT_BAN_FOUNDER'			=> 'ウェブマスターをアクセス禁止にする事はできません',
	'CANNOT_BAN_YOURSELF'			=> '自分自身をアクセス禁止にする事はできません',
	'CANNOT_DEACTIVATE_BOT'			=> 'ボットアカウントを停止する事はできません。かわりにスパイダー/ボット管理ページで無効化してください。',
	'CANNOT_DEACTIVATE_FOUNDER'		=> 'ウェブマスターのアカウントを停止する事はできません',
	'CANNOT_DEACTIVATE_YOURSELF'	=> '自分自身のアカウントを停止する事はできません',
	'CANNOT_FORCE_REACT_BOT'		=> 'ボットに対してアカウント有効化メールを送信する事はできません。かわりにスパイダー/ボット管理ページでボットを有効化してください。',
	...
	'FOUNDER'						=> 'ウェブマスター',
	'FOUNDER_EXPLAIN'				=> 'ウェブマスター（原文:Founder)は全てのAdminパーミッションを持ち、また他ユーザーからアクセス禁止、アカウント停止、アカウント削除される事はありません。',
