...
$lang = array_merge($lang, array(
	...
	'ACTIVE'						=> '有効',
	'ACTIVE_ERROR'					=> '入力したユーザー名のアカウントは現在停止しています。アカウントの有効化に関して何か問題がある場合は管理人にご連絡ください。',
	'ADMINISTRATOR'					=> 'Admin',
	...
	'ASCENDING'						=> '昇順',
	'ATTACHMENTS'					=> '添付ファイル',
	'ATTACHED_IMAGE_NOT_IMAGE'		=> '添付しようとした画像は正常ではありません',
	'AUTHOR'						=> '作成者',
	'AUTH_NO_PROFILE_CREATED'		=> 'ユーザープロフィールの取得に失敗しました',
	'AVATAR_DISALLOWED_CONTENT'		=> 'アップロードファイルの内容と MIME Type が一致しなかったため、アップロードファイルの受付を拒否しました',
	...
	'AVATAR_PHP_SIZE_NA'			=> 'アバター画像のファイルサイズが大きすぎます。<br />php.ini オプション upload_max_filesize の設定値を取得できませんでした。',
	'AVATAR_PHP_SIZE_OVERRUN'		=> 'アバター画像のファイルサイズが大きすぎます。アップロード可能なファイルの最大サイズは %d MB です。<br />この値は php.ini で設定されており、プログラム側（phpBB3）がこの設定値を上書きする事はできません。',
	...
	'ENABLED'							=> '有効',
	'ENCLOSURE'							=> '囲み文字',
	'ERR_CHANGING_DIRECTORY'			=> 'FTPセッションを開始するに当たってカレントディレクトリをルートディレクトリに変更（CHDIR）できなかったため、プログラム処理を中断しました',
	'ERR_CONNECTING_SERVER'				=> 'サーバ接続時にエラーが発生しました',
	'ERR_JAB_AUTH'						=> 'Jabber サーバ認証に失敗しました',
	'ERR_JAB_CONNECT'					=> 'Jabber サーバに接続できませんでした',
	'ERR_UNABLE_TO_LOGIN'				=> '入力したユーザー名またはパスワードが正しくありません',
	'ERR_UNWATCHING'					=> '監視の解除を実行中にエラーが発生しました',
	'ERR_WATCHING'						=> '監視の実行中にエラーが発生しました',
	'ERR_WRONG_PATH_TO_PHPBB'			=> '入力した phpBB へのパスが間違っている可能性があります',
	'EXPAND_VIEW'						=> '展開ビュー',
	'EXTENSION'							=> '拡張子',
	'EXTENSION_DISABLED_AFTER_POSTING'	=> '拡張子 <strong>%s</strong> が無効化されているため、表示できません',
	...
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'このサイトへ接続する際に必要なFTPサーバのドメインです。ほとんどのケースではこのサイトのドメインで問題ありません。',
	...
	'FTP_FSOCK_TIMEOUT_EXPLAIN'		=> 'FTP サーバからのリスポンスを待つ最大秒数です。この秒数が過ぎてもFTPサーバから返答がない場合、FTPサーバとの接続は切断されます。',
	'FTP_FSOCK_USERNAME'			=> 'FTP ユーザー名',
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'FTP サーバへ接続するためのユーザー名です',

	'FTP_HOST'					=> 'FTP ホスト名',
	'FTP_HOST_EXPLAIN'			=> 'このサイトへ接続する際に必要なFTPサーバのドメインです。ほとんどのケースではこのサイトのドメインで問題ありません。',
	...
	'FTP_TIMEOUT_EXPLAIN'		=> 'FTP サーバからのリスポンスを待つ最大秒数です。この秒数が過ぎてもFTPサーバから返答がない場合、FTPサーバとの接続は切断されます。',
	...
	'GROUP_ERR_USER_LONG'		=> '入力したグループ名は長すぎます。グループ名は６０字以内である必要があります。',
	'GUEST'						=> 'ゲスト',
	...
	'INVALID_EMAIL_LOG'			=> 'メールアドレス <strong>%s</strong> は正しくない可能性があります',
	'IP'						=> 'IPアドレス',
	'IP_BLACKLISTED'			=> 'あなたのIPアドレス %1$s はブラックリストに登録されているためアクセスが禁止されています。 詳細を見るには次のリンクをクリックしてください。',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> '不正プログラムによるログインを防ぐため、一定回数ログインに失敗すると認証コードの入力が要求されます。画像認証コードが下に表示されているはずです。画像が表示されない、もしくは視覚的に問題がある場合は%s管理人%sに連絡してください。',
	'LOGIN_ERROR_ATTEMPTS'				=> '不正プログラムによるログインを防ぐため、一定回数ログインに失敗したユーザーに対して認証コードの入力を要求しています。ログインするにはユーザー名とパスワードだけでなく、画像に表示されている認証コードも入力してください。',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'ApacheによるHTTP認証に失敗しました',
	...
	'NOT_AUTHORISED'			=> 'あなたはこのエリアへアクセスする事はできません',
	'NOT_WATCHING_FORUM'		=> 'フォーラムの監視を解除しました',
	'NOT_WATCHING_TOPIC'		=> 'トピックの監視を解除しました',
	'NOTIFY_ADMIN'				=> '管理人かウェブマスターに連絡してください',
	'NOTIFY_ADMIN_EMAIL'		=> '管理人かウェブマスターに連絡してください: <a href="mailto:%1$s">%1$s</a>',
	...
	'NO_CONNECT_TO_SMTP_HOST'	=> 'SMTPサーバへ接続できませんでした: %1$s : %2$s',
	'NO_BIRTHDAYS'				=> '',
	...
	'NO_IPS_DEFINED'			=> '追加された IP アドレスまたはホスト名はありません',
	...
	'NO_UPLOAD_FORM_FOUND'		=> 'アップロードのフォーム情報が正しくないため、ファイルをアップロードできませんでした',
	...
	'PASSWORD'				=> 'パスワード',
	'PLAY_QUICKTIME_FILE'	=> 'Quicktime ファイルを再生する',
	'PM'					=> 'PM',
	...
	'POST_BY_AUTHOR'		=> 'by',
	'POST_BY_FOE'			=> 'この記事はブロックユーザー <strong>%1$s</strong> が投稿しました。%2$sこの記事を表示する%3$s',
	...
	'RESEND_ACTIVATION'			=> 'アカウント有効化メールの再送信',
	'RESET'						=> 'リセット',
	...
	'SIGNATURE'					=> 'サイン',
	'SKIP'						=> 'コンテンツへ',
	'SMTP_NO_AUTH_SUPPORT'		=> 'SMTPサーバが認証をサポートしていません',
	...
	'SQL_ERROR_OCCURRED'		=> 'SQLエラーが発生したため、ページ情報をデータベースから取得できませんでした。問題が解決しない場合は%s管理人%sに連絡してください。',
	'STATISTICS'				=> '統計データ',
	...
	'TOO_LONG_YIM'					=> '入力した Yahoo! メッセンジャ が長すぎます',
	...
	'TOO_SHORT_YIM'					=> '入力した Yahoo! メッセンジャ が短すぎます',
	...
	'URL_REDIRECT'			=> 'ブラウザがページリダイレクトのMETAタグをサポートしていない場合、%sこちらをクリック%sしてください',
	'USERGROUPS'			=> 'グループ',
	'USERNAME'				=> 'ユーザー名',
	'USERNAMES'				=> 'ユーザー名',
	'USER_AVATAR'			=> 'アバター',
	...
	'WRONG_DATA_WEBSITE'		=> 'ウェブサイトのアドレスはプロトコルまで含めた正しいURLである必要があります（例: http://www.example.com/ ）.',
	'WROTE'						=> 'さんが書きました',
	...
	'default_dateformat'	=> 'Y年M月d日(D) H:i', // 2007年1月01日(月) 1:37 pm
));
