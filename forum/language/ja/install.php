...
$lang = array_merge($lang, array(
	...
	'ADMIN_PASSWORD_EXPLAIN'	=> 'パスワードは ６ 字から ３０ 字の長さにしてください',
	'ADMIN_TEST'				=> '管理人設定のチェック',
	'ADMIN_USERNAME'			=> '管理人のユーザー名',
	'ADMIN_USERNAME_EXPLAIN'	=> 'ユーザー名は ３ 字から ２０ 字の長さにしてください',
	...
	'BLANK_PREFIX_FOUND'			=> 'データベース内のphpBB2テーブルをスキャンしたところ、phpBB2テーブルの接頭語が見当たりませんでした',
	'BOARD_NOT_INSTALLED'			=> 'phpBB3 がインストールされていません（ファイル config.php が存在しないか内容に欠陥があります）',
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'phpBB 統合コンバータフレームワークを使用するには phpBB3 を先にインストールしておく必要があります。今まで利用していた掲示板システムのデータを phpBB3 へコンバートするには、先に<a href="%s"> phpBB3 のインストール</a>を完了してください。',
	...
	'COLLIDING_USERNAMES_FOUND'	=> '旧掲示板システムのデータ内に、データコンバートすると（データをクリーニングすると）衝突してしまうユーザー名が存在します。データコンバートする前にそれら衝突するユーザーを削除するかリネームしてユーザー名が衝突しないようにしてください。',
	...
	'CONFIG_PHPBB_EMPTY'		=> 'phpBB3 のコンフィグ変数 “%s” が空白のままです',
	'CONFIG_RETRY'				=> '再実行',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'あなたが使用していた旧掲示板システムのデータは新掲示板 phpBB 3.0 へコンバートされました。新掲示板にログインするには<a href="../">こちら</a>をクリックしてください。旧掲示板システムの基本設定が新掲示板にきちんと移転・反映されているかを確かめてください。もし問題がなければ、install ディレクトリを削除することによって一般ユーザーが新掲示板サイトにアクセスできるようになります。',
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> '旧掲示板システムで FTP アップロードが許可されています。旧掲示板システムの FTP アップロードオプションを無効に設定してください。もし FTP サーバと phpBB3 がインストールされているウェブサーバが同一でない場合、アップロードディレクトリをウェブサーバ上のディレクトリに指定し直してください。そしてFTPサーバに置かれている全アップロードファイルをそのディレクトリにコピーしてください。コピーが完了し次第、データコンバートを再開してください。',
	'CONV_ERROR_CONFIG_EMPTY'			=> 'データコンバート可能なコンフィグ情報はありません',
	'CONV_ERROR_FORUM_ACCESS'			=> 'フォーラムのアクセス情報を取得できませんでした',
	'CONV_ERROR_GET_CATEGORIES'			=> 'カテゴリ情報を取得できませんでした',
	'CONV_ERROR_GET_CONFIG'				=> '旧掲示板システムの環境設定情報を取得できませんでした',
	...
	'CONV_ERROR_PERM_SETTING'			=> 'パーミッション設定を追加/更新できませんでした',
	'CONV_ERROR_PM_COUNT'				=> 'Unable to select folder pm count.',
	'CONV_ERROR_REPLACE_CATEGORY'		=> '旧カテゴリを新フォーラムに置き換えて追加することができませんでした',
	'CONV_ERROR_REPLACE_FORUM'			=> '旧フォーラムを新フォーラムに置き換えて追加することができませんでした',
	'CONV_ERROR_USER_ACCESS'			=> 'ユーザーのアクセス権情報を取得できませんでした',
	'CONV_ERROR_WRONG_GROUP'			=> '不正なグループ “%1$s” が %2$s で定義されています',
	'CONV_OPTIONS_BODY'					=> 'フォームに既に入力されている情報はこの phpBB3（以下 “新掲示板”） のデータベース情報です。もし新掲示板のデータベースと旧掲示板システムのデータベースが異なる場合、入力されている情報を旧掲示板システムのデータベース情報に変更してください。コンバータはここで指定されたデータベース内のテーブルと格納データを一切変更しません。コンバータが途中で中断されないよう、旧掲示板を使用不可にしておくべきです。',
	...
	'DEFAULT_PREFIX_IS'			=> '指定したデータベース内に指定した接頭語をもつテーブルを見つけられませんでした。旧掲示板システムのデータベース情報が正確に入力されているかどうかを確認してください。旧掲示板システム %1$s におけるデフォルト接頭語は <strong>%2$s</strong> です。',
	...
	'DL_CONFIG_EXPLAIN'			=> 'コンフィグファイル config.php をご自分のPCにダウンロードできます。ダウンロードしたファイルは phpBB3 ルートディレクトリに上書きアップロードされる必要があります。アップロードする時、アスキーモードでアップロードしてください（やり方がわからない場合、お使いのFTPアプリケーションのドキュメントを参照してください）。アップロードが完了したら “完了” ボタンをクリックして次のステップへ進んでください。',
	'DL_DOWNLOAD'				=> 'ダウンロード',
	'DONE'						=> '完了',
	...
	'FILES_OPTIONAL_EXPLAIN'	=> '<strong>オプション</strong> - これらのファイルとディレクトリの存在と、それらに対する書き込み権は必ずしも必要というわけではありません。インストールシステムはこれらの条件を満たさない場合でも機能するように設計されています。しかしこれらの条件を満たしている方がインストールは早く終わるでしょう。',
	...
	'FORUM_ADDRESS_EXPLAIN'		=> '旧掲示板システムのURLです。例: <samp>http://www.example.com/phpBB2/</samp>。アドレスが入力された場合、旧掲示板システムの記事、プライベートメッセージ、サイン内でこのアドレスが使用されている箇所はデータコンバートされた際に全て新掲示板のアドレスに置き換えられます。',
	'FORUM_PATH'				=> '旧掲示板へのパス',
	'FORUM_PATH_EXPLAIN'		=> '<strong>phpBB3 ルートディレクトリ</strong>から旧掲示板システムへの<strong>相対</strong>パスです。',
	'FOUND'						=> '見つかりました',
	'FTP_CONFIG'				=> 'FTP でコンフィグファイルを転送する',
	'FTP_CONFIG_EXPLAIN'		=> 'FTP 拡張モジュールを検出しました。もしお望みなら PHP の FTP 拡張モジュール関数を使って config.php をサーバへアップロードできます。その場合、下のフォームに FTP 情報を入力する必要があります。ユーザー名とパスワードはサーバのアカウント情報であることに注意してください（分からない場合はサーバ管理者に問い合わせてください）。',
	'FTP_PATH'					=> 'FTP パス',
	'FTP_PATH_EXPLAIN'			=> 'あなたのサーバスペースのルートディレクトリからの phpBB3 へのパスです。例: <samp>htdocs/phpBB3/</samp>.',
	'FTP_UPLOAD'				=> 'アップロード',

	'GPL'						=> 'GPL (General Public License)',

	'INITIAL_CONFIG'			=> '基本設定',
	'INITIAL_CONFIG_EXPLAIN'	=> 'このサーバで phpBB が動作するということが判明したので、動作に必要な情報をいくつか入力する必要があります。もしデータベースに接続するための情報が分からない場合、まず最初にサーバ管理者に問い合わせてください。それでも解決しない場合、phpBB サポートフォーラムを利用してください。データの入力が完了したら、入力したデータが正確であることを確認してから次のステップへ進んでください。',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<h2>今まで使っていた掲示板システムから phpBB へデータコンバートする</h2>
		<p>phpBB統合コンバータフレームワークは phpBB 2.0.x または他の掲示板システムから phpBB3 へのデータコンバートを統合的にサポートします。あなたの旧掲示板システムのデータを phpBB3 へデータコンバートするには、<a href="%2$s">コンバータ選択ページ</a>をクリックしてください。</p>
		<h2>phpBB3 を今すぐ使用します！</h2>
		<p>下のボタンをクリックすれば Administration Control Panel (AdminCP) へ入室できます。そこで phpBB3 がどのような機能を備えているか確認すると良いでしょう。<a href="http://www.phpbb.com/support/documentation/3.0/">Documentation</a> と <a href="http://www.phpbb.com/community/viewforum.php?f=46">support forums</a> にヘルプ情報が載っています。さらに詳細な情報が必要な時は <a href="%3$s">README</a> を参照してください。</p><p><strong>install ディレクトリを削除すれば一般ユーザーがこの掲示板サイトにアクセスできるようになります。install ディレクトリがそのままの状態で存在している間は AdminCP ページのみしかアクセスすることはできません。</strong></p>',
	'INSTALL_INTRO'				=> 'phpBB3 のインストールへようこそ',
 
	'INSTALL_INTRO_BODY'		=> 'ここでは phpBB3 のインストールを行うことができます。</p><p>インストールするにはデータベースへ接続するための情報が必要です。もしデータベースへ接続するための情報が分からない場合、サーバ管理者に問い合わせてください。データベースに接続できないとインストールを先へ進めることはできません。必要な情報は次の通りです:</p>
	...
	<ul>
		...
		<li>SQLite 2.8.2+</li>
		<li>Firebird 2.0+</li>
		<li>MS SQL Server 2000 以上 （直接またはODBC経由）</li>
		<li>Oracle</li>
	</ul>
	...
	'INSTALL_NEXT_PASS'			=> '全てのテストがパスしたので次のステージへ進んでかまいません。インストール後にもしファイルのアクセス権を変更したりPHP拡張モジュールを変更したりして再テストしたいと思った場合、いつでもできます。',
	...
	'INST_ERR_DB_NO_MYSQLI'		=> 'サーバにインストールされているMySQLのバージョンはあなたが選択したオプション “MySQL with MySQLi Extension” に当てはまりません。かわりにオプション “MySQL” を選択してください。',
	'INST_ERR_DB_NO_SQLITE'		=> 'インストールされているSQLiteのバージョンが古すぎます。少なくとも 2.8.2 以上にアップグレードしてください。',
	'INST_ERR_DB_NO_ORACLE'		=> 'サーバにインストールされているOracleのバージョンでは <var>NLS_CHARACTERSET</var> パラメータを <var>UTF8</var> に設定しておく必要があります。パラメータを変更するかバージョンを 9.2+ にアップグレードしてください。',
	'INST_ERR_DB_NO_FIREBIRD'	=> 'サーバにインストールされているFirebirdのバージョンが古すぎます。少なくとも 2.0 以上にアップグレードしてください。',
	'INST_ERR_DB_NO_FIREBIRD_PS'=> 'Firebirdデータベースのページサイズが 8192 より小さいです。少なくとも 8192 以上である必要があります。',
	'INST_ERR_DB_NO_POSTGRES'	=> '選択したデータベースは文字コード <var>UNICODE</var> または <var>UTF8</var> で作成されていません。文字コードを <var>UNICODE</var> か <var>UTF8</var> にしてデータベースを再度作成してください。',
	'INST_ERR_DB_NO_NAME'		=> 'データベースの名前が入力されていません',
	'INST_ERR_EMAIL_INVALID'	=> '入力したメールアドレスが正しくありません',
	'INST_ERR_EMAIL_MISMATCH'	=> '入力したメールアドレスが不一致です',
	'INST_ERR_FATAL'			=> '致命的なインストールエラー',
	'INST_ERR_FATAL_DB'			=> '致命的かつ復元不可能なデータベースエラーが発生しました。これはおそらく指定したユーザーには <code>CREATE TABLES</code> または <code>INSERT</code> などのSQL命令の実行権限が与えられていないためと考えられます。詳細は下記をご覧ください。まず最初にサーバ管理者にこの事を問い合わせてください。それでも解決しない場合、phpBBサポートフォーラムを利用してください。',
	'INST_ERR_FTP_PATH'			=> '入力したパスのディレクトリへカレントディレクトリを移動できませんでした。入力したパスが正確かどうか確認してください。',
	'INST_ERR_FTP_LOGIN'		=> 'FTPサーバにログインできませんでした。ユーザー名とパスワードが正しいか確認してください。',
	'INST_ERR_MISSING_DATA'		=> 'このブロックのフィールドは全て入力する必要があります',
	'INST_ERR_NO_DB'			=> '選択したデータベースを取り扱うためのPHP拡張モジュールの読み込みに失敗しました',
	'INST_ERR_PASSWORD_MISMATCH'	=> '入力したパスワードが不一致です',
	'INST_ERR_PASSWORD_TOO_LONG'	=> '入力したパスワードが長すぎます。３０ 字以下にしてください。',
	'INST_ERR_PASSWORD_TOO_SHORT'	=> '入力したパスワードが短すぎます。６ 字以上にしてください。',
	'INST_ERR_PREFIX'			=> '入力した接頭語を持つテーブルが既にデータベース内に存在します。接頭語を変更してください。',
	'INST_ERR_PREFIX_INVALID'	=> '入力したテーブル接頭語に不正な文字が含まれています。ハイフンやコンマなどの文字を使用しないでください。',
	'INST_ERR_PREFIX_TOO_LONG'	=> '入力したテーブル接頭語が長すぎます。%d 字以下にしてください。',
	'INST_ERR_USER_TOO_LONG'	=> '入力したユーザー名が長すぎます。２０ 字以下にしてください。',
	'INST_ERR_USER_TOO_SHORT'	=> '入力したユーザー名が短すぎます。３ 字以上にしてください。',
	...
	'MBSTRING_CHECK_EXPLAIN'				=> '<strong>必須</strong> - <samp>mbstring</samp> はマルチバイト文字を扱うための PHP 拡張モジュールです。mbstring 設定オプションのいくつかは phpBB3 と相性が良くないため、それらのオプションを無効にしておく必要があります。もし下のチェックのどれかが “いいえ” になっている場合、phpBB3 ルートディレクトリ直下のファイル .htaccess に下記コードを追加することで解決することがあります（ウェブサーバが Apache である場合に限ります）。<br />
<var>
--- コード ---<br />
...
-------------
	...
	'MAKE_FOLDER_WRITABLE'		=> 'このフォルダの存在と、アクセス権が書き込み可である事を確認した後、もう一度試してみてください:<br />≫<strong>%s</strong>.',
	'MAKE_FOLDERS_WRITABLE'		=> 'これらのフォルダの存在と、アクセス権が書き込み可である事を確認した後、もう一度試してみてください:<br />≫<strong>%s</strong>.',

	'NAMING_CONFLICT'			=> 'ユーザー名の衝突: %s と %s は同じユーザー名です<br /><br />%s',
	'NEXT_STEP'					=> '次のステップへ',
	'NOT_FOUND'					=> '見つかりません',
	'NOT_UNDERSTAND'			=> 'Could not understand %s #%d, table %s ( “%s” )',
	'NO_CONVERTORS'				=> 'ご利用できるコンバータはありません',
	...
	'OVERVIEW_BODY'				=> 'phpBB3 へようこそ！<br /><br />phpBB™ は世界で最も広く使用されているインターネット掲示板ソフトウェアです。phpBB3 は2000年から現在に至るまでのパッケージラインナップの中で最新バージョンのパッケージです。かつての phpBB2 と同様、phpBB3 は豊富な機能を持ち、ユーザーフレンドリーであり、phpBB Team によって完全にサポートされています。phpBB3 では phpBB2 の重要かつ基本的な機能に十分な改良が施され、さらに phpBB2 では備えていなかった全く新しい機能が追加されています。私達はこの phpBB3 があなたの期待に応えるものであることを願っています。 <br /><br />このインストールシステムは phpBB3 のインストール、最新バージョンへのアップデート、phpBB3 とは異なる掲示板システム（phpBB2 含む）からのデータコンバートを手助けします。より詳しい情報は <a href="../docs/INSTALL.html">the installation guide</a> をご覧ください。<br /><br />phpBB3 のライセンスまたはサポートに関してはサイドメニューの関連項目からご覧頂けます。インストール、アップデート、データコンバートを始めるには上のタブからオプションを選択してください。',

	'PCRE_UTF_SUPPORT'				=> 'PCRE 関数の UTF-8 文字列のサポート',
	'PCRE_UTF_SUPPORT_EXPLAIN'		=> 'もし PCRE（Perl 互換正規表現）関数が UTF-8 によるパターン文字列を取り扱えない場合、 phpBB3 は動作<strong>しません</strong>。PHP の PCRE 拡張モジュールのバージョンが古い場合、この症状が起こります。',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'		=> '<strong>必須</strong> - ここに挙げられているデータベースの内、少なくとも１つは PHP 拡張モジュールとして利用できる必要があります。もしPHPのデータベースモジュールが１つも利用できない場合、サーバ管理者にデータベースの使用を相談してください。',
	'PHP_REGISTER_GLOBALS'			=> 'PHP設定オプション <var>register_globals</var> が無効です',
	'PHP_REGISTER_GLOBALS_EXPLAIN'	=> 'この設定オプションが有効に設定されていても phpBB3 は動作するでしょう。しかしセキュリティ上の理由で、もし可能であるなら register_globals を無効にしておくことを強く勧めます。もし “いいえ” になっている場合、phpBB3 ルートディレクトリ直下のファイル .htaccess に下記コードを追加することで解決することがあります（ウェブサーバが Apache である場合に限ります）。<br />
<var>
--- コード ---<br />
...
-------------
	...
	'PHP_SETTINGS'					=> 'PHPのバージョンと設定',
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>必須</strong> - phpBB3 を使用するにはサーバにインストールされているPHPのバージョンが 4.3.3 以上である必要があります。もし <var>セーフモード</var> が下に表示されている場合、PHPのセーフモードが有効になっていることを示します。セーフモードが有効な場合、リモート操作に制限が課せられます。',
	...
	'PREPROCESS_STEP'				=> 'データコンバート前プロセス関数/クエリの遂行',
	'PRE_CONVERT_COMPLETE'			=> 'データコンバート前ステップを全て完了しました。データコンバートを開始してください。コンバート完了後、手動で調整しなければならない点がいくつかあるかもしれないことに注意してください。特にパーミッションが正しく割り当てられているかチェックしてください。必要であれば検索インデックスを再構築してください。アバターやスマイリーのような画像ファイルが正確にコピーされているかどうかも確認してください。',
	...
	'REQUIREMENTS_EXPLAIN'		=> 'ここでは、phpBB3 をサーバにインストール可能かどうか、インストール後にきちんと動作するかどうかのテスト結果が表示されています。表示されている全てのテスト結果に目を通してください。必須テストを全てパスするまでインストールを開始することはできません。phpBB3 の全機能を使用するにはオプションテストもパスしておく必要があります。',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'ここでは環境設定を変更できます。デフォルト設定と違う環境設定にする必要がある場合のみ入力・変更してください。ここで表示されている各設定が理解できなくても心配せずにそのまま次のページへ進んでください。これらの設定は後で AdminCP にて変更できます。',
	...
	'UNABLE_WRITE_LOCK'			=> 'ロックファイル（このテンポレリファイルが存在している間はインストール中であることを意味します）に書き込めませんでした',
	'UNAVAILABLE'				=> '利用できません',
	'UNWRITABLE'				=> '書き込めません',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> '差分ファイルは全てアップデートされました。<a href="../ucp.php?mode=login">掲示板にログイン</a>して動作に問題がないか確認してください。install ディレクトリを削除することを忘れないでください！',
	...
	'CHANGE_CLEAN_NAMES'			=> 'ユーザー名を同一とみなす方式に変更があります。新しい方式でユーザー名を比較した際に同一とみなされるユーザーが何人か存在します。先に進める前にこれら重複したユーザー名について、片方のユーザー名を削除かリネームしてユーザー名が重複しないようにする必要があります。',
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> '<a href="../ucp.php?mode=login">掲示板にログイン</a>して動作に問題がないか確認してください。install ディレクトリを削除することを忘れないでください！',
	...
	'DATABASE_UPDATE_INFO_OLD'			=> 'install ディレクトリ内のデータベースアップデートファイルのバージョンが最新ではありません。アップロードしたファイルのバージョンが最新かどうか確認してください。',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'ここでは修正ファイルをダウンロードできます。圧縮形式を選択して修正ファイルをダウンロードしてください。ダウンロード後、解凍して出てきたファイルを phpBB3 ルートディレクトリへアップロードしてください。修正ファイルを全てアップロードし終わったら “ファイル再チェック” をクリックしてアップデートが完了したかを確認してください。',
	...
	'FILES_CONFLICT_EXPLAIN'		=> '次のファイルは旧バージョンのオリジナルファイルを修正したファイルです。これらのファイルは修正部分がアップデート部分と衝突しています。アップデートするには衝突部分を自分で調べて手動で衝突部分を取り除くか、表示されているオプションの中からアップデート方法を選択してください。手動で衝突部分を取り除いた場合、 “ファイル再チェック” をクリックして衝突部分が本当に取り除かれているか確認してください。アップデート方法のオプションは各ファイル毎に選ぶことができます。修正部分とアップデート部分をマージ（共存・統合）する場合、１番目のオプションでは衝突部分にアップデートコードが使用され修正コードは破棄されます。２番目のオプションでは衝突部分に修正コードが使用されアップデートコードは破棄されます。',
	'FILES_MODIFIED'				=> '修正ファイル',
	'FILES_MODIFIED_EXPLAIN'		=> '次のファイルは旧バージョンのオリジナルファイルを修正したファイルです。修正部分とアップデート部分のマージ（共存・統合）が可能です。',
	'FILES_NEW'						=> '新しいファイル',
	'FILES_NEW_EXPLAIN'				=> '次のファイルはこのアップデートで新しく追加されたファイルです。これらのファイルはお使いの phpBB3 に新しく追加されます。',
	'FILES_NEW_CONFLICT'			=> '新しいファイル [ 衝突 ]',
	'FILES_NEW_CONFLICT_EXPLAIN'	=> '次のファイルはこのアップデートで新しく追加されたファイルです。しかしこの追加ファイルと同じ位置、同じファイル名のファイルがお使いの phpBB3 に既に存在しています。アップデートファイルをアップロードするとこのファイルは上書きされます。',
	'FILES_NOT_MODIFIED'			=> 'オリジナルファイル',
	'FILES_NOT_MODIFIED_EXPLAIN'	=> '次のファイルは旧バージョンのオリジナルファイルです。修正は一切されていません。',
	'FILES_UP_TO_DATE'				=> 'アップデート済みファイル',
	'FILES_UP_TO_DATE_EXPLAIN'		=> '次のファイルは既にアップデートが完了しているため、アップデートファイルをアップロードする必要はありません。',
	'FTP_SETTINGS'					=> 'FTP設定',
	...
	'NO_ERRORS'						=> 'エラーなし',
	'NO_UPDATE_FILES'				=> '次のファイルをアップデートしていません',
	'NO_UPDATE_FILES_EXPLAIN'		=> '次のファイルはアップデートファイルですが、アップロード先のディレクトリが見つからなかったためアップロードできませんでした。もしこのリストに language/ や styles/ 以外のディレクトリ下のファイルが含まれている場合、phpBB3 のディレクトリ構造が変更されている可能性があります。',
	'NO_UPDATE_FILES_OUTDATED'		=> 'アップデートパッケージが見つかりませんでした。アップデートパッケージをサーバにアップロードしたかを確認してください。<br /><br />この phpBB3 は最新バージョンにアップデートされて<strong>いません</strong>。現在、このphpBB %1$s を最新バージョンにアップデートするためのアップデートパッケージを利用できます。<a href="http://www.phpbb.com/downloads/" rel="external">http://www.phpbb.com/downloads/</a> に訪れてアップデートパッケージ(phpBB-%2$s_to_%3$s)をダウンロードしてください。',
	'NO_UPDATE_FILES_UP_TO_DATE'	=> 'この phpBB3 のバージョンは最新バージョンです。このアップデートツールを実行する必要はありません。',
	...
	'OLD_UPDATE_FILES'		=> 'アップデートファイルが最新ではありません。このアップデートファイルだとphpBB %1$s から phpBB %2$s にアップデートできますが、現在の phpBB3 の最新バージョンは %3$s です。',

	'PACKAGE_UPDATES_TO'				=> 'このパッケージによるアップデート後のバージョン',
	'PERFORM_DATABASE_UPDATE'			=> 'データベースアップデート',
	'PERFORM_DATABASE_UPDATE_EXPLAIN'	=> '下のボタンをクリックするとデータベースアップデートスクリプトが開始されます。データベースのアップデートにはしばらく時間がかかります。アップデートが完了するまで決してページ移動しないでください。アップデートの完了後、次のアップデートプロセスへ移行してください。',
	...
	'SQL'						=> 'SQL',
	'SQL_FAILURE_EXPLAIN'		=> 'この失敗はおそらく心配するほどのことではありません。アップデートはうまくいくでしょう。この失敗に関して理解したいなら公式サポートフォーラムで質問してかまいません。公式サポートフォーラムでアドバイスを得る方法に関しては <a href="../docs/README.html">README</a> をご覧ください。',
	...
	'TOGGLE_DISPLAY'			=> 'ファイルリストを 表示する/隠す',
	...
	'UPDATE_INSTRUCTIONS_INCOMPLETE'	=> '
		...
		<p>未完了状態の自動アップデートを検出しました。自動アップデートの各ステップの指示にきちんと従っていたかを確認してください。下のリンクをクリックすれば未完了の自動アップデートを続行することが可能です。</p>
	',
	'UPDATE_METHOD'					=> 'アップデート方法',
	'UPDATE_METHOD_EXPLAIN'			=> 'アップデート方法を選択できます。FTP アップロードを使用するには FTP サーバへのログイン情報が必要です。FTP アップロードを選択した場合、ファイルは自動的にアップロードされバックアップファイル .bak も自動的に作成されます。アップデートパッケージのダウンロードを選択した場合、ダウンロードパッケージ内のアップデートファイルをご自分で phpBB3 ディレクトリ下の正しい位置にアップロードする必要があります。',
