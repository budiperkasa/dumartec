...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'このユーザーへのフィードバック（あなたの意見、評価）を以下に書き込んでください。プレーンテキストのみ使用してください。HTML、BBCodeなどは使用できません。フィードバックはユーザーログに追加され、他の Admin またはモデレータも同様に参照できます。',
	'ADD_WARNING'			=> '警告の追加',
	'ADD_WARNING_EXPLAIN'	=> 'このユーザーに警告を追加するには以下のフォームに内容を書き込んでください。 プレーンテキストのみ使用してください。 HTML、BBCodeなどは使用できません。チェックボックス “この警告をユーザーに通知する” をチェックして送信した場合、警告はプライベートメッセージとしてユーザーに送信されます。',
	'ALL_ENTRIES'			=> 'すべて',
	...
	'EMPTY_TOPICS_REMOVED_WARNING'	=> '記事がなくなったトピックはデータベースから削除されていることに注意してください',
	...
	'IP_INFO'				=> 'IPアドレス情報',
	'IPS_POSTED_FROM'		=> 'このユーザーが投稿した時のIPアドレス',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'ここでは選択した記事を他のトピックに統合できます。選択された記事は新しい返信記事として統合先トピックへそのまま追加されます。<br />統合先トピックのIDナンバーを入力するか、 “トピック選択” をクリックして統合先トピックを検索してください。',
	'MERGE_TOPIC_ID'		=> '統合先トピックのIDナンバー',
	...
	'OTHER_USERS'			=> 'このIPアドレスから投稿した他のユーザー',
	...
	'YOU_SELECTED_TOPIC'	=> '選択したトピックのID %d: %s',
