...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_EXPLAIN'	=> 'Hier kan je het bannen van gebruikers per naam, IP of e-mailadres beheren. Deze methode zorgt ervoor dat de gebruiker het forum niet meer te zien krijgt. Je kunt een korte reden (maximaal 3000 tekens) voor de ban opgeven, deze wordt weergegeven in de beheerderslog. Ook de duur van de ban kan aangegeven worden, als je de ban wilt laten eindigen op een bepaalde datum die niet als tijdsperiode is ingesteld selecteer dan <u>Tot -></u> voor de lengte van de ban en voer een datum in in het formaat JJJJ-MM-DD.',
	...
	'EMAIL_UNBAN_EXPLAIN'		=> 'Als je meerdere e-mailadressen in één keer niet meer wilt verbannen (of niet meer wilt uitsluiten), kan je dit doen door gebruik te maken van de combinatie muis en toetsenbord. Uitgesloten e-mailadressen zijn benadrukt.',
	...
	'IP_UNBAN_EXPLAIN'			=> 'Als je meerdere IP-adressen in één keer niet meer wilt verbannen (of niet meer wilt uitsluiten), kan je dit doen door gebruik te maken van de combinatie muis en toetsenbord. Uitgesloten IP-adressen zijn benadrukt.',
	...
	'USER_UNBAN_EXPLAIN'		=> 'Als je meerdere gebruikersnamen in één keer niet meer wilt verbannen (of niet meer wilt uitsluiten), kan je dit doen door gebruik te maken van de combinatie muis en toetsenbord. Uitgesloten gebruikersnamen zijn benadrukt.',
));
?>