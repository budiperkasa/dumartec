...
$lang = array_merge($lang, array(
	'ACP_BOARD_SETTINGS_EXPLAIN'	=> 'Hier kan je de basiswerking van het forum instellen, een passende naam en omschrijving kiezen, de standaard tijdszone, taal en andere zaken wijzigen.',
...
$lang = array_merge($lang, array(
	...
	'BOARD_PM_EXPLAIN'			=> 'Aan- of uitzetten van privéberichten voor alle gebruikers.',
));

// Avatar Settings
$lang = array_merge($lang, array(
	'ACP_AVATAR_SETTINGS_EXPLAIN'	=> 'Avatars zijn normaal gesproken kleine, unieke afbeeldingen die een gebruiker kan associëren met zichzelf. Ze worden normaal gesproken onder de gebruikersnaam weergegeven, afhankelijk van de stijl die ze gebruiken. Hier kan je vaststellen hoe gebruikers hun avatars bepalen. Let wel dat om avatars te kunnen uploaden je wel de map moet hebben gemaakt met de naam die je hieronder hebt opgegeven en dat ernaar geschreven kan worden. Let ook dat de bestandsgrootte alleen van toepassing is op geüploade avatars, niet op gelinkte afbeeldingen.',
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Het pad onder je phpBB-rootmap voor voorgeïnstalleerde afbeeldingen, vb: <samp>images/avatars/gallery</samp>.',
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Voor geüploade avatarbestanden.',
...
// Message Settings
$lang = array_merge($lang, array(
	'ACP_MESSAGE_SETTINGS_EXPLAIN'	=> 'Hier kan je alle standaard instellingen voor je privéberichten instellen.',

	'ALLOW_BBCODE_PM'			=> 'BBCode toestaan in privéberichten',
	'ALLOW_FLASH_PM'			=> 'Het gebruik van de <code>[FLASH]</code> BBCode toestaan',
	'ALLOW_FLASH_PM_EXPLAIN'	=> 'Bedenk wel dat de mogelijkheid om Flash te gebruiken in privé berichten na inschakeling ook afhangt van de permissies.',
	...
	'ALLOW_MASS_PM_EXPLAIN'		=> 'Het verzenden naar groepen kan per groep worden aangepast in de groepsinstellingen pagina.',
	'ALLOW_PRINT_PM'			=> 'Afdrukvoorbeelden in privéberichten toestaan',
	...
	'BOXES_LIMIT'				=> 'Maximum aantal privéberichten per box',
	'BOXES_LIMIT_EXPLAIN'		=> 'Gebruikers kunnen niet meer dan dit aantal berichten ontvangen in elk van hun persoonlijk bericht boxen. Zet deze waarde op 0 om oneindig aantal berichten toe te staan.',
	'BOXES_MAX'					=> 'Maximum aantal privéberichten mappen',
	'BOXES_MAX_EXPLAIN'			=> 'Als standaard kunnen gebruikers dit aantal mappen aanmaken voor hun privéberichten.',
	'ENABLE_PM_ICONS'			=> 'Het gebruik van onderwerpicoontjes in privéberichten toestaan',
	...
	'PM_MAX_RECIPIENTS_EXPLAIN'	=> 'De maximale aantal toegestane ontvangers in een privébericht. Als 0 is ingevoerd is er een oneindig aantal toegestaan. Deze instelling kan worden aangepast voor elke groep in de groepsinstellingen pagina.',
));
...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER'			=> 'Schakel berichtenwachtrij in.',
	'ENABLE_QUEUE_TRIGGER_EXPLAIN'	=> 'Mogelijkheid om geregistreerde gebruikers hun berichten op de moderatiewachtrij te zetten als hun aantal berichten lager is dan de gespecificeerde hoeveelheid hieronder. De instelling heeft geen effect op de permissie instellingen betreffende de post/topic wachtrij.',
	'QUEUE_TRIGGER_POSTS'			=> 'Maximaal aantal berichten voor de berichtenwachtrij',
	'QUEUE_TRIGGER_POSTS_EXPLAIN'	=> 'Als berichtenwachtrij is ingeschakeld komen de tot de hieronder gespecificeerde berichten op de moderatie-wachtrij. Als het aantal berichten van de gebruikers onder dit getal zit, worden de berichten automatisch in de wachtrij gezet.',
	...
	'FLOOD_INTERVAL_EXPLAIN'		=> 'Aantal seconden dat gebruikers dienen te wachten tussen het plaatsen van berichten. Om dit voor bepaalde gebruikers te omzeilen dienen je permissie aan te passen.',
...
$lang = array_merge($lang, array(
	...
	'USERNAME_CHARS'				=> 'Beperk aantal karakters gebruikersnaam',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'	=> 'Hier kan je de visuele-bevestiging standaarden en CAPTCHA-instellingen opgeven.',
...
$lang = array_merge($lang, array(
	...
	'LIMIT_SESSIONS_EXPLAIN'		=> 'Als het aantal sessies gedurende één minuut boven deze waarde komt, zal het forum offline gaan. Stel in op 0 voor onbeperkt aantal sessies.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> 'Gegenereerde inhoud zal eerst gecomprimeerd worden voor deze verzonden wordt. Dit verkleint het netwerkverkeer, maar zal het CPU-gebruik van zowel de server als de cliënt verhogen.',
...
$lang = array_merge($lang, array(
	...
	'IP_VALID_EXPLAIN'				=> 'Bepaald hoeveel van de gebruiker zijn IP gebruikt wordt om een sessie te valideren; <samp>alle</samp> vergelijkt het volledige adres, <samp>A.B.C</samp> de eerste x.x.x, <samp>A.B</samp> de eerst x.x, <samp>geen</samp> schakelt de controle uit. Bij een IPv6 adres vergelijkt <samp>A.B.C</samp> de eerste 4 stukken en <samp>A.B</samp> de eerste 3 stukken.',
	...
	'REFERER_VALID_EXPLAIN'			=> 'Indien ingeschakeld zal de verwijzing of het POST verzoek gecontroleerd worden op de host/script pad instellingen. Dit kan problemen veroorzaken bij het gebruik van meerdere domeinnamen en externe inlogs.',
...
$lang = array_merge($lang, array(
	...
	'BOARD_HIDE_EMAILS_EXPLAIN'		=> 'Deze functie houdt e-mailadressen compleet privé.',
	...
	'EMAIL_PACKAGE_SIZE_EXPLAIN'	=> 'Dit is het aantal e-mails die worden verzonden in één pakket.',
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Specificeer een geregistreerde username of een geldig JID. De gebruikersnaam wordt niet gecontroleerd op geldigheid. Als je alleen een gebruikersnaam specificeert, zal je JID je gebruikersnaam en de server zijn die je hierboven hebt gespecificeerd. Anders moet je een geldige JID invullen, bijvoorbeeld gebruiker@jabber.org',
));
?>