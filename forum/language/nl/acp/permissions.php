...
$lang = array_merge($lang, array(
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Hier kan je globale permissies toewijzen aan gebruikers - gebruikers permissies, globale moderator permissies en beheerder permissies. Gebruikers permissies hebben de mogelijkheden als het gebruik van avatars, privéberichten versturen, et cetera; globale moderator permissies zoals goedkeuren van berichten, beheren van onderwerpen, beheren bans, et cetera en tenslotte beheerder permissies zoals het toepassen permissies, aangepaste BBCodes, beheren van forums, et cetera. Persoonlijke gebruiker permissies zouden enkel in sommige gevallen veranderd moeten worden, de aangeraden methode is gebruikers in groepen en die groepen de permissies toewijzen.',
	...
	'ROLE_DESCRIPTION_ADMIN_FULL'			=> 'Heeft toegang tot alle beheerders functies op dit forum.<br />Niet aan te raden.',
	'ROLE_DESCRIPTION_ADMIN_STANDARD'		=> 'Heeft toegang tot de meeste beheerders functies maar niet tot server of systeem gerelateerde instellingen.',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Kan alle forum functies gebruiken, inclusief het plaatsen van mededelingen en stickies. Kan ook de vloedlimiet negeren.<br />Niet aan te raden voor gewone gebruikers.',
	...
	'ROLE_DESCRIPTION_USER_STANDARD'		=> 'Heeft toegang tot de meeste maar niet alle gebruikersfuncties. Kan gebruikersnaam wijzigen of de vloedlimiet negeren, bijvoorbeeld.',
