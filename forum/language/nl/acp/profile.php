...
$lang = array_merge($lang, array(
	...
	'CUSTOM_FIELDS_NOT_TRANSLATED'	=> 'Ten minste één profielveld is nog niet vertaald. Vul de benodigde info in door te klikken op de "vertaal" link.',
	...
	'DISPLAY_AT_REGISTER'			=> 'Geef weer op het registratiescherm',
	...
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'De profielvelden zullen worden getoond op alle locaties aangegeven in de serverprestatie instellingen. Indien je voor "nee" koos, zal het veld van onderwerppagina\'s, profielen en de ledenlijst niet worden getoond.',
...
'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Verberg het profiel veld voor alle andere gebruiker behalve voor de gebruiker, beheerders en moderators die gewoon de mogelijkheid hebben om dit veld te zien. Wanneer de optie tonen in gebruikerspaneel is uitgeschakeld, kan de gebruiker dit veld niet meer zien of wijzigen en kan dit veld alleen nog maar aangepast worden door de beheerders.',
	...
	'REQUIRED_FIELD_EXPLAIN'	=> 'Forceer profielveld dat het word ingevuld of gespecificeerd door gebruiker of beheerder. Wanneer de getoond op registratiescherm is uitgeschakeld, zal het veld pas verplicht zijn op het moment dat de gebruiker het profiel aanpast.',
	'ROWS'						=> 'Rijen',
	...
	'STEP_2_EXPLAIN_CREATE'			=> 'Hier kan je standaardinstellingen, die je wil wijzigen, opgeven.',
	'STEP_2_EXPLAIN_EDIT'			=> 'Hier kan je enkele standaardinstellingen wijzigen.<br /><strong>Veranderingen aan profielvelden zullen geen effect hebben op bestaande profielvelden ingevuld door jouw gebruikers</strong>',
	'STEP_2_TITLE_CREATE'			=> 'Specifieke profieltype keuzes',
	'STEP_2_TITLE_EDIT'				=> 'Specifieke profieltype keuzes',
	'STEP_3_EXPLAIN_CREATE'			=> 'Vanaf je meer dan 1 taal hebt geïnstalleerd, zal je de resterende taalitems ook moeten invullen. Het profielveld zal werken met de standaardtaal, het is mogelijk om later de resterende taalitems aan te vullen.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Vanaf je meer dan 1 taal hebt geïnstalleerd, kan je nu ook de resterende taalitems toevoegen of wijzigen. Het profielveld zal werken met de standaardtaal.',
