...
$lang = array_merge($lang, array(
	...
	'COMMON_WORD_THRESHOLD_EXPLAIN'		=> 'Woorden die in een groot percentage berichten voorkomen, worden als frequent beschouwd. Deze frequente woorden worden genegeerd bij zoekopdrachten. Indien je nul opgeeft, wordt de functie uitgeschakeld. Deze functie werkt echter alleen indien er meer dan 100 berichten zijn. Wanneer je wil dat de woorden die momenteel worden gezien als frequent alsnog worden opgenomen zul je opnieuw de zoekindex moeten heropbouwen.',
	...
	'CONTINUE_DELETING_INDEX_EXPLAIN'	=> 'Het index verwijderproces is ooit gestart, om de zoekindex pagina te kunnen openen moet je dit proces eerst beëindigen of annuleren.',
	'CONTINUE_INDEXING'					=> 'Ga door met het vorige indexeringsproces',
	'CONTINUE_INDEXING_EXPLAIN'			=> 'Het indexeringsproces is ooit gestart, om de zoekindex pagina te kunnen openen moet je dit proces eerst beëindigen of annuleren.',
	...
	'LIMIT_SEARCH_LOAD_EXPLAIN'	=> 'Als de systeembelasting voor 1 minuut deze waarde overschrijdt, zal de zoekpagina offline gaan. 1.0 is gelijk aan het verbruik van ~100% van één processor. Dit werkt alleen op UNIX gebaseerde servers.',

	'MAX_SEARCH_CHARS'					=> 'Maximum aantal geïndexeerde tekens',
	'MAX_SEARCH_CHARS_EXPLAIN'			=> 'Alleen woorden met minder dan dit aantal tekens zullen geïndexeerd worden.',
	'MIN_SEARCH_CHARS'					=> 'Minimum aantal geïndexeerde tekens',
	'MIN_SEARCH_CHARS_EXPLAIN'			=> 'Alleen woorden met minimum dit aantal tekens zullen geïndexeerd worden.',
	...
	'SEARCH_GUEST_INTERVAL_EXPLAIN'	=> 'Het aantal seconden dat gasten moeten wachten voordat ze een nieuwe zoekopdracht kunnen uitvoeren. Indien één gast een zoekopdracht uitgevoerd heeft, moet ook de rest wachten tot deze tijd verstreken is.',
	'SEARCH_INDEX_CREATE_REDIRECT'	=> 'Alle berichten tot en met bericht id %1$d zijn geïndexeerd, waarvan %2$d berichten van in deze stap.<br />De huidige indexeringssnelheid is gemiddeld %3$.1f berichten per seconde.<br />Bezig met indexeren...',
