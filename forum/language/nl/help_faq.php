...
$help = array(
	...
	array(
		...
		1 => 'De meest voorkomende reden hiervoor is dat de beheerder jouw taal niet geïnstalleerd heeft, of dat nog niemand het forum in je taal vertaald heeft. Je kan altijd aan de beheerder vragen of hij het talen pakket dat jij nodig hebt wil installeren. Indien het nog niet bestaat, mag je gerust de vertaling maken. Meer informatie hieromtrent kan gevonden worden op de website van de phpBB groep (de link staat onderaan iedere pagina).'
	),
	array(
	...
	array(
		...
		1 => 'Zowel moderators als beheerders kunnen onderwerpen sluiten. Je kan niet langer antwoorden op deze berichten en als ze een poll bevatte, eindigt deze automatisch. Onderwerpen kunnen om eender welke reden gesloten worden.'
	),
	array(
	...
	array(
		...
		1 => 'Om lid van een gebruikersgroep te worden, moet je op de bijhorende link klikken in het gebruikerspaneel, waarna je een overzicht van alle gebruikersgroepen krijgt. Niet alle groepen zijn vrij toegankelijk, ze vereisen een goedkeuring van je lidmaatschap en hebben soms zelf verborgen gebruikers. Als het een open groep is, kan je lid worden door op de hiervoor dienende knop te klikken. Als het een gesloten groep is, kun je je lidmaatschap aanvragen door op de bijhorende knop te klikken. De groepsleider moet je aanvraag dan goedkeuren, hij of zij vraagt mogelijk waarom je lid wil worden. Indien je niet tot een groep toegelaten wordt, moet je de groepsleider niet lastig vallen, hij of zij heeft een reden om je te weigeren.'
	),
	array(
	...
	array(
		...
		1 => 'Je kan gebruikers blokkeren zodat ze je geen privéberichten meer kunnen sturen, dit gebeurt via het gebruikerspaneel. Als je ongepaste privéberichten ontvangt van een bepaalde gebruiker, contacteer dan de beheerder, deze kan ervoor zorgen dat hij of zij niet langer privéberichten kan sturen.'
	),
	array(
