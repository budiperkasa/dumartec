...
$lang = array_merge($lang, array(
	...
	'DL_CONFIG_EXPLAIN'			=> 'Je kan het config.php bestand naar je computer downloaden, waarna je het manueel uploadt (en het eventueel bestaande config.php bestand overschrijft) naar de phpBB 3.0 root map. Zorg er echter wel voor dat je het bestand in ASCII-formaat uploadt (als je niet weet hoe dit moet, raadpleeg dan de documentatie van je FTP-programma). Nadat je het config.php geüpload hebt, klik je op "klaar" om naar de volgende stap te gaan.',
	...
	'INSTALL_CONGRATS_EXPLAIN'		=> '
		<p>Je hebt phpBB %1$s succesvol geïnstalleerd. Vanaf hier heb je twee mogelijkheden met je nieuwe phpBB3-installatie:</p>
	...
	'NO_LOCATION'			=> 'De locatie kan niet bepaald worden. Als je zeker bent dat Imagemagick geïnstalleerd is, kan je de locatie later in het beheerderspaneel opgeven',
...
$lang = array_merge($lang, array(
	...
	'CHANGE_CLEAN_NAMES'			=> 'De methode die ervoor zorgt dat er geen dubbele gebruikersnamen ontstaan is veranderd. Er zijn enkele gebruikers die dezelfde naam zullen hebben als ze worden vergeleken met de nieuwe methode. Je moet deze gebruikers verwijderen of hernoemen om er zeker van te zijn dat elke naam wordt gebruikt door één gebruiker alvoor je verder kan gaan.',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'Huidige verschillen bij %1$d van de %2$d bestanden zijn gecontroleerd.<br />Wacht alstublieft tot alle bestanden zijn gecontroleerd.',
