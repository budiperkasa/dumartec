...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Door het betreden van "%1$s" (in wat volgt wordt hiernaar verwezen als het gaat over "wij", "ons", "onze", "%1$s" of "%2$s"), ga je automatisch akkoord met de volgende voorwaarden. Als je niet akkoord gaat met één van de voorwaarden, betreedt/gebruik "%1$s" dan niet langer. We hebben het recht om deze voorwaarden op ieder moment te wijzigen en zullen je daar zoveel mogelijk van op de hoogte houden. Het is echter aan te bevelen op regelmatige basis zelf de voorwaarden te controleren op wijzigingen. Als je niet akkoord gaat met één van de wijzigingen, maak dan niet langer gebruik van "%1$s". Als je wel gebruik blijft maken van "%1$s", ga je automatisch akkoord met de wijzigingen.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Je account is aangemaakt. Dit forum vereist echter accountactivatie door een beheerder. Een e-mail werd naar de beheerders gezonden en je wordt geïnformeerd als je account geactiveerd is',
	...
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'De avatar kon niet geüpload worden naar %s',
	'AVATAR_PAGE'					=> 'Pagina',
	...
	'FOES_EXPLAIN'					=> 'Vijanden zijn gebruikers die je standaard negeert. Berichten van die gebruikers worden niet volledig getoond, ook privéberichten van de gebruiker niet verstuurd. Let op; het is niet mogelijk om moderators of beheerders te negeren.',
	...
	'NO_EDIT_READ_MESSAGE'	=> 'Privébericht kan niet worden gewijzigd omdat hij al is gelezen.',
	...
	'NO_MESSAGE'			=> 'Het privébericht kon niet gevonden worden',
	...
	'NO_WATCHED_SELECTED'	=> 'Je hebt geen forum of topic abonnementen geselecteerd.',
	...
	'PM_DISABLED'				=> 'Privéberichten is uitgeschakeld op dit forum',
	'PM_FROM'					=> 'Van',
	...
	'UCP_REGISTER_DISABLE'					=> 'Het is momenteel niet mogelijk een nieuwe account te creëren.',
