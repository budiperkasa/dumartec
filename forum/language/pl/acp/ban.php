...
*
* @package language
* @version $Id: ban.php 8479 2008-04-06 LEW21 $
...
$lang = array_merge($lang, array(
	...
	'EMAIL_UNBAN_EXPLAIN'		=> 'Możesz odbanować (lub anulować wyłączenie) wielu adresów e-mail na raz dzięki użyciu odpowiedniej dla Twojego komputera i przeglądarki kombinacji myszki i klawiatury (np. Ctrl + LPM). Wyłączone adresy e-mail są pogrubione.',
	...
	'IP_UNBAN_EXPLAIN'			=> 'Możesz odbanować (lub anulować wyłączenie) wielu adresów IP na raz dzięki użyciu odpowiedniej dla Twojego komputera i przeglądarki kombinacji myszki i klawiatury (np. Ctrl + LPM). Wyłączone adresy IP są pogrubione.',
	...
	'USER_BAN_EXPLAIN'			=> 'Możesz zbanować wielu użytkowników na raz wpisując nazwę każdego w nowej linii. Użyj funkcji <span style="text-decoration: underline;">Znajdź użytkownika</span>, aby znaleźć i dodać jednego lub więcej użytkowników automatycznie.',
	'USER_NO_BANNED'			=> 'Nie ma zbanowanych użytkowników',
	'USER_UNBAN'				=> 'Odbanuj lub anuluj wyłączenie kont użytkowników',
	'USER_UNBAN_EXPLAIN'		=> 'Możesz odbanować (lub anulować wyłączenie) wielu kont użytkowników na raz dzięki użyciu odpowiedniej dla Twojego komputera i przeglądarki kombinacji myszki i klawiatury (np. Ctrl + LPM). Wyłączone konta użytkowników są pogrubione.',
