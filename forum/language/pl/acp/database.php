...
*
* @package language
* @version $Id: database.php 8479 2008-04-06 LEW21 $
...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'Ta strona daje Ci możliwość wykonania kopii zapasowej bazy danych phpBB3. Wynikowy plik możesz zapisać w katalogu <samp>store/</samp> i/lub ściągnąć na swój dysk twardy. Zależnie od konfiguracji Twojego serwera, możesz wybrać kilka formatów kompresji.',
	...
	'STORE_AND_DOWNLOAD'	=> 'Zapisz i ściągnij',
	'STORE_LOCAL'			=> 'Zapisz plik lokalnie',
	'STRUCTURE_ONLY'		=> 'Tylko struktura',

	'TABLE_SELECT'		=> 'Zaznacz tabele',
	'TABLE_SELECT_ERROR'=> 'Musisz zaznaczyć przynajmniej jedną tabelę.',
));
