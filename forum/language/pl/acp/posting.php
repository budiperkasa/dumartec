...
*
* @package language
* @version $Id: posting.php 8743 2008-11-16 LEW21 $
...
// Uśmieszki i ikony
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'Tutaj możesz dodawać, usuwać i zmieniać ikony, które użytkownicy mogą ustawiać swoim wątkom, postom i prywatnym wiadomościom. Ikony te zazwyczaj są wyświetlane w pobliżu tematów wątków na liście wątków i w pobliżu tematów postów na liście postów. Możesz też zainstalować lub utworzyć pakiet ikon.',
	...
	'EMOTION'					=> 'Emocja',
	'EXPORT_ICONS'				=> 'Wyeksportuj i ściągnij icons.pak',
	'EXPORT_ICONS_EXPLAIN'		=> '%sPo kliknięciu na ten link konfiguracja zainstalowanych ikon zostanie spakowana do pliku <samp>icons.pak</samp>, który, po ściągnięciu, może zostać użyty do utworzenia pliku <samp>.zip</samp> lub <samp>.tgz</samp>, zawierającego wszystkie ikony plus plik konfiguracyjny <samp>icons.pak</samp>%s.',
	'EXPORT_SMILIES'			=> 'Wyeksportuj i ściągnij smilies.pak',
	'EXPORT_SMILIES_EXPLAIN'	=> '%sPo kliknięciu na ten link konfiguracja zainstalowanych uśmieszków zostanie spakowana do pliku <samp>smilies.pak</samp>, który, po ściągnięciu, może zostać użyty do utworzenia pliku <samp>.zip</samp> lub <samp>.tgz</samp>, zawierającego wszystkie uśmieszki plus plik konfiguracyjny <samp>smilies.pak</samp>%s.',
	...
	'NO_ICONS_EXPORT'	=> 'Nie ma żadnych ikon, z których można by stworzyć pakiet.',
	...
	'NO_SMILIES_EXPORT'	=> 'Nie ma żadnych uśmieszków, z których można by stworzyć pakiet.',
...
$lang = array_merge($lang, array(
	...
	'ADD_DISALLOW_EXPLAIN'	=> 'Możesz zabronić wielu nazw użytkownika na raz poprzez użycie *.',
