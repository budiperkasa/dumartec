...
* 
* @package language 
* @version $Id: bots.php,v 1.0 2007/19/04 01:12:00 davidmj Exp $
...
$lang = array_merge($lang, array( 
	...
	'BOTS_EXPLAIN'		=> 'Bots são agentes automaticos usados pelos motores de busca para actualizar as bases de dados do motor automaticamente. Estes podem assim fazer uma visão menos correta das estatísticas de número de visitantes no Fórum aumentando assim a carga deste. Aqui você pode definir um tipo especial de utilizador para superar estes problemas.',
	'BOT_ACTIVATE'		=> 'Activado',
	'BOT_ACTIVE'		=> 'Bot Activo',
	'BOT_ADD'			=> 'Adiccionar bot',
	'BOT_ADDED'			=> 'Novo bot adicionado com sucesso.',
	'BOT_AGENT'			=> 'Agente de partida',
	'BOT_AGENT_EXPLAIN'	=> 'O fio que emparelha o agente de browser de bots, são permitidas partidas parciais.',
	'BOT_DEACTIVATE'	=> 'Desactivado',
	...
	'BOT_NAME_TAKEN'	=> 'Este nome esta a ser usado por um utilizador e não pode ser usado por um Bot.',
	'BOT_NEVER'			=> 'Nunca', 
	...
	'BOT_VIS'			=> 'Bot visivel', 
	'BOT_VIS_EXPLAIN'	=> 'Permitir que o bot seja visto por todos os utilizadores como estando online.',

	'ERR_BOT_AGENT_MATCHES_UA'	=> 'O agente de bot que você proveu é semelhante ao que você está usando actualmente. Por favor ajuste o agente para este bot.',
