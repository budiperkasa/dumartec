...
* 
* @package language 
* @version $Id: permissions_phpbb.php,v 1.0 2007/19/04 01:12:00 Portugal phpBB Hacks Exp $
...
$lang = array_merge($lang, array( 
	...
	'acl_u_chgname'		=> array('lang' => 'Pode Editar Utilizador', 'cat' => 'profile'),
	...
	'acl_u_download'	=> array('lang' => 'Pode Descarregar Ficheiros', 'cat' => 'post'), 
	'acl_u_savedrafts'	=> array('lang' => 'Pode Guardar Rascunho', 'cat' => 'post'), 
	...
	'acl_u_masspm'		=> array('lang' => 'Pode Enviar MPs para diversos Utilizadores e Grupos', 'cat' => 'pm'),
	...
	'acl_u_pm_delete'	=> array('lang' => 'Pode Apagar Mensagens Particulares de sua pasta', 'cat' => 'pm'), 
	'acl_u_pm_forward'	=> array('lang' => 'Pode Reenviar Mensagens Particulares', 'cat' => 'pm'), 
	...
	'acl_u_pm_attach'	=> array('lang' => 'Pode Anexar Ficheiros em Mensagens Particulares', 'cat' => 'pm'), 
	'acl_u_pm_download'	=> array('lang' => 'Pode Descarregar Ficheiros em Mensagens Particulares', 'cat' => 'pm'), 
...
// Forum Permissions 
$lang = array_merge($lang, array( 
	'acl_f_list'		=> array('lang' => 'Pode Ver Secção', 'cat' => 'post'), 
	'acl_f_read'		=> array('lang' => 'Pode Ler Secção', 'cat' => 'post'), 
	...
	'acl_f_download'	=> array('lang' => 'Pode Descarregar Ficheiros', 'cat' => 'content'), 
	...
	'acl_f_subscribe'	=> array('lang' => 'Pode Aprovar Secções', 'cat' => 'actions'), 
...
$lang = array_merge($lang, array( 
	...
	'acl_m_ban'		=> array('lang' => 'Pode Adminstrar Explusões', 'cat' => 'misc'), // This moderator setting is only global (and not local) 
)); 
...
$lang = array_merge($lang, array( 
	...
	'acl_a_forum'		=> array('lang' => 'Pode Adminstrar Secções', 'cat' => 'forums'), 
	'acl_a_forumadd'	=> array('lang' => 'Pode Adicionar Secções', 'cat' => 'forums'), 
	'acl_a_forumdel'	=> array('lang' => 'Pode Eliminar Secções', 'cat' => 'forums'), 
	...
	'acl_a_user'		=> array('lang' => 'Pode Adminstrar Utilizadores', 'cat' => 'user_group'),
	'acl_a_userdel'		=> array('lang' => 'Pode Eliminar/Limpar Utilizadores', 'cat' => 'user_group'),
	'acl_a_group'		=> array('lang' => 'Pode Adminstrar Grupos', 'cat' => 'user_group'), 
	...
	'acl_a_ranks'		=> array('lang' => 'Pode Adminstrar Ranks', 'cat' => 'user_group'), 
	'acl_a_profile'		=> array('lang' => 'Pode Adminstrar Campos do Perfil', 'cat' => 'user_group'), 
	'acl_a_names'		=> array('lang' => 'Pode Adminstrar Nomes Proibidos', 'cat' => 'user_group'), 
	'acl_a_ban'			=> array('lang' => 'Pode Adminstrar Explusões', 'cat' => 'user_group'), 
	...
	'acl_a_fauth'		=> array('lang' => 'Pode alterar Categorias de Permissões de Secções', 'cat' => 'permissions'), 
	...
	'acl_a_roles'		=> array('lang' => 'Pode Adminstrar funções', 'cat' => 'permissions'), 
	'acl_a_switchperm'	=> array('lang' => 'Pode utilizar Outras Permissões', 'cat' => 'permissions'), 

	'acl_a_styles'		=> array('lang' => 'Pode Adminstrar Templates', 'cat' => 'misc'), 
	'acl_a_viewlogs'	=> array('lang' => 'Pode Ver Registos', 'cat' => 'misc'), 
	'acl_a_clearlogs'	=> array('lang' => 'Pode Limpar registos', 'cat' => 'misc'), 
	'acl_a_modules'		=> array('lang' => 'Pode Adminstrar Módulos', 'cat' => 'misc'), 
	'acl_a_language'	=> array('lang' => 'Pode Adminstrar Pacotes de Línguas', 'cat' => 'misc'), 
	'acl_a_email'		=> array('lang' => 'Pode Enviar email em massa', 'cat' => 'misc'), 
	'acl_a_bots'		=> array('lang' => 'Pode Adminstrar BOTs', 'cat' => 'misc'), 
	'acl_a_reasons'		=> array('lang' => 'Pode Adminstrar motivos de denúncias/negações', 'cat' => 'misc'), 
	'acl_a_backup'		=> array('lang' => 'Pode Copiar/Restaurar Banco de Dados', 'cat' => 'misc'), 
	'acl_a_search'		=> array('lang' => 'Pode Adminstrar backends de pesquisas e Configurações', 'cat' => 'misc'), 
)); 
