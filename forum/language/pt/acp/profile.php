...
* 
* @package language 
* @version $Id: profile.php,v 1.0 2007/19/04 01:12:00 acydburn Exp $
...
$lang = array_merge($lang, array( 
	...
	'ALPHA_ONLY'			=> 'Somente catacteres alfanumericos', 
	'ALPHA_SPACERS'			=> 'Catacteres alfanumericos e espaços', 
	'ALWAYS_TODAY'			=> 'Sempre a Data Atual', 

	'BOOL_ENTRIES_EXPLAIN'	=> 'Escreva as suas opções agora', 
	'BOOL_TYPE_EXPLAIN'		=> 'Defina o tipo, como uma checkbox ou Botões de Rádio.',

	'CHANGED_PROFILE_FIELD'		=> 'O Campo do Perfil foi modificado com sucesso.', 
	'CHARS_ANY'					=> 'Qualquer Caracteres', 
	'CHECKBOX'					=> 'Checkbox', 
	'COLUMNS'					=> 'Colunas', 
	'CP_LANG_DEFAULT_VALUE'		=> 'Valor Padrão', 
	'CP_LANG_EXPLAIN'			=> 'Descrição do Campo', 
	'CP_LANG_EXPLAIN_EXPLAIN'	=> 'A Explicação para este Campo exibido ao utilizador.',
	'CP_LANG_NAME'				=> 'Título do Campo exibido ao utilizador',
	...
	'DEFAULT_LANGUAGE_NOT_FILLED'	=> 'As entradas de linguagem para a Língua Padrão não estão preenchidos a este campo do perfil.', 
	'DEFAULT_VALUE'					=> 'Valor Padrão', 
	'DELETE_PROFILE_FIELD'			=> 'Apagar Campo do Perfil', 
	'DELETE_PROFILE_FIELD_CONFIRM'	=> 'Você deseja realmente APAGAR este Campo do Perfil?', 
	'DISPLAY_AT_PROFILE'			=> 'Exibir no Painel de Utilizadores',
	'DISPLAY_AT_PROFILE_EXPLAIN'	=> 'O utilizador está autorizado a alterar este campo do perfil com o Painel de utilizadores.',
	'DISPLAY_AT_REGISTER'			=> 'Exibir na Tela de Registos', 
	'DISPLAY_AT_REGISTER_EXPLAIN'	=> 'Se esta opção estiver activa, o campo será exibido no registo e autorizado para ser alterado com o Painel de Utilizadores.',
	'DISPLAY_PROFILE_FIELD'			=> 'Exibir Campo do Perfil', 
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'O Campo do Perfil será visualizado em tpicos, perfils e lista de membros, se isto estiver ativo com as configurações de carga. Apenas exibindo com o perfil dos utilizadores estará padronalmente ativo.',
	'DROPDOWN_ENTRIES_EXPLAIN'		=> 'Escreva suas opções agora, todas elas em uma linha.',

	'EDIT_DROPDOWN_LANG_EXPLAIN'	=> 'Por Favor, note que você pode alterar os seus textos de opções e também pode adicionar novas opções ao fim. Não é aconselhado adicionar novas opções dentre outras opções existentes - isto pode resultar em opções defeituosas exibidas aos utilizadores. Isto pode também acontecer se você apagar opções dentre outras. Excluindo opções do fim resulta em utilizadores possuindo assigned this item now reverting back to the default one.',
	...
	'FIELD_DESCRIPTION_EXPLAIN'	=> 'A explicação para este campo exibida ao utilizador.',
	...
	'REQUIRED_FIELD_EXPLAIN'	=> 'Força o campo a ser preenchido ou especificado pelo utilizador. Isto irá exibir o campo no registo e com Painel de utilizadores.',
	'ROWS'						=> 'Linhas', 
	...
	'STEP_2_EXPLAIN_CREATE'			=> 'Aqui você pode definir algumas opções comuns. Além disso, você pode prever o campo o qual você gerou, visualizando-o enquanto utilizador. Por Favor, teste as suas configurações para ver se tudo está funcionando corretamente.',
	'STEP_2_EXPLAIN_EDIT'			=> 'Aqui você pode alterar algumas opções comuns. Além disso, você pode prever o campo alterado, visualizando-o enquanto utilizador. Por Favor, teste as suas configurações para ver se tudo está funcionando corretamente.<br /><strong>Por Favor, note que as alterações no campos do perfil não afetará os campos existentes inseridos pelos seus utilizadores.</strong>',
	...
	'STRING_DEFAULT_VALUE_EXPLAIN'	=> 'Escreva uma frase padrão a ser exibida, um valor parão. Deixe em branco se você não deseja activar esta opção.', 

	'TEXT_DEFAULT_VALUE_EXPLAIN'	=> 'Escreva um texto padrão a ser exibido, um valor parão. Deixe em branco se você não deseja activar esta opção.', 
	'TRANSLATE'						=> 'Traduzir', 

	'USER_FIELD_NAME'	=> 'Título do Campo exibido ao utilizador',
