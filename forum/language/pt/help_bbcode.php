...
$help = array( 
   ...
   array( 
      0 => 'Deixar o texto completo em forma de código ou apenas uma parte dele', 
   ...
   array( 
      0 => 'Adicionar uma imagem numa mensagem', 
   ...
   array( 
      0 => 'Anexando ficheiros na mensagem', 
      1 => 'A tag de anexar ficheiros pode ser inserida em qualquer local do post pois utiliza o novo <strong>[attachment=][/attachment]</strong> BBCode, isso se o recurso de anexar ficheiros foi activado pelo administrador do fórum &amp; se isto foi activado você pode anexar livremente ficheiros em suas mensagens. Dentro da tela de publicação de mensagens vai ter uma bloco onde pode anexar um ou mais ficheiros.' 
   ), 
   array( 
      0 => '--', 
      1 => 'Outras matérias' 
   ...
   array( 
      ...
      1 => 'Se você é um administrador ou se tiver permissões para tal, além disso você pode adiccionar BBCodes atravéz da secção Custom BBCodes.' 
   ) 
); 
