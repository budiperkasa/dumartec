...
* @translator: phpBB do Brasil - http://www.phpbb.com/community/memberlist.php?mode=viewprofile&u=179772 - 2007-12-19 - 14:28
*/
...
$lang = array_merge($lang, array(
	...
	'FILES_OPTIONAL'			=> 'Arquivos adicionais e diret&oacute;rio',
	'FILES_OPTIONAL_EXPLAIN'	=> '<strong>Opcional</strong> - As configura&ccedil;&otilde;es destes arquivos, diret&oacute;rios e permiss&otilde;es n&atilde;o s&atilde;o requeridas. O sistema de instala&ccedil;&atilde;o tentar&aacute; usar v&aacute;rias t&eacute;cnicas para cri&aacute;-los se eles n&atilde;o existirem ou n&atilde;o poderem ser gravados. Por&eacute;m, a presen&ccedil;a destes far&aacute; com que a instala&ccedil;&atilde;o fique mais r&aacute;pida.',
	'FILES_REQUIRED'			=> 'Arquivos e diret&oacute;rios',
	'FILES_REQUIRED_EXPLAIN'	=> '<strong>Requerido</strong> - Para funcionar corretamente, o phpBB precisa poder ter acesso ou estar apto a gravar certos arquivos ou diret&oacute;rios. Se voc&ecirc; v&ecirc; &quot;N&atilde;o Encontrado&quot; voc&ecirc; precisa criar este arquivo relevante ou diret&oacute;rio. Se voc&ecirc; v&ecirc; &quot;Grava&ccedil;&atilde;o N&atilde;o Permitida&quot; voc&ecirc; precisa mudar as permiss&otilde;es no arquivo ou diret&oacute;rio para permitir que o phpBB grave ele.',
	...
	<ul>
        ...
        <li>A porta do Banco de Dados - a porta do servidor de banco de dados (a maioria do tempo isto n&atilde;o &eacute; necess&aacute;rio).</li>
	...
	<p><strong>Nota:</strong> se voc&ecirc; est&aacute; instalando usando SQLite, voc&ecirc; deve entrar com o caminho completo para seu banco de dados no servidor DNS e deixar os campos de usu&aacute;rio e senha em branco. Por raz&otilde;es de seguran&ccedil;a, voc&ecirc; precisar&aacute; estar seguro que n&atilde;o exista maneira de acessar este banco de dados diretamente pelo endere&ccedil;o da internet.</p>
	...
	'OVERVIEW_BODY'				=> 'Bem-vindo ao phpBB3!<br /><br />O phpBB™ &eacute; o sistema de f&oacute;runs open source (gratuito) mais usado no mundo. O phpBB3 &eacute; a vers&atilde;o mais recente e que vem sendo melhorada desde vers&otilde;es anteriores do script, j&aacute; h&aacute; sete anos. Como seus predecessores, o phpBB3 &eacute; rico em funcionalidades, amig&aacute;vel e com uma equipe completa e pronta para te ajudar ao redor do mundo. O phpBB3 tr&aacute;s diversas melhorias em rela&ccedil;&atilde;o ao seu mais popular antecessor, o phpBB2, e adiciona caracter&iacute;sticas novas n&atilde;o presentes em vers&otilde;es anteriores. Esperamos que o mesmo supere suas expectativas.<br /><br />A instala&ccedil;&atilde;o ir&aacute; lhe guiar ao longo de todo o processo, atualizando seu f&oacute;rum de vers&otilde;es antigas para o novo phpBB3, bem como convertendo de um sistema de f&oacute;runs diferente. Para mais informa&ccedil;&otilde;es, recomendamos a leitura do <a href="../docs/INSTALL.html">guia de instala&ccedil;&atilde;o</a>.<br /><br />Para ler a licen&ccedil;a do phpBB3 e aprender como obter suporte e faz&ecirc;-lo corretamente, basta selecionar as op&ccedil;&otilde;es correspondentes do menu ao lado. Para continuar, por favor, selecione a aba apropriada.',
	...
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> '<strong>Requerido</strong> - Em ordem para o phpBB funcionar corretamente, a fun&ccedil;&atilde;o getimagesize() precisa estar ativa.',
	'PHP_OPTIONAL_MODULE'			=> 'M&oacute;dulos opcionais',
	'PHP_OPTIONAL_MODULE_EXPLAIN'	=> '<strong>Opcional</strong> - Estes m&oacute;dulos ou aplica&ccedil;&otilde;es s&atilde;o opcionais. Por&eacute;m, se eles est&atilde;o dispon&iacute;veis, eles habilitar&atilde;o caracter&iacute;sticas extras.',
	'PHP_SUPPORTED_DB'				=> 'Banco de dados suportados',
	'PHP_SUPPORTED_DB_EXPLAIN'		=> '<strong>Requerido</strong> - Voc&ecirc; tem que ter suporte a pelo menos um banco de dados compat&iacute;vel dentro do PHP. Se nenhum m&oacute;dulo de banco de dados &eacute; mostrado como dispon&iacute;vel, aconselhamos que voc&ecirc; entre em contato com o seu provedor de hospedagem ou dever&aacute; rever a documenta&ccedil;&atilde;o pertinente a instala&ccedil;&atilde;o do PHP.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Requerido</strong> - Para instalar o phpBB &eacute; necess&aacute;rio ter pelo menos a vers&atilde;o 4.3.3 do PHP instalada. Se o <var>modo seguro</var> estiver sendo exibido abaixo, sua instala&ccedil;&atilde;o do PHP est&aacute; trabalhando naquele modo. Isto impor&aacute; limita&ccedil;&otilde;es na administra&ccedil;&atilde;o remota e em caracter&iacute;sticas semelhantes.',
...
$lang = array_merge($lang, array(
	...
	'CONTINUE_UPDATE_NOW'           => 'Continuar o processo de atualiza&ccedil;&atilde;o agora',
