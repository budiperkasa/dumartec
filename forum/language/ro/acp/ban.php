...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_EXPLAIN'	=> 'Aici puteţi controla banarea utilizatorilor după nume, IP sau adresă de e-mail. Aceste metode previn un utilizator să vizualizeze orice parte a forumului. Puteţi să-i daţi un motiv scurt (maxim 3000 caractere) pentru ban dacă doriţi. Acesta va fi afişat în fişierul de log al administratorului. De asemenea, se poate specifica şi durata banului. Dacă vreţi ca banarea să expire la o anumită dată, decât să specificaţi perioada de banare mai bine completaţi data limită <span style="text-decoration: underline;">Până -&gt;</span> pentru banare în formatul <kbd>YYYY-MM-DD</kbd>.',
	...
	'USER_BAN_EXPLAIN'			=> 'Puteţi bana multipli utilizatori deodată introducând fiecare nume pe un rând. Folosiţi facilitatea <span style="text-decoration: underline;">Găseşte un membru</span> pentru a găsi şi adăuga unul sau mai mulţi utilizatori automat.',
