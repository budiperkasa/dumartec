...
$lang = array_merge($lang, array(
	...
	'ALLOW_ATTACHMENTS'			=> 'Permite ataşamente',
	...
	'ALLOW_PM_ATTACHMENTS'		=> 'Permite ataşamente în mesajele private',
...
$lang = array_merge($lang, array(
	...
	'MAX_AVATAR_SIZE_EXPLAIN'		=> 'Înălţime x Lungime în pixeli',
	...
	'MIN_AVATAR_SIZE_EXPLAIN'		=> 'Înălţime x Lungime în pixeli',
));
...
//	'ACC_USER_ADMIN'			=> 'Utilizator + administrator',
	...
	'MAX_CHARS'					=> 'Max',
	'MIN_CHARS'					=> 'Min',
	'MIN_TIME_REG'				=> 'Timpul minin pentru înregistrare',
	'MIN_TIME_REG_EXPLAIN'		=> 'Formularul de înregistrare nu poate fi trimis înainte ca acest interval de timp să treacă.',
	'MIN_TIME_TERMS'			=> 'Timpul minin pentru acceptarea termenilor',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'Pagina cu termeni nu poate fi sărită înainte ca acest interval de timp să treacă.',
	'NO_AUTH_PLUGIN'			=> 'Nici un plugin de autentificare potrivit nu a fost găsit.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'		=> 'Aici puteţi defini confirmarea vizuală standard şi setările CAPTCHA.',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Cum va arăta CAPTCHA folosind setările curente. Folosiţi butonul de previzualizare pentru a reîmprospăta. Generările captcha sunt aleatorii şi vor fi diferite de la o vizualizare la alta.',
	'VISUAL_CONFIRM_POST'		        	=> 'Activează confirmarea vizuală pentru mesajele vizitatorilor',
	'VISUAL_CONFIRM_POST_EXPLAIN'       	=> 'Cere utilizatorilor anonimi să introducă un cod aleatoriu potrivit cu imaginea pentru a preveni mesajele în bloc.',
...
$lang = array_merge($lang, array(
	...
	'RECOMPILE_STYLES_EXPLAIN'	=> 'Caută componentele de stil actualiizate în sistemul de fişiere şi le recompilează.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> 'Conţinutul generat va fi compresat înainte de a fi trimis utilizatorului. Această operaţie poate reduce traficul reţelei, dar de asemenea va mări gradul de folosire al procesorului pe server şi pe partea clientului.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Determină dacă utilizatorii se pot autentifica atomat când vizitează forumul.', 
	...
	'FORM_TIME_MIN_EXPLAIN'			=> 'Trimiterile mai rapide decât acest interval de timp sunt ignorate de către forum. Folosiţi 0 pentru dezactivare.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Dacă această opţiune este setată ca fiind dezactivată, niciun e-mail nu va fi trimis de către forum.',
	...
	'USE_SMTP_EXPLAIN'				=> 'Selectaţi “Da” dacă doriţi să trimiteţi e-mail-uri via unui server numit în locul funţiei locale de mesagerie.',
));
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Specificaţi un nume de utilizator înregistrat. Numele de utilizator nu va fi verificat dacă este valid.',
));
