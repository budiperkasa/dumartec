...
$lang = array_merge($lang, array(
    ...
    'COPY_PERMISSIONS_ADD_EXPLAIN'    => 'Odată creat, forumul va avea aceleaşi permisiuni ca şi cele pe care le selectaţi aici. Dacă nici un forum nu este selectat, cel mai nou forum creat nu va fi vizibil până au fost specificate permisiunile.',
    'COPY_PERMISSIONS_EDIT_EXPLAIN'    => 'Dacă alegeţi să copiaţi permisiunile, forumul va avea aceleaşi permisiuni ca şi cel selectat aici. Această operaţie va suprascrie orice permisiune pe care aţi setat-o anterior pentru acest forum cu permisiunile forumului pe care l-aţi selectat aici. Dacă nici un forum nu este selectat, vor fi păstrate permisiunile curente.',
    ...
    'NO_FORUM_ACTION'                => 'Nici o acţiune nu a fost definită în priviţa conţinutului forumului',
    'NO_PARENT'                        => 'Nici un părinte',
