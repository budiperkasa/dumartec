...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'URL'			=> 'Un adresă web validă ce foloseşte orice protocol (http, ftp, etc… nu poate fi folosit pentru scripturi java). Dacă nu este specificat, &quot;http://&quot; este adăugat şirului ca şi prefix',
...
$lang = array_merge($lang, array(
	...
	'ICONS_NONE_EDITED'		=> 'Nici o iconiţă nu a fost actualizată.',
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Din acest panou de control puteţi adăuga, şterge şi actualiza cuvinte care automatic vor fi cenzurate in forumurile proprii. În plus, utilizatorii nu vor avea voie să se înregistreze cu nume ce conţin aceste cuvinte. Wildcardurile (*) sunt acceptate în câmpul de cuvinte, de exemplu *test* va fi găsit detestabil, test* va fi găsit testare, *test va fi găsit detest.',
