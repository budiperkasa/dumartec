...
$lang = array_merge($lang, array(
    ...
    'DISPLAY_AT_REGISTER_EXPLAIN'    => 'Dacă această opţiune este activată, câmpul va fi afişat la înregistrare şi se va putea schimba din panoul de control al utilizatorului.',
    'DISPLAY_PROFILE_FIELD'            => 'Afişează câmp profil',
    'DISPLAY_PROFILE_FIELD_EXPLAIN'    => 'Câmpul de profil va fi afişat toate locurile permise în cadrul preferinţelor încărcate. Selectând “Nu” în acest câmp, câmpul se va ascunde din paginile subiectului, profilelor şi listei cu membrii.',
    'DROPDOWN_ENTRIES_EXPLAIN'        => 'Introduceţi acum opţiunile dumneavoastră, fiecare opţiune pe o linie',

    'EDIT_DROPDOWN_LANG_EXPLAIN'    => 'Reţineţi că puteţi schimba textul opţiunilor şi de asemenea puteţi adăuga noi opţiuni la sfârşit. Nu este recomandat să adăugaţi noi opţiuni între cele existente - această operaţie poate avea rezultate eronate în opţiunile alocate utilizatorilor. De asemenea, aceast lucru se poate întâmpla dacă eliminaţi opţiunile din interior. Eliminând opţiunile de la sfârşit are drept consecinţă faptul că utilizatorii care au avut atribuită această opţiune vor reveni la cea iniţială.',
    ...
    'FIELD_IDENT_EXPLAIN'        => 'Identificarea câmpului este un nume pentru a identifica câmpul de profil din baza de date şi din şabloane.',
    'FIELD_INT'                    => 'Numere',
    ...
    'HIDE_PROFILE_FIELD_EXPLAIN'    => 'Numai administratorii şi moderatorii pot să vadă/completeze acest câmp de profil. Dacă această opţiune este activată, câmpurile de profil vor fi afişate doar în profilurile utilizatorilor.',
    ...
    'NO_FIELD_ENTRIES'            => 'Nici o variantă nu a fost definită',
    'NO_FIELD_ID'                => 'Nici un identificator de câmp nu a fost specificat.',
    'NO_FIELD_TYPE'                => 'Nici un tip de câmp nu a fost specificat.',
    ...
    'REQUIRED_FIELD_EXPLAIN'    => 'Forţează câmpul de profil să fie completat sau specificat de către utilizator. Aceasta operaţie va afişa câmpul de profil la înregistrare şi în panoul de control al utilizatorului.',
    'ROWS'                        => 'Rânduri',
    ...
    'STEP_1_TITLE_EDIT'                => 'Modifică câmp profil',
