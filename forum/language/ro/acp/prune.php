...
$lang = array_merge($lang, array(
    'ACP_PRUNE_USERS_EXPLAIN'    => 'Aici puteţi şterge (sau dezactiva) utilizatorii din forumul propriu. Aceasta operaţie poate fi efectuată printr-o varietate de moduri: după numărul de mesaje, ultima activitate, etc. Fiecare dintre aceste criterii poate fi combinat, de exemplu puteţi şterge utilizatorii ce au avut ultima activitate înainte de 2002-01-01 cu mai puţin de 10 mesaje. Alternativ, puteţi specifica direct în căsuţa de text o listă a utilizatorilor, orice criteriu introdus fiind ignorat. Aveţi grijă cu această facilitate! Odată ce un utilizator este şters, nu mai există cale de întoarcere.',

    'DEACTIVATE_DELETE'            => 'Dezactivaţi sau ştergeţi',
    'DEACTIVATE_DELETE_EXPLAIN'    => 'Alegeţi între a dezactiva utilizatorii sau a-i şterge în totalitate, reţineţi că nu este cale de întoarcere!',
    ...
    'LAST_ACTIVE_EXPLAIN'        => 'Introduceţi o dată în formatul <kbd>YYYY-MM-DD</kbd>.',
    ...
    'SELECT_USERS_EXPLAIN'        => 'Precizaţi aici numele utilizatorilor, vor fi folosite de preferinţă pentru criteriile de mai sus.',
