...
$help = array(
	...
	array(
		0 => 'Adăugarea ataşamentelor într-un mesaj',
		1 => 'Ataşamentele pot acuma să fie puse în orice parte a mesajului, folosind noul cod BB <strong>[attachment=][/attachment]</strong>, dacă funcţionalitatea ataşamentelor a fost activată de către administratorul forumului şi dacă vi s-au atribuit permisiunile necesare să creeaţi ataşamente. La scrierea mesajului există o căsuţă drop-down (respectiv un buton) pentru plasarea ataşamentelor în linie.'
	),
	array(
		0 => '--',
		1 => 'Diverse'
