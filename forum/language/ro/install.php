...
$lang = array_merge($lang, array(
	...
	'BLANK_PREFIX_FOUND'		=> 'O scanare a tabelelor a arătat o instalare validă folosind nici un prefix pentru tabel.',
	'BOARD_NOT_INSTALLED'			=> 'Nu a fost găsită nici o instalare',
	...
	'CONVERT_INTRO_BODY'		=> 'De aici, puteţi importa date de la alte sisteme de forumuri (instalate). Lista de mai jos arată toate modulele de conversie ce sunt disponibile. Dacă nici un convertor pentru softul forumului din care doriţi să convertiţi nu este afişat în această listă, vă rugăm să vizitaţi site-ul nostru unde pot fi găsite pentru descărcare module suplimentare de conversie.',
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'Încărcarea ataşamentelor pe FTP este activată pe vechiul forum. Vă rugăm să dezactivaţi opţiunea de încărcare prin FTP şi asiguraţi-vă că este specificat un directorul valid de încărcare, apoi copiaţi toate fişierele ataşamentelor în acest nou director accesibil. Odată ce aţi terminat această operaţie, restartaţi convertorul.',
	'CONV_ERROR_CONFIG_EMPTY'			=> 'Nu există nici o informaţie de configurare disponibilă pentru această conversie.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>Aţi instalat cu succes phpBB %1$s. De aici aveţi două opţiuni referitoare la ce să faceţi cu noul sistem de forum instalat phpBB3:</p>
		<h2>Să convertiţi un forum existent în phpBB3</h2>
		<p>Unified Convertor Framework phpBB suportă conversia phpBB 2.0.x şi a altor sisteme de forumuri în phpBB3. Dacă aveţi un forum existent pe care doriţi să-l convertiţi, vă rugăm să <a href="%2$s">continuaţi cu convertorul</a>.</p>
		<h2>Să porniţi cu phpBB3!</h2>
		<p>Accesând butonul de mai jos, veţi ajunge în Panoul de control al administratorului (ACP). Acordaţi-vă puţin timp pentru a examina opţiunile disponibile. Reţineţi că ajutorul este disponibil online via <a href="http://www.phpbb.com/support/documentation/3.0/">Documentaţie</a> şi <a href="http://www.phpbb.com/community/viewforum.php?f=46">forumurile de suport</a>, consultaţi <a href="%3$s">fişierul CITEŞTE</a> pentru mai multe informaţii.</p><p><strong>Vă rugăm acum să ştergeţi, mutaţi sau să redenumiţi directorul install înainte de a accesa forumul. Dacă acest director este în continuare prezent, doar Panoul de control al administratorului (ACP) va fi disponibil.</strong></p>',
...
// TODO: write some more introductions here
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'Versiunea Firebird instalată pe acest forum este mai veche decât 2.0, vă rugăm să actualizaţi la o versiune mai nouă.',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'		=> '<strong>Cerinţe</strong> - Trebuie să aveţi suport pentru cel puţin o bază de date compatibilă cu PHP. Dacă nici un modul al bazei de date nu este afişat ca fiind disponibil, ar trebui să contactaţi provider-ul hostului sau să revizuiţi pentru ajutor documentaţia relevantă de instalare a PHP.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Toate fişiere sunt actualizate cu ultima versiune a phpBB. Acum trebuie <a href="../ucp.php?mode=login">să vă autentificaţi pe forum</a> şi să verificaţi dacă totul decurge normal. Nu uitaţi să ştergi, redenumiţi sau să mutaţi directorul de instalare!',
	...
	'CURRENT_FILE'					=> 'Începutul fişierului original curent',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Sfârşitul fişierului original curent / Începutul noului fişier actualizat',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Uneşte diferenţele şi foloseşte codul modificat în cadrul blocului de conflict',
	'MERGE_NEW_FILE_OPTION'		=> 'Uneşte diferenţele şi foloseşte codul noului fişier în cadrul blocului de conflict',
	...
	'NEW_FILE'						=> 'Sfârşitul fişierului nou actualizat',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<strong><a href="%2$s" title="%2$s">Acuma porniţi procesul de actualizare accesând prin browser directorul install</a>.</strong><br />
		<br />
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Verifică pentru a vedea dacă versiunea phpBB pe care o folosiţi este la zi.',
	'VERSION_NOT_UP_TO_DATE'	=> 'Versiunea phpBB nu este la zi. Vă rugăm să continuaţi procesul de actualizare.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'Versiunea phpBB nu este la zi.<br />Mai jos veţi găsi un link către anunţurile de lansare a ultimelor versiuni, dar şi instrucţiunile pentru efectuarea actualizării.',
	'VERSION_UP_TO_DATE'		=> 'Instalarea este la zi, nicio actualizare nu este valabilă pentru versiunea phpBB curentă folosită. Puteţi continua pentru a efectua o verificare de validare a fişierelor.',
	'VERSION_UP_TO_DATE_ACP'	=> 'Instalarea este la zi, nicio actualizare nu este valabilă pentru versiunea phpBB curentă folosită. Nu este necesară actualizarea instalării.',
