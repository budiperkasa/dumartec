...
$lang = array_merge($lang, array(
	...
	'ATTACHMENTS_EXPLAIN'			=> 'Aceasta este o listă de ataşamente pe care le-aţi trimis în mesajele din acest forum.',
	'ATTACHMENTS_DELETED'			=> 'Ataşamente şterse cu succes.',
	'ATTACHMENT_DELETED'			=> 'Ataşament şters cu succes.',
	...
	'DELETE_ATTACHMENT'			=> 'Ştergere ataşament',
	'DELETE_ATTACHMENTS'		=> 'Ştergere ataşamente',
	'DELETE_ATTACHMENT_CONFIRM'	=> 'Sunteţi sigur(ă) că doriţi ştergerea acestui ataşament?',
	'DELETE_ATTACHMENTS_CONFIRM'=> 'Sunteţi sigur(ă) că doriţi ştergerea acestor ataşamente?',
	'DELETE_AVATAR'				=> 'Şterge imagine',
	'DELETE_COOKIES_CONFIRM'	=> 'Sunteţi sigur(ă) că doriţi ştergerea tuturor cookie-urilor primite de pe acest forum?',
	'DELETE_MARKED_PM'			=> 'Ştergere mesaje marcate',
	'DELETE_MARKED_PM_CONFIRM'	=> 'Sunteţi sigur(ă) că doriţi ştergerea tuturor mesajelor marcate?',
	'DELETE_OLDEST_MESSAGES'	=> 'Ştergerea mesajelor celor mai vechi',
	'DELETE_MESSAGE'			=> 'Ştergere mesaj',
	'DELETE_MESSAGE_CONFIRM'	=> 'Sunteţi sigur(ă) că doriţi ştergerea acestui mesaj privat?',
	'DELETE_MESSAGES_IN_FOLDER'	=> 'Ştergerea tuturor mesajelor din dosarul şters',
	'DELETE_RULE'				=> 'Ştergere regulă',
	'DELETE_RULE_CONFIRM'		=> 'Sunteţi sigur(ă) că doriţi ştergerea acestei reguli?',
	...
	'EDIT_DRAFT_EXPLAIN'		=> 'Aici puteţi modifica mesajul dumneavoastră în lucru. Mesajele în lucru nu conţin ataşamente şi informaţii despre voturi.',
	...
	'FOLDER_MESSAGE_STATUS'		=> 'Sunt păstrate %1$d de la %2$d mesaje',
	...
	'FOLDER_STATUS_MSG'			=> 'Dosarul este plin %1$d%% (sunt păstrate %2$d de la %3$d mesaje)',
	...
	'LOGIN_REDIRECT'			=> 'Aţi fost autentificat(ă) cu succes.',
	'LOGOUT_FAILED'				=> 'Nu aţi fost deautentificat(ă), pentru că cererea nu se potriveşte cu sesiunea. Vă rugăm să contactaţi administratorul forumului dacă continuaţi să aveţi probleme.',
	'LOGOUT_REDIRECT'			=> 'Aţi fost deconectat(ă) cu succes.',
	...
	'MOVE_DELETED_MESSAGES_TO'		=> 'Mutare mesaje din dosarul şterse în',
	'MOVE_DOWN'						=> 'Mutare mai jos',
	'MOVE_MARKED_TO_FOLDER'			=> 'Mutare mesaje marcate în %s',
	'MOVE_PM_ERROR'					=> 'O eroare a apărut în timpul mutării mesajelor în noul dosar, au fost mutate doar %1d din %2d mesaje.',
	'MOVE_TO_FOLDER'				=> 'Mutare în dosar',
	...
	'NO_AUTH_DELETE_MESSAGE'		=> 'Nu sunteţi autorizat(ă) să ştergeţi mesaje private.',
	'NO_AUTH_EDIT_MESSAGE'			=> 'Nu sunteţi autorizat(ă) să modificaţi mesaje private.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'Nu sunteţi autorizat(ă) să redirecţionaţi mesaje private.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'Nu sunteţi autorizat(ă) să trimiteţi mesaje private spre grupuri.',
	'NO_AUTH_READ_MESSAGE'			=> 'Nu sunteţi autorizat(ă) să citiţi mesaje private.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'Nu puteţi citi acest mesaj pentru că a fost şters de către autor.',
	'NO_AUTH_SEND_MESSAGE'			=> 'Nu sunteţi autorizat(ă) să trimiteţi mesaje private.',
	'NO_AUTH_SIGNATURE'				=> 'Nu sunteţi autorizat(ă) să vă alegeţi o semnătură.',
	...
	'NO_SAVED_DRAFTS'			=> 'Niciun mesaj în lucru salvată.',
	...
	'PASSWORD_UPDATED'			=> 'Parola dumneavoastră a fost trimisă cu succes la adresa originală de e-mail.',
	...
	'PROFILE_INFO_NOTICE'		=> 'Aceste informaţii vor fi vizibile celorlalţi utilizatori. Fiţi atent(ă) la includerea detaliilor personale. Orice câmp marcat cu * trebuie să fie completat.',
	'PROFILE_UPDATED'			=> 'Profilul dumneavoastră a fost actualizat.',

	'RECIPIENT'							=> 'Destinatar',
	'RECIPIENTS'						=> 'Destinatari',
	'REGISTRATION'						=> 'Înregistrare',
	'RELEASE_MESSAGES'					=> '%sExpedierea tuturor mesajelor în aşteptare%s… acestea vor fi resortate în dosarul potrivit dacă este destul spaţiu disponibil.',
	'REMOVE_ADDRESS'					=> 'Înlăturare adresă',
	'REMOVE_SELECTED_BOOKMARKS'			=> 'Ştergerea semnelor de carte selectate',
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> 'Sunteţi sigur(ă) că doriţi ştergerea semenelor de carte selectate?',
	'REMOVE_BOOKMARK_MARKED'			=> 'Ştergere semne de carte marcate',
	'REMOVE_FOLDER'						=> 'Ştergere dosar',
	'REMOVE_FOLDER_CONFIRM'				=> 'Sunteţi sigur(ă) că doriţi ştergerea acestui dosar?',
	'RENAME'							=> 'Redenumire',
	'RENAME_FOLDER'						=> 'Redenumire dosar',
	'REPLIED_MESSAGE'					=> 'Răspuns la mesaj',
	'RESIGN_SELECTED'					=> 'Demisia a fost aleasă',
	...
	'TIMEZONE'					=> 'Fus orar',
	'TO'						=> 'Destinatar',
	'TOO_MANY_RECIPIENTS'		=> 'Prea mulţi destinatari.',
	...
	'UCP_MAIN_ATTACHMENTS'		=> 'Administrare ataşamente',
	...
	'UCP_PREFS'					=> 'Preferinţele forumului',
	...
	'WATCHED_EXPLAIN'			=> 'Mai jos găsiţi o listă de formuri şi subiecte la care sunteţi abonat(ă). Veţi fi notificat(ă) la fiecare mesaj nou din fiecare. Pentru a vă dezabona, marcaţi forumul sau subiectul şi apăsaţi butonul <em>Încetarea urmăririi</em>.',
	...
	'GROUPS_EXPLAIN'	=> 'Grupurile de utilizatori permit administratorilor să administreze mai uşor utilizatorii. Veţi fi introdus(ă) într-un grup de utilizatori încă de la înregistrare, acesta este grupul dumneavoastră prestabilit. Acest grup defineşte cum apăreţi celorlalţi utilizatori, de exemplu culoarea numelui de utilizator, avatarul, rangul, etc. În funcţie de ceea ce administratorul permite, puteţi să vă schimbaţi grupul prestabilit. Puteţi de asemenea să fiţi aşezat în alte grupuri sau să vă fie permis să vă alăturaţi altor grupuri. Unele grupuri vă pot oferi permisiuni suplimentare de vizualizare a conţinutului sau creştere a captacităţilor în alte zone.',
	'GROUP_LEADER'		=> 'Lideri',
	'GROUP_MEMBER'		=> 'Membri',
