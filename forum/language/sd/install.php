...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'	=> 'سنڌي ٻولي جي انٽرنيٽ تي واڌاري لاءِ جاکوڙيندڙ فورم',
	'CONFIG_SITENAME'	=> 'سنڌ فورم ',
	'DEFAULT_INSTALL_POST'	=> 'هيءُ توهان جي سنڌي پي ايڇ پي بي بي ٿري ۾ هڪ شروعاتي تحرير آهي، سڀ شيون صحيح هلندڙ حالت ۾ لڳي رهيون آهن. توهان هن تحرير کي ختم به ڪري سگهو ٿا، ۽ بورڊ جي سيٽنگ جو عمل جاري رکي سگهو ٿا. انسٽاليشن دوران توهان جي پهرين ڪيٽيگري ۽ فورم ۾ پهرين کان موجوده گروپن (منتظمين، بوٽس، ايڊيٽرن، مهمانن، رجسٽرڊ رُڪنن ۽ رجسٽرڊ ڪوپا رُڪنن) جي اجازتون موجود آهي. جيڪڏهن توهان پنهنجي پهرين ڪيٽيگري ۽ فورم به ختم ڪرڻ چاهيو ٿا. ته ان سڀني گروپن کي سڀني نون ڪيٽيگرين تي لاڳو ڪرڻ نه وسارينديا. اسان توهان کي هيءَ تجويز ڏيون ٿا ته توهان پنهنجي پهرين ڪيٽيگري ۽ فورم جو نالو تبديل ڪريو ۽ باقي فورمن تي ان جون اجازتون ڪاپي ڪريو. اگر ڪوبه مسئلو پيش اچي ته سنڌ فورم تي رابطو ڪريو، اميد آهي ته پي ايڇ پي سنڌي ترجمي سان توهان کي پسند ايندو.',
	...
	'FORUMS_FIRST_CATEGORY'	=> 'توهان جي پهرين ڪيٽيگري',
	'FORUMS_TEST_FORUM_DESC'	=> 'توهان جي پهرين فورم جو تفصيل',
	'FORUMS_TEST_FORUM_TITLE'	=> 'توهان جو پهريون فورم ',
	'RANKS_SITE_ADMIN_TITLE'	=> 'سائيٽ ايڊمن',
	...
	'SMILIES_WINK'	=> 'Wink',
	'TOPICS_TOPIC_TITLE'	=> 'سنڌ فورم تي ڀلي ڪري آيا',
));
