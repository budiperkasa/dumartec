...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'В цій панелі ви можете додавати, редагувати та видаляти слова, які будуть автоматично підлягати цензурі на ваших форумах. Крім того, користувачі не зможуть зареєструватись з іменами, які містять дані слова. Дозволяється використання маски (*) в словах, наприклад *тест* буде відповідати слову "протестований", тест* буде відповідати слову "тестування", *тест - слову "протест".',
