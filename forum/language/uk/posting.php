...
$lang = array_merge($lang, array(
	...
	'PHP_SIZE_OVERRUN'	=> 'Надто великий розмір приєднаного файлу, максимально допустимий розмір файлу %d Мб.<br />Зауважте, ця величина встановлена в php.ini і не може бути перевищена.',
