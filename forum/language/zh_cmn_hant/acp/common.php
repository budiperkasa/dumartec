...
$lang = array_merge($lang, array(
	...
	'LOG_FORUM_DEL_MOVE_POSTS_FORUMS'		=> '<strong>已刪除版面和它的子版面，已移動訊息</strong> 到 %1$s<br />» %2$s',
	'LOG_FORUM_DEL_MOVE_POSTS_MOVE_FORUMS'	=> '<strong>已刪除版面，已移動文章</strong> 到 %1$s <strong>和已移動子版面</strong> 到 %2$s<br />» %3$s',
	'LOG_FORUM_DEL_POSTS'					=> '<strong>已刪除版面和它的訊息</strong><br />» %s',
	'LOG_FORUM_DEL_POSTS_FORUMS'			=> '<strong>已刪除版面，它的訊息以及子版面</strong><br />» %s',
	'LOG_FORUM_DEL_POSTS_MOVE_FORUMS'		=> '<strong>已刪除版面和它的訊息，已移動子版面</strong> 到 %1$s<br />» %2$s',
