...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<h2>全域權限</h2>
		<p>這些用來控制使用整個討論區的全域等級，進一步區分為會員權限、群組權限、管理員和全域版主。</p>
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> '在這裡，您可以指派管理權限給會員或群組。所有擁有管理權限的會員都能看到管理員控制台。',
	...
	'ACP_ADMIN_ROLES_EXPLAIN'					=> '在這裡，您可以管理具管理權限的角色。角色是有效的權限組合，如果您更改了角色內容，那麼使用這個角色者將會被更改權限。',
	...
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> '在這裡，您可以檢視所選擇的會員/群組其有效的管理權限。',
	...
	'TRACE_GROUP_NO_LOCAL'			=> '這個群組關於這個版面的權限是 <samp>否</samp> 所以保留全部的舊值t。',
